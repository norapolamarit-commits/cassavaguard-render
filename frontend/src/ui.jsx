...
(function () {
  ...
  const Icon = ({ name, className = 'w-5 h-5', ...p }) => {
    const paths = {
      ...
      brain: 'M7 10a5 7 0 1 0 10 0a5 7 0 1 0-10 0M12 3v14M8 7c1 0 1.5 1 1.5 2M16 7c-1 0-1.5 1-1.5 2',
      ...
      camera: 'M4 8a2 2 0 0 1 2-2h2.5l1-1.5h5l1 1.5H18a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8zM9 14a3 3 0 1 0 6 0a3 3 0 1 0-6 0',
      ...
      user: 'M8 8a4 4 0 1 0 8 0a4 4 0 1 0-8 0M4 21c1.2-4 4.2-6 8-6s6.8 2 8 6',
    };
    return (

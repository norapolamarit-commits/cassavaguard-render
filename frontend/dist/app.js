...
void main() {
	...
	`}var oo=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Ms(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Bi(5,5,5),a=new jt({name:"CubemapFromEquirect",uniforms:di(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Gt,blending:Sn});a.uniforms.tEquirect.value=t;let r=new Xt(s,a),o=t.minFilter;return t.minFilter===Jn&&(t.minFilter=Nt),new ur(1,10,this).update(e,r),t.minFilter=o,r.geometry.dispose(),r.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){let a=e.getRenderTarget();for(let r=0;r<6;r++)e.setRenderTarget(this,r),e.clear(t,n,s);e.setRenderTarget(a)}};function Vp(i){let e=new WeakMap,t=new WeakMap,n=null;function s(f,d=!1){return f==null?null:d?r(f):a(f)}function a(f){if(f&&f.isTexture){let d=f.mapping;if(d===gr||d===xr)if(e.has(f)){let x=e.get(f).texture;return o(x,f.mapping)}else{let x=f.image;if(x&&x.height>0){let E=new oo(x.height);return E.fromEquirectangularTexture(i,f),e.set(f,E),f.addEventListener("dispose",c),o(E.texture,f.mapping)}else return null}}return f}function r(f){if(f&&f.isTexture){let d=f.mapping,x=d===gr||d===xr,E=d===Zn||d===ci;if(x||E){let m=t.get(f),h=m!==void 0?m.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==h)return n===null&&(n=new ro(i)),m=x?n.fromEquirectangular(f,m):n.fromCubemap(f,m),m.texture.pmremVersion=f.pmremVersion,t.set(f,m),m.texture;if(m!==void 0)return m.texture;{let w=f.image;return x&&w&&w.height>0||E&&w&&l(w)?(n===null&&(n=new ro(i)),m=x?n.fromEquirectangular(f):n.fromCubemap(f),m.texture.pmremVersion=f.pmremVersion,t.set(f,m),f.addEventListener("dispose",u),m.texture):null}}}return f}function o(f,d){return d===gr?f.mapping=Zn:d===xr&&(f.mapping=ci),f}function l(f){let d=0,x=6;for(let E=0;E<x;E++)f[E]!==void 0&&d++;return d===x}function c(f){let d=f.target;d.removeEventListener("dispose",c);let x=e.get(d);x!==void 0&&(e.delete(d),x.dispose())}function u(f){let d=f.target;d.removeEventListener("dispose",u);let x=t.get(d);x!==void 0&&(t.delete(d),x.dispose())}function p(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:p}}function Hp(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let s=t(n);return s===null&&ai("WebGLRenderer: "+n+" extension not supported."),s}}}function Wp(i,e,t,n){let s={},a=new WeakMap;function r(p){let f=p.target;f.index!==null&&e.remove(f.index);for(let x in f.attributes)e.remove(f.attributes[x]);f.removeEventListener("dispose",r),delete s[f.id];let d=a.get(f);d&&(e.remove(d),a.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(p,f){return s[f.id]===!0||(f.addEventListener("dispose",r),s[f.id]=!0,t.memory.geometries++),f}function l(p){let f=p.attributes;for(let d in f)e.update(f[d],i.ARRAY_BUFFER)}function c(p){let f=[],d=p.index,x=p.attributes.position,E=0;if(x===void 0)return;if(d!==null){let w=d.array;E=d.version;for(let A=0,_=w.length;A<_;A+=3){let b=w[A+0],y=w[A+1],M=w[A+2];f.push(b,y,y,M,M,b)}}else{let w=x.array;E=x.version;for(let A=0,_=w.length/3-1;A<_;A+=3){let b=A+0,y=A+1,M=A+2;f.push(b,y,y,M,M,b)}}let m=new(x.count>=65535?bs:ys)(f,1);m.version=E;let h=a.get(p);h&&e.remove(h),a.set(p,m)}function u(p){let f=a.get(p);if(f){let d=p.index;d!==null&&f.version<d.version&&c(p)}else c(p);return a.get(p)}return{get:o,update:l,getWireframeAttribute:u}}function Xp(i,e,t){let n;function s(p){n=p}let a,r;function o(p){a=p.type,r=p.bytesPerElement}function l(p,f){i.drawElements(n,f,a,p*r),t.update(f,n,1)}function c(p,f,d){d!==0&&(i.drawElementsInstanced(n,f,a,p*r,d),t.update(f,n,d))}function u(p,f,d){if(d===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,a,p,0,d);let E=0;for(let m=0;m<d;m++)E+=f[m];t.update(E,n,1)}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function qp(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(a,r,o){switch(t.calls++,r){case i.TRIANGLES:t.triangles+=o*(a/3);break;case i.LINES:t.lines+=o*(a/2);break;case i.LINE_STRIP:t.lines+=o*(a-1);break;case i.LINE_LOOP:t.lines+=o*a;break;case i.POINTS:t.points+=o*a;break;default:Fe("WebGLInfo: Unknown draw mode:",r);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function $p(i,e,t){let n=new WeakMap,s=new xt;function a(r,o,l){let c=r.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=u!==void 0?u.length:0,f=n.get(o);if(f===void 0||f.count!==p){let C=function(){M.dispose(),n.delete(o),o.removeEventListener("dispose",C)};f!==void 0&&f.texture.dispose();let d=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,E=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],h=o.morphAttributes.normal||[],w=o.morphAttributes.color||[],A=0;d===!0&&(A=1),x===!0&&(A=2),E===!0&&(A=3);let _=o.attributes.position.count*A,b=1;_>e.maxTextureSize&&(b=Math.ceil(_/e.maxTextureSize),_=e.maxTextureSize);let y=new Float32Array(_*b*4*p),M=new gs(y,_,b,p);M.type=fn,M.needsUpdate=!0;let g=A*4;for(let R=0;R<p;R++){let P=m[R],N=h[R],O=w[R],T=_*b*4*R;for(let F=0;F<P.count;F++){let L=F*g;d===!0&&(s.fromBufferAttribute(P,F),y[T+L+0]=s.x,y[T+L+1]=s.y,y[T+L+2]=s.z,y[T+L+3]=0),x===!0&&(s.fromBufferAttribute(N,F),y[T+L+4]=s.x,y[T+L+5]=s.y,y[T+L+6]=s.z,y[T+L+7]=0),E===!0&&(s.fromBufferAttribute(O,F),y[T+L+8]=s.x,y[T+L+9]=s.y,y[T+L+10]=s.z,y[T+L+11]=O.itemSize===4?s.w:1)}}f={count:p,texture:M,size:new xe(_,b)},n.set(o,f),o.addEventListener("dispose",C)}if(r.isInstancedMesh===!0&&r.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",r.morphTexture,t);else{let d=0;for(let E=0;E<c.length;E++)d+=c[E];let x=o.morphTargetsRelative?1:1-d;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:a}}function Yp(i,e,t,n,s){let a=new WeakMap;function r(c){let u=s.render.frame,p=c.geometry,f=e.get(c,p);if(a.get(f)!==u&&(e.update(f),a.set(f,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),a.get(c)!==u&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),a.set(c,u))),c.isSkinnedMesh){let d=c.skeleton;a.get(d)!==u&&(d.update(),a.set(d,u))}return f}function o(){a=new WeakMap}function l(c){let u=c.target;u.removeEventListener("dispose",l),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:r,dispose:o}}var Zp={[rl]:"LINEAR_TONE_MAPPING",[ol]:"REINHARD_TONE_MAPPING",[ll]:"CINEON_TONE_MAPPING",[qs]:"ACES_FILMIC_TONE_MAPPING",[dl]:"AGX_TONE_MAPPING",[hl]:"NEUTRAL_TONE_MAPPING",[cl]:"CUSTOM_TONE_MAPPING"};function Jp(i,e,t,n,s,a){let r=new Wt(e,t,{type:i,depthBuffer:s,stencilBuffer:a,samples:n?4:0,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,resolveDepthBuffer:!1,resolveStencilBuffer:!1}),o=null,l=null,c=new Ft;c.setAttribute("position",new rt([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new rt([0,2,0,0,2,0],2));let u=new Qa({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+h);let A=w+m+r,_=w+h+o,b=Sd(s,s.VERTEX_SHADER,A),y=Sd(s,s.FRAGMENT_SHADER,_);s.attachShader(E,b),s.attachShader(E,y),t.index0AttributeName!==void 0?s.bindAttribLocation(E,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(E,0,"position"),s.linkProgram(E);function M(P){if(i.debug.checkShaderErrors){let N=s.getProgramInfoLog(E)||"",O=s.getShaderInfoLog(b)||"",T=s.getShaderInfoLog(y)||"",F=N.trim(),L=O.trim(),V=T.trim(),X=!0,H=!0;if(s.getProgramParameter(E,s.LINK_STATUS)===!1)if(X=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,E,b,y);else{let D=wd(s,b,"vertex"),J=wd(s,y,"fragment");Fe("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(E,s.VALIDATE_STATUS)+`
...
Program Info Log: `+F+`
`+D+`
`+J)}else F!==""?De("WebGLProgram: Program Info Log:",F):(L===""||V==="")&&(H=!1);H&&(P.diagnostics={runnable:X,programLog:F,vertexShader:{log:L,prefix:m},fragmentShader:{log:V,prefix:h}})}s.deleteShader(b),s.deleteShader(y),g=new ts(s,E),C=Ym(s,E)}let g;this.getUniforms=function(){return g===void 0&&M(this),g};let C;this.getAttributes=function(){return C===void 0&&M(this),C};let R=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return R===!1&&(R=s.getProgramParameter(E,Bm)),R},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(E),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=km++,this.cacheKey=e,this.usedTimes=1,this.program=E,this.vertexShader=b,this.fragmentShader=y,this}var dg=0,Hl=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,n){let s=this._getShaderCacheForMaterial(e);return s.has(t)===!1&&(s.add(t),t.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(e){let t=this.materialCache.get(e);for(let n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let t=this.materialCache,n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){let t=this.shaderCache,n=t.get(e);return n===void 0&&(n=new Wl(e),t.set(e,n)),n}},Wl=class{constructor(e){this.id=dg++,this.code=e,this.usedTimes=0}};function hg(i){return i===jn||i===Qs||i===ea}function ug(i,e,t,n,s,a){let r=new xs,o=new Hl,l=new Set,c=[],u=new Map,p=n.logarithmicDepthBuffer,f=n.precision,d={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(g){return l.add(g),g===0?"uv":`uv${g}`}function E(g,C,R,P,N,O){let T=P.fog,F=N.geometry,L=g.isMeshStandardMaterial||g.isMeshLambertMaterial||g.isMeshPhongMaterial?P.environment:null,V=g.isMeshStandardMaterial||g.isMeshLambertMaterial&&!g.envMap||g.isMeshPhongMaterial&&!g.envMap,X=e.get(g.envMap||L,V),H=X&&X.mapping===$s?X.image.height:null,D=d[g.type];g.precision!==null&&(f=n.getMaxPrecision(g.precision),f!==g.precision&&De("WebGLProgram.getParameters:",g.precision,"not supported, using",f,"instead."));let J=F.morphAttributes.position||F.morphAttributes.normal||F.morphAttributes.color,Y=J!==void 0?J.length:0,ae=0;F.morphAttributes.position!==void 0&&(ae=1),F.morphAttributes.normal!==void 0&&(ae=2),F.morphAttributes.color!==void 0&&(ae=3);let Pe,Ee,we,K;if(D){let Le=wn[D];Pe=Le.vertexShader,Ee=Le.fragmentShader}else{Pe=g.vertexShader,Ee=g.fragmentShader;let Le=o.getVertexShaderStage(g),Be=o.getFragmentShaderStage(g);o.update(g,Le,Be),we=Le.id,K=Be.id}let j=i.getRenderTarget(),ce=i.state.buffers.depth.getReversed(),be=N.isInstancedMesh===!0,ge=N.isBatchedMesh===!0,Oe=!!g.map,dt=!!g.matcap,ze=!!X,We=!!g.aoMap,je=!!g.lightMap,Ge=!!g.bumpMap&&g.wireframe===!1,Ze=!!g.normalMap,ht=!!g.displacementMap,ot=!!g.emissiveMap,nt=!!g.metalnessMap,tt=!!g.roughnessMap,z=g.anisotropy>0,He=g.clearcoat>0,Ve=g.dispersion>0,I=g.retroreflectivity>0,v=g.iridescence>0,G=g.sheen>0,W=g.transmission>0,ee=z&&!!g.anisotropyMap,le=He&&!!g.clearcoatMap,de=He&&!!g.clearcoatNormalMap,Q=He&&!!g.clearcoatRoughnessMap,ne=v&&!!g.iridescenceMap,me=v&&!!g.iridescenceThicknessMap,Se=G&&!!g.sheenColorMap,he=G&&!!g.sheenRoughnessMap,ue=!!g.specularMap,Ae=!!g.specularColorMap,Ie=!!g.specularIntensityMap,Ue=W&&!!g.transmissionMap,B=W&&!!g.thicknessMap,fe=!!g.gradientMap,te=!!g.alphaMap,pe=g.alphaTest>0,oe=!!g.alphaHash,se=!!g.extensions,ie=hn;g.toneMapped&&(j===null||j.isXRRenderTarget===!0)&&(ie=i.toneMapping);let re={shaderID:D,shaderType:g.type,shaderName:g.name,vertexShader:Pe,fragmentShader:Ee,defines:g.defines,customVertexShaderID:we,customFragmentShaderID:K,isRawShaderMaterial:g.isRawShaderMaterial===!0,glslVersion:g.glslVersion,precision:f,batching:ge,batchingColor:ge&&N._colorsTexture!==null,instancing:be,instancingColor:be&&N.instanceColor!==null,instancingMorph:be&&N.morphTexture!==null,outputColorSpace:j===null?i.outputColorSpace:j.isXRRenderTarget===!0?j.texture.colorSpace:Ke.workingColorSpace,alphaToCoverage:!!g.alphaToCoverage,map:Oe,matcap:dt,envMap:ze,envMapMode:ze&&X.mapping,envMapCubeUVHeight:H,aoMap:We,lightMap:je,bumpMap:Ge,normalMap:Ze,displacementMap:ht,emissiveMap:ot,normalMapObjectSpace:Ze&&g.normalMapType===Xc,normalMapTangentSpace:Ze&&g.normalMapType===to,packedNormalMap:Ze&&g.normalMapType===to&&hg(g.normalMap.format),metalnessMap:nt,roughnessMap:tt,anisotropy:z,anisotropyMap:ee,clearcoat:He,clearcoatMap:le,clearcoatNormalMap:de,clearcoatRoughnessMap:Q,dispersion:Ve,retroreflection:I,iridescence:v,iridescenceMap:ne,iridescenceThicknessMap:me,sheen:G,sheenColorMap:Se,sheenRoughnessMap:he,specularMap:ue,specularColorMap:Ae,specularIntensityMap:Ie,transmission:W,transmissionMap:Ue,thicknessMap:B,gradientMap:fe,opaque:g.transparent===!1&&g.blending===Zi&&g.alphaToCoverage===!1,alphaMap:te,alphaTest:pe,alphaHash:oe,combine:g.combine,mapUv:Oe&&x(g.map.channel),aoMapUv:We&&x(g.aoMap.channel),lightMapUv:je&&x(g.lightMap.channel),bumpMapUv:Ge&&x(g.bumpMap.channel),normalMapUv:Ze&&x(g.normalMap.channel),displacementMapUv:ht&&x(g.displacementMap.channel),emissiveMapUv:ot&&x(g.emissiveMap.channel),metalnessMapUv:nt&&x(g.metalnessMap.channel),roughnessMapUv:tt&&x(g.roughnessMap.channel),anisotropyMapUv:ee&&x(g.anisotropyMap.channel),clearcoatMapUv:le&&x(g.clearcoatMap.channel),clearcoatNormalMapUv:de&&x(g.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Q&&x(g.clearcoatRoughnessMap.channel),iridescenceMapUv:ne&&x(g.iridescenceMap.channel),iridescenceThicknessMapUv:me&&x(g.iridescenceThicknessMap.channel),sheenColorMapUv:Se&&x(g.sheenColorMap.channel),sheenRoughnessMapUv:he&&x(g.sheenRoughnessMap.channel),specularMapUv:ue&&x(g.specularMap.channel),specularColorMapUv:Ae&&x(g.specularColorMap.channel),specularIntensityMapUv:Ie&&x(g.specularIntensityMap.channel),transmissionMapUv:Ue&&x(g.transmissionMap.channel),thicknessMapUv:B&&x(g.thicknessMap.channel),alphaMapUv:te&&x(g.alphaMap.channel),vertexTangents:!!F.attributes.tangent&&(Ze||z),vertexNormals:!!F.attributes.normal,vertexColors:g.vertexColors,vertexAlphas:g.vertexColors===!0&&!!F.attributes.color&&F.attributes.color.itemSize===4,pointsUvs:N.isPoints===!0&&!!F.attributes.uv&&(Oe||te),fog:!!T,useFog:g.fog===!0,fogExp2:!!T&&T.isFogExp2,flatShading:g.wireframe===!1&&(g.flatShading===!0||F.attributes.normal===void 0&&Ze===!1&&(g.isMeshLambertMaterial||g.isMeshPhongMaterial||g.isMeshStandardMaterial||g.isMeshPhysicalMaterial)),sizeAttenuation:g.sizeAttenuation===!0,logarithmicDepthBuffer:p,reversedDepthBuffer:ce,skinning:N.isSkinnedMesh===!0,hasPositionAttribute:F.attributes.position!==void 0,morphTargets:F.morphAttributes.position!==void 0,morphNormals:F.morphAttributes.normal!==void 0,morphColors:F.morphAttributes.color!==void 0,morphTargetsCount:Y,morphTextureStride:ae,numSunLights:C.sun.length,numDirLights:C.directional.length,numPointLights:C.point.length,numSpotLights:C.spot.length,numSpotLightMaps:C.spotLightMap.length,numRectAreaLights:C.rectArea.length,numHemiLights:C.hemi.length,numSunLightShadows:C.sunShadowMap.length,numDirLightShadows:C.directionalShadowMap.length,numPointLightShadows:C.pointShadowMap.length,numSpotLightShadows:C.spotShadowMap.length,numSpotLightShadowsWithMaps:C.numSpotLightShadowsWithMaps,numLightProbes:C.numLightProbes,numLightProbeGrids:O.length,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:g.dithering,shadowMapEnabled:i.shadowMap.enabled&&R.length>0,shadowMapType:i.shadowMap.type,toneMapping:ie,decodeVideoTexture:Oe&&g.map.isVideoTexture===!0&&Ke.getTransfer(g.map.colorSpace)===at,decodeVideoTextureEmissive:ot&&g.emissiveMap.isVideoTexture===!0&&Ke.getTransfer(g.emissiveMap.colorSpace)===at,premultipliedAlpha:g.premultipliedAlpha,doubleSided:g.side===Ot,flipSided:g.side===Gt,useDepthPacking:g.depthPacking>=0,depthPacking:g.depthPacking||0,index0AttributeName:g.index0AttributeName,extensionClipCullDistance:se&&g.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(se&&g.extensions.multiDraw===!0||ge)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:g.customProgramCacheKey()};return re.vertexUv1s=l.has(1),re.vertexUv2s=l.has(2),re.vertexUv3s=l.has(3),l.clear(),re}function m(g){let C=[];if(g.shaderID?C.push(g.shaderID):(C.push(g.customVertexShaderID),C.push(g.customFragmentShaderID)),g.defines!==void 0)for(let R in g.defines)C.push(R),C.push(g.defines[R]);return g.isRawShaderMaterial===!1&&(h(C,g),w(C,g),C.push(i.outputColorSpace)),C.push(g.customProgramCacheKey),C.join()}function h(g,C){g.push(C.precision),g.push(C.outputColorSpace),g.push(C.envMapMode),g.push(C.envMapCubeUVHeight),g.push(C.mapUv),g.push(C.alphaMapUv),g.push(C.lightMapUv),g.push(C.aoMapUv),g.push(C.bumpMapUv),g.push(C.normalMapUv),g.push(C.displacementMapUv),g.push(C.emissiveMapUv),g.push(C.metalnessMapUv),g.push(C.roughnessMapUv),g.push(C.anisotropyMapUv),g.push(C.clearcoatMapUv),g.push(C.clearcoatNormalMapUv),g.push(C.clearcoatRoughnessMapUv),g.push(C.iridescenceMapUv),g.push(C.iridescenceThicknessMapUv),g.push(C.sheenColorMapUv),g.push(C.sheenRoughnessMapUv),g.push(C.specularMapUv),g.push(C.specularColorMapUv),g.push(C.specularIntensityMapUv),g.push(C.transmissionMapUv),g.push(C.thicknessMapUv),g.push(C.combine),g.push(C.fogExp2),g.push(C.sizeAttenuation),g.push(C.morphTargetsCount),g.push(C.morphAttributeCount),g.push(C.numSunLights),g.push(C.numDirLights),g.push(C.numPointLights),g.push(C.numSpotLights),g.push(C.numSpotLightMaps),g.push(C.numHemiLights),g.push(C.numRectAreaLights),g.push(C.numSunLightShadows),g.push(C.numDirLightShadows),g.push(C.numPointLightShadows),g.push(C.numSpotLightShadows),g.push(C.numSpotLightShadowsWithMaps),g.push(C.numLightProbes),g.push(C.shadowMapType),g.push(C.toneMapping),g.push(C.numClippingPlanes),g.push(C.numClipIntersection),g.push(C.depthPacking)}function w(g,C){r.disableAll(),C.instancing&&r.enable(0),C.instancingColor&&r.enable(1),C.instancingMorph&&r.enable(2),C.matcap&&r.enable(3),C.envMap&&r.enable(4),C.normalMapObjectSpace&&r.enable(5),C.normalMapTangentSpace&&r.enable(6),C.clearcoat&&r.enable(7),C.iridescence&&r.enable(8),C.alphaTest&&r.enable(9),C.vertexColors&&r.enable(10),C.vertexAlphas&&r.enable(11),C.vertexUv1s&&r.enable(12),C.vertexUv2s&&r.enable(13),C.vertexUv3s&&r.enable(14),C.vertexTangents&&r.enable(15),C.anisotropy&&r.enable(16),C.alphaHash&&r.enable(17),C.batching&&r.enable(18),C.dispersion&&r.enable(19),C.retroreflection&&r.enable(24),C.batchingColor&&r.enable(20),C.gradientMap&&r.enable(21),C.packedNormalMap&&r.enable(22),C.vertexNormals&&r.enable(23),g.push(r.mask),r.disableAll(),C.fog&&r.enable(0),C.useFog&&r.enable(1),C.flatShading&&r.enable(2),C.logarithmicDepthBuffer&&r.enable(3),C.reversedDepthBuffer&&r.enable(4),C.skinning&&r.enable(5),C.morphTargets&&r.enable(6),C.morphNormals&&r.enable(7),C.morphColors&&r.enable(8),C.premultipliedAlpha&&r.enable(9),C.shadowMapEnabled&&r.enable(10),C.doubleSided&&r.enable(11),C.flipSided&&r.enable(12),C.useDepthPacking&&r.enable(13),C.dithering&&r.enable(14),C.transmission&&r.enable(15),C.sheen&&r.enable(16),C.opaque&&r.enable(17),C.pointsUvs&&r.enable(18),C.decodeVideoTexture&&r.enable(19),C.decodeVideoTextureEmissive&&r.enable(20),C.alphaToCoverage&&r.enable(21),C.numLightProbeGrids>0&&r.enable(22),C.hasPositionAttribute&&r.enable(23),g.push(r.mask)}function A(g){let C=d[g.type],R;if(C){let P=wn[C];R=cd.clone(P.uniforms)}else R=g.uniforms;return R}function _(g,C){let R=u.get(C);return R!==void 0?++R.usedTimes:(R=new cg(i,C,g,s),c.push(R),u.set(C,R)),R}function b(g){if(--g.usedTimes===0){let C=c.indexOf(g);c[C]=c[c.length-1],c.pop(),u.delete(g.cacheKey),g.destroy()}}function y(g){o.remove(g)}function M(){o.dispose()}return{getParameters:E,getProgramCacheKey:m,getUniforms:A,acquireProgram:_,releaseProgram:b,releaseShaderCache:y,programs:c,dispose:M}}function fg(){let i=new WeakMap;function e(r){return i.has(r)}function t(r){let o=i.get(r);return o===void 0&&(o={},i.set(r,o)),o}function n(r){i.delete(r)}function s(r,o,l){i.get(r)[o]=l}function a(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:a}}function pg(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function Rd(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Nd(){let i=[],e=0,t=[],n=[],s=[];function a(){e=0,t.length=0,n.length=0,s.length=0}function r(f){let d=0;return f.isInstancedMesh&&(d+=2),f.isSkinnedMesh&&(d+=1),d}function o(f,d,x,E,m,h){let w=i[e];return w===void 0?(w={id:f.id,object:f,geometry:d,material:x,materialVariant:r(f),groupOrder:E,renderOrder:f.renderOrder,z:m,group:h},i[e]=w):(w.id=f.id,w.object=f,w.geometry=d,w.material=x,w.materialVariant=r(f),w.groupOrder=E,w.renderOrder=f.renderOrder,w.z=m,w.group=h),e++,w}function l(f,d,x,E,m,h,w){w.reversedDepth===!0&&(m=-m);let A=o(f,d,x,E,m,h);x.transmission>0?n.push(A):x.transparent===!0?s.push(A):t.push(A)}function c(f,d,x,E,m,h){let w=o(f,d,x,E,m,h);x.transmission>0?n.unshift(w):x.transparent===!0?s.unshift(w):t.unshift(w)}function u(f,d){t.length>1&&t.sort(f||pg),n.length>1&&n.sort(d||Rd),s.length>1&&s.sort(d||Rd)}function p(){for(let f=e,d=i.length;f<d;f++){let x=i[f];if(x.id===null)break;x.id=null,x.object=null,x.geometry=null,x.material=null,x.group=null}}return{opaque:t,transmissive:n,transparent:s,init:a,push:l,unshift:c,finish:p,sort:u}}function mg(){let i=new WeakMap;function e(n,s){let a=i.get(n),r;return a===void 0?(r=new Nd,i.set(n,[r])):s>=a.length?(r=new Nd,a.push(r)):r=a[s],r}function t(){i=new WeakMap}return{get:e,dispose:t}}function gg(){let i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"SunLight":case"DirectionalLight":t={direction:new k,color:new Ye};break;case"SpotLight":t={position:new k,direction:new k,color:new Ye,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new k,color:new Ye,distance:0,decay:0};break;case"HemisphereLight":t={direction:new k,skyColor:new Ye,groundColor:new Ye};break;case"RectAreaLight":t={color:new Ye,position:new k,halfWidth:new k,halfHeight:new k};break}return i[e.id]=t,t}}}function xg(){let i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"SunLight":case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new xe};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new xe};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new xe,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}var vg=0;function _g(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function yg(i){let e=new gg,t=xg(),n={version:0,hash:{sunLength:-1,directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numSunShadows:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],sun:[],sunShadow:[],sunShadowMap:[],sunShadowMatrix:[],sunShadowCascade:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new k);let s=new k,a=new gt,r=new gt;function o(c){let u=0,p=0,f=0;for(let N=0;N<9;N++)n.probe[N].set(0,0,0);let d=0,x=0,E=0,m=0,h=0,w=0,A=0,_=0,b=0,y=0,M=0,g=0,C=0,R=0;c.sort(_g);for(let N=0,O=c.length;N<O;N++){let T=c[N],F=T.color,L=T.intensity,V=T.distance,X=null;if(T.shadow&&T.shadow.map&&(T.shadow.map.texture.format===jn?X=T.shadow.map.texture:X=T.shadow.map.depthTexture||T.shadow.map.texture),T.isAmbientLight)u+=F.r*L,p+=F.g*L,f+=F.b*L;else if(T.isLightProbe){for(let H=0;H<9;H++)n.probe[H].addScaledVector(T.sh.coefficients[H],L);R++}else if(T.isSunLight){let H=e.get(T);if(H.color.copy(T.color).multiplyScalar(T.intensity),T.castShadow){let D=T.shadow,J=t.get(T);J.shadowIntensity=D.intensity,J.shadowBias=D.bias,J.shadowNormalBias=D.normalBias,J.shadowRadius=D.radius,J.shadowMapSize.copy(D.mapSize).multiply(D.getFrameExtents()),n.sunShadow[x]=J,n.sunShadowMap[x]=X;let Y=D.getViewportCount();for(let ae=0;ae<Y;ae++)n.sunShadowMatrix[E+ae]=D.getMatrix(ae),n.sunShadowCascade[E+ae]=D._cascadeData[ae];E+=Y,x++}n.sun[d]=H,d++}else if(T.isDirectionalLight){let H=e.get(T);if(H.color.copy(T.color).multiplyScalar(T.intensity),T.castShadow){let D=T.shadow,J=t.get(T);J.shadowIntensity=D.intensity,J.shadowBias=D.bias,J.shadowNormalBias=D.normalBias,J.shadowRadius=D.radius,J.shadowMapSize=D.mapSize,n.directionalShadow[m]=J,n.directionalShadowMap[m]=X,n.directionalShadowMatrix[m]=T.shadow.matrix,b++}n.directional[m]=H,m++}else if(T.isSpotLight){let H=e.get(T);H.position.setFromMatrixPosition(T.matrixWorld),H.color.copy(F).multiplyScalar(L),H.distance=V,H.coneCos=Math.cos(T.angle),H.penumbraCos=Math.cos(T.angle*(1-T.penumbra)),H.decay=T.decay,n.spot[w]=H;let D=T.shadow;if(T.map&&(n.spotLightMap[g]=T.map,g++,D.updateMatrices(T),T.castShadow&&C++),n.spotLightMatrix[w]=D.matrix,T.castShadow){let J=t.get(T);J.shadowIntensity=D.intensity,J.shadowBias=D.bias,J.shadowNormalBias=D.normalBias,J.shadowRadius=D.radius,J.shadowMapSize=D.mapSize,n.spotShadow[w]=J,n.spotShadowMap[w]=X,M++}w++}else if(T.isRectAreaLight){let H=e.get(T);H.color.copy(F).multiplyScalar(L),H.halfWidth.set(T.width*.5,0,0),H.halfHeight.set(0,T.height*.5,0),n.rectArea[A]=H,A++}else if(T.isPointLight){let H=e.get(T);if(H.color.copy(T.color).multiplyScalar(T.intensity),H.distance=T.distance,H.decay=T.decay,T.castShadow){let D=T.shadow,J=t.get(T);J.shadowIntensity=D.intensity,J.shadowBias=D.bias,J.shadowNormalBias=D.normalBias,J.shadowRadius=D.radius,J.shadowMapSize=D.mapSize,J.shadowCameraNear=D.camera.near,J.shadowCameraFar=D.camera.far,n.pointShadow[h]=J,n.pointShadowMap[h]=X,n.pointShadowMatrix[h]=T.shadow.matrix,y++}n.point[h]=H,h++}else if(T.isHemisphereLight){let H=e.get(T);H.skyColor.copy(T.color).multiplyScalar(L),H.groundColor.copy(T.groundColor).multiplyScalar(L),n.hemi[_]=H,_++}}A>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ve.LTC_FLOAT_1,n.rectAreaLTC2=ve.LTC_FLOAT_2):(n.rectAreaLTC1=ve.LTC_HALF_1,n.rectAreaLTC2=ve.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=p,n.ambient[2]=f;let P=n.hash;(P.sunLength!==d||P.directionalLength!==m||P.pointLength!==h||P.spotLength!==w||P.rectAreaLength!==A||P.hemiLength!==_||P.numSunShadows!==x||P.numDirectionalShadows!==b||P.numPointShadows!==y||P.numSpotShadows!==M||P.numSpotMaps!==g||P.numLightProbes!==R)&&(n.sun.length=d,n.directional.length=m,n.spot.length=w,n.rectArea.length=A,n.point.length=h,n.hemi.length=_,n.sunShadow.length=x,n.sunShadowMap.length=x,n.sunShadowMatrix.length=E,n.sunShadowCascade.length=E,n.directionalShadow.length=b,n.directionalShadowMap.length=b,n.directionalShadowMatrix.length=b,n.pointShadow.length=y,n.pointShadowMap.length=y,n.pointShadowMatrix.length=y,n.spotShadow.length=M,n.spotShadowMap.length=M,n.spotLightMatrix.length=M+g-C,n.spotLightMap.length=g,n.numSpotLightShadowsWithMaps=C,n.numLightProbes=R,P.sunLength=d,P.directionalLength=m,P.pointLength=h,P.spotLength=w,P.rectAreaLength=A,P.hemiLength=_,P.numSunShadows=x,P.numDirectionalShadows=b,P.numPointShadows=y,P.numSpotShadows=M,P.numSpotMaps=g,P.numLightProbes=R,n.version=vg++)}function l(c,u){let p=0,f=0,d=0,x=0,E=0,m=0,h=u.matrixWorldInverse;for(let w=0,A=c.length;w<A;w++){let _=c[w];if(_.isSunLight){let b=n.sun[p];b.direction.setFromMatrixPosition(_.matrixWorld),b.direction.transformDirection(h),p++}else if(_.isDirectionalLight){let b=n.directional[f];b.direction.setFromMatrixPosition(_.matrixWorld),s.setFromMatrixPosition(_.target.matrixWorld),b.direction.sub(s),b.direction.transformDirection(h),f++}else if(_.isSpotLight){let b=n.spot[x];b.position.setFromMatrixPosition(_.matrixWorld),b.position.applyMatrix4(h),b.direction.setFromMatrixPosition(_.matrixWorld),s.setFromMatrixPosition(_.target.matrixWorld),b.direction.sub(s),b.direction.transformDirection(h),x++}else if(_.isRectAreaLight){let b=n.rectArea[E];b.position.setFromMatrixPosition(_.matrixWorld),b.position.applyMatrix4(h),r.identity(),a.copy(_.matrixWorld),a.premultiply(h),r.extractRotation(a),b.halfWidth.set(_.width*.5,0,0),b.halfHeight.set(0,_.height*.5,0),b.halfWidth.applyMatrix4(r),b.halfHeight.applyMatrix4(r),E++}else if(_.isPointLight){let b=n.point[d];b.position.setFromMatrixPosition(_.matrixWorld),b.position.applyMatrix4(h),d++}else if(_.isHemisphereLight){let b=n.hemi[m];b.direction.setFromMatrixPosition(_.matrixWorld),b.direction.transformDirection(h),m++}}}return{setup:o,setupView:l,state:n}}function Id(i){let e=new yg(i),t=[],n=[],s=[];function a(f){p.camera=f,t.length=0,n.length=0,s.length=0}function r(f){t.push(f)}function o(f){n.push(f)}function l(f){s.push(f)}function c(){e.setup(t)}function u(f){e.setupView(t,f)}let p={lightsArray:t,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:a,state:p,setupLights:c,setupLightsView:u,pushLight:r,pushShadow:o,pushLightProbeGrid:l}}function bg(i){let e=new WeakMap;function t(s,a=0){let r=e.get(s),o;return r===void 0?(o=new Id(i),e.set(s,[o])):a>=r.length?(o=new Id(i),r.push(o)):o=r[a],o}function n(){e=new WeakMap}return{get:t,dispose:n}}var Sg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,Xl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new ws(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new jt({vertexShader:Ng,fragmentShader:Ig,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Xt(new Us(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},ql=class extends yn{constructor(e,t){super();let n=this,s=null,a=1,r=null,o="local-floor",l=1,c=null,u=null,p=null,f=null,d=null,x=null,E=typeof XRWebGLBinding<"u",m=new Xl,h={},w=t.getContextAttributes(),A=null,_=null,b=[],y=[],M=new xe,g=null,C=null,R=new Rt;R.viewport=new xt;let P=new Rt;P.viewport=new xt;let N=[R,P],O=new fr,T=null,F=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let j=b[K];return j===void 0&&(j=new Ui,b[K]=j),j.getTargetRaySpace()},this.getControllerGrip=function(K){let j=b[K];return j===void 0&&(j=new Ui,b[K]=j),j.getGripSpace()},this.getHand=function(K){let j=b[K];return j===void 0&&(j=new Ui,b[K]=j),j.getHandSpace()};function L(K){let j=y.indexOf(K.inputSource);if(j===-1)return;let ce=b[j];ce!==void 0&&(ce.update(K.inputSource,K.frame,c||r),ce.dispatchEvent({type:K.type,data:K.inputSource}))}function V(){s.removeEventListener("select",L),s.removeEventListener("selectstart",L),s.removeEventListener("selectend",L),s.removeEventListener("squeeze",L),s.removeEventListener("squeezestart",L),s.removeEventListener("squeezeend",L),s.removeEventListener("end",V),s.removeEventListener("inputsourceschange",X);for(let K=0;K<b.length;K++){let j=y[K];j!==null&&(y[K]=null,b[K].disconnect(j))}T=null,F=null,m.reset();for(let K in h)delete h[K];if(e.setRenderTarget(A),d=null,f=null,p=null,s=null,_=null,we.stop(),n.isPresenting=!1,e.setPixelRatio(g),e.setSize(M.width,M.height,!1),C!==null){let K=C.camera;K.fov=C.fov,K.zoom=C.zoom,K.updateProjectionMatrix(),C=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){a=K,n.isPresenting===!0&&De("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&De("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||r},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return f!==null?f:d},this.getBinding=function(){return p===null&&E&&(p=new XRWebGLBinding(s,t)),p},this.getFrame=function(){return x},this.getSession=function(){return s},this.setSession=async function(K){if(s=K,s!==null){if(A=e.getRenderTarget(),s.addEventListener("select",L),s.addEventListener("selectstart",L),s.addEventListener("selectend",L),s.addEventListener("squeeze",L),s.addEventListener("squeezestart",L),s.addEventListener("squeezeend",L),s.addEventListener("end",V),s.addEventListener("inputsourceschange",X),w.xrCompatible!==!0&&await t.makeXRCompatible(),g=e.getPixelRatio(),e.getSize(M),E&&"createProjectionLayer"in XRWebGLBinding.prototype){let ce=null,be=null,ge=null;w.depth&&(ge=w.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ce=w.stencil?Kn:_n,be=w.stencil?Ki:un);let Oe={colorFormat:t.RGBA8,depthFormat:ge,scaleFactor:a};p=this.getBinding(),f=p.createProjectionLayer(Oe),s.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),_=new Wt(f.textureWidth,f.textureHeight,{format:an,type:qt,depthTexture:new Wn(f.textureWidth,f.textureHeight,be,void 0,void 0,void 0,void 0,void 0,void 0,ce),stencilBuffer:w.stencil,colorSpace:e.outputColorSpace,samples:w.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1,storeMultisampledDepthBuffer:f.ignoreDepthValues===!1,storeMultisampledStencilBuffer:f.ignoreDepthValues===!1})}else{let ce={antialias:w.antialias,alpha:!0,depth:w.depth,stencil:w.stencil,framebufferScaleFactor:a};d=new XRWebGLLayer(s,t,ce),s.updateRenderState({baseLayer:d}),e.setPixelRatio(1),e.setSize(d.framebufferWidth,d.framebufferHeight,!1),_=new Wt(d.framebufferWidth,d.framebufferHeight,{format:an,type:qt,colorSpace:e.outputColorSpace,stencilBuffer:w.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1,storeMultisampledDepthBuffer:d.ignoreDepthValues===!1,storeMultisampledStencilBuffer:d.ignoreDepthValues===!1})}_.isXRRenderTarget=!0,this.setFoveation(l),c=null,r=await s.requestReferenceSpace(o),we.setContext(s),we.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function X(K){for(let j=0;j<K.removed.length;j++){let ce=K.removed[j],be=y.indexOf(ce);be>=0&&(y[be]=null,b[be].disconnect(ce))}for(let j=0;j<K.added.length;j++){let ce=K.added[j],be=y.indexOf(ce);if(be===-1){for(let Oe=0;Oe<b.length;Oe++)if(Oe>=y.length){y.push(ce),be=Oe;break}else if(y[Oe]===null){y[Oe]=ce,be=Oe;break}if(be===-1)break}let ge=b[be];ge&&ge.connect(ce)}}let H=new k,D=new k;function J(K,j,ce){H.setFromMatrixPosition(j.matrixWorld),D.setFromMatrixPosition(ce.matrixWorld);let be=H.distanceTo(D),ge=j.projectionMatrix.elements,Oe=ce.projectionMatrix.elements,dt=ge[14]/(ge[10]-1),ze=ge[14]/(ge[10]+1),We=(ge[9]+1)/ge[5],je=(ge[9]-1)/ge[5],Ge=(ge[8]-1)/ge[0],Ze=(Oe[8]+1)/Oe[0],ht=dt*Ge,ot=dt*Ze,nt=be/(-Ge+Ze),tt=nt*-Ge;if(j.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(tt),K.translateZ(nt),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),ge[10]===-1)K.projectionMatrix.copy(j.projectionMatrix),K.projectionMatrixInverse.copy(j.projectionMatrixInverse);else{let z=dt+nt,He=ze+nt,Ve=ht-tt,I=ot+(be-tt),v=We*ze/He*z,G=je*ze/He*z;K.projectionMatrix.makePerspective(Ve,I,v,G,z,He),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function Y(K,j){j===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(j.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(s===null)return;let j=K.near,ce=K.far;m.texture!==null&&(m.depthNear>0&&(j=m.depthNear),m.depthFar>0&&(ce=m.depthFar)),O.near=P.near=R.near=j,O.far=P.far=R.far=ce,(T!==O.near||F!==O.far)&&(s.updateRenderState({depthNear:O.near,depthFar:O.far}),T=O.near,F=O.far),O.layers.mask=K.layers.mask|6,R.layers.mask=O.layers.mask&-5,P.layers.mask=O.layers.mask&-3;let be=K.parent,ge=O.cameras;Y(O,be);for(let Oe=0;Oe<ge.length;Oe++)Y(ge[Oe],be);ge.length===2?J(O,R,P):O.projectionMatrix.copy(R.projectionMatrix),C===null&&K.isPerspectiveCamera&&(C={camera:K,fov:K.fov,zoom:K.zoom}),ae(K,O,be)};function ae(K,j,ce){ce===null?K.matrix.copy(j.matrixWorld):(K.matrix.copy(ce.matrixWorld),K.matrix.invert(),K.matrix.multiply(j.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(j.projectionMatrix),K.projectionMatrixInverse.copy(j.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Va*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return O},this.getFoveation=function(){if(!(f===null&&d===null))return l},this.setFoveation=function(K){l=K,f!==null&&(f.fixedFoveation=K),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(O)},this.getCameraTexture=function(K){return h[K]};let Pe=null;function Ee(K,j){if(u=j.getViewerPose(c||r),x=j,u!==null){let ce=u.views;d!==null&&(e.setRenderTargetFramebuffer(_,d.framebuffer),e.setRenderTarget(_));let be=!1;ce.length!==O.cameras.length&&(O.cameras.length=0,be=!0);for(let ze=0;ze<ce.length;ze++){let We=ce[ze],je=null;if(d!==null)je=d.getViewport(We);else{let Ze=p.getViewSubImage(f,We);je=Ze.viewport,ze===0&&(e.setRenderTargetTextures(_,Ze.colorTexture,Ze.depthStencilTexture),e.setRenderTarget(_))}let Ge=N[ze];Ge===void 0&&(Ge=new Rt,Ge.layers.enable(ze),Ge.viewport=new xt,N[ze]=Ge),Ge.matrix.fromArray(We.transform.matrix),Ge.matrix.decompose(Ge.position,Ge.quaternion,Ge.scale),Ge.projectionMatrix.fromArray(We.projectionMatrix),Ge.projectionMatrixInverse.copy(Ge.projectionMatrix).invert(),Ge.viewport.set(je.x,je.y,je.width,je.height),ze===0&&(O.matrix.copy(Ge.matrix),O.matrix.decompose(O.position,O.quaternion,O.scale)),be===!0&&O.cameras.push(Ge)}let ge=s.enabledFeatures;if(ge&&ge.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&E){p=n.getBinding();let ze=p.getDepthInformation(ce[0]);ze&&ze.isValid&&ze.texture&&m.init(ze,s.renderState)}if(ge&&ge.includes("camera-access")&&E){e.state.unbindTexture(),p=n.getBinding();for(let ze=0;ze<ce.length;ze++){let We=ce[ze].camera;if(We){let je=h[We];je||(je=new ws,h[We]=je);let Ge=p.getCameraImage(We);je.sourceTexture=Ge}}}}for(let ce=0;ce<b.length;ce++){let be=y[ce],ge=b[ce];be!==null&&ge!==void 0&&ge.update(be,j,c||r)}Pe&&Pe(K,j),j.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:j}),x=null}let we=new Ld;we.setAnimationLoop(Ee),this.setAnimationLoop=function(K){Pe=K},this.dispose=function(){}}},Pg=new gt,kd=new ke;kd.set(-1,0,0,0,1,0,0,0,1);function Lg(i,e){function t(m,h){m.matrixAutoUpdate===!0&&m.updateMatrix(),h.value.copy(m.matrix)}function n(m,h){h.color.getRGB(m.fogColor.value,Ml(i)),h.isFog?(m.fogNear.value=h.near,m.fogFar.value=h.far):h.isFogExp2&&(m.fogDensity.value=h.density)}function s(m,h,w,A,_){h.isNodeMaterial?h.uniformsNeedUpdate=!1:h.isMeshBasicMaterial?a(m,h):h.isMeshLambertMaterial?(a(m,h),h.envMap&&(m.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(a(m,h),p(m,h)):h.isMeshPhongMaterial?(a(m,h),u(m,h),h.envMap&&(m.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(a(m,h),f(m,h),h.isMeshPhysicalMaterial&&d(m,h,_)):h.isMeshMatcapMaterial?(a(m,h),x(m,h)):h.isMeshDepthMaterial?a(m,h):h.isMeshDistanceMaterial?(a(m,h),E(m,h)):h.isMeshNormalMaterial?a(m,h):h.isLineBasicMaterial?(r(m,h),h.isLineDashedMaterial&&o(m,h)):h.isPointsMaterial?l(m,h,w,A):h.isSpriteMaterial?c(m,h):h.isShadowMaterial?(m.color.value.copy(h.color),m.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function a(m,h){m.opacity.value=h.opacity,h.color&&m.diffuse.value.copy(h.color),h.emissive&&m.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(m.map.value=h.map,t(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.bumpMap&&(m.bumpMap.value=h.bumpMap,t(h.bumpMap,m.bumpMapTransform),m.bumpScale.value=h.bumpScale,h.side===Gt&&(m.bumpScale.value*=-1)),h.normalMap&&(m.normalMap.value=h.normalMap,t(h.normalMap,m.normalMapTransform),m.normalScale.value.copy(h.normalScale),h.side===Gt&&m.normalScale.value.negate()),h.displacementMap&&(m.displacementMap.value=h.displacementMap,t(h.displacementMap,m.displacementMapTransform),m.displacementScale.value=h.displacementScale,m.displacementBias.value=h.displacementBias),h.emissiveMap&&(m.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,m.emissiveMapTransform)),h.specularMap&&(m.specularMap.value=h.specularMap,t(h.specularMap,m.specularMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest);let w=e.get(h),A=w.envMap,_=w.envMapRotation;A&&(m.envMap.value=A,m.envMapRotation.value.setFromMatrix4(Pg.makeRotationFromEuler(_)).transpose(),A.isCubeTexture&&A.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(kd),m.reflectivity.value=h.reflectivity,m.ior.value=h.ior,m.refractionRatio.value=h.refractionRatio),h.lightMap&&(m.lightMap.value=h.lightMap,m.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,m.lightMapTransform)),h.aoMap&&(m.aoMap.value=h.aoMap,m.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,m.aoMapTransform))}function r(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,h.map&&(m.map.value=h.map,t(h.map,m.mapTransform))}function o(m,h){m.dashSize.value=h.dashSize,m.totalSize.value=h.dashSize+h.gapSize,m.scale.value=h.scale}function l(m,h,w,A){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.size.value=h.size*w,m.scale.value=A*.5,h.map&&(m.map.value=h.map,t(h.map,m.uvTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function c(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.rotation.value=h.rotation,h.map&&(m.map.value=h.map,t(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function u(m,h){m.specular.value.copy(h.specular),m.shininess.value=Math.max(h.shininess,1e-4)}function p(m,h){h.gradientMap&&(m.gradientMap.value=h.gradientMap)}function f(m,h){m.metalness.value=h.metalness,h.metalnessMap&&(m.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,m.metalnessMapTransform)),m.roughness.value=h.roughness,h.roughnessMap&&(m.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,m.roughnessMapTransform)),h.envMap&&(m.envMapIntensity.value=h.envMapIntensity)}function d(m,h,w){m.ior.value=h.ior,h.sheen>0&&(m.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),m.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(m.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,m.sheenColorMapTransform)),h.sheenRoughnessMap&&(m.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,m.sheenRoughnessMapTransform))),h.clearcoat>0&&(m.clearcoat.value=h.clearcoat,m.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(m.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,m.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(m.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Gt&&m.clearcoatNormalScale.value.negate())),h.dispersion>0&&(m.dispersion.value=h.dispersion),h.retroreflectivity>0&&(m.retroreflectivity.value=h.retroreflectivity),h.iridescence>0&&(m.iridescence.value=h.iridescence,m.iridescenceIOR.value=h.iridescenceIOR,m.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(m.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,m.iridescenceMapTransform)),h.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),h.transmission>0&&(m.transmission.value=h.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),h.transmissionMap&&(m.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,m.transmissionMapTransform)),m.thickness.value=h.thickness,h.thicknessMap&&(m.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=h.attenuationDistance,m.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(m.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(m.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=h.specularIntensity,m.specularColor.value.copy(h.specularColor),h.specularColorMap&&(m.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,m.specularColorMapTransform)),h.specularIntensityMap&&(m.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,h){h.matcap&&(m.matcap.value=h.matcap)}function E(m,h){let w=e.get(h).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Dg(i,e,t,n){let s={},a={},r=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(_,b){let y=b.program;n.uniformBlockBinding(_,y)}function c(_,b){let y=s[_.id];y===void 0&&(m(_),y=u(_),s[_.id]=y,_.addEventListener("dispose",w));let M=b.program;n.updateUBOMapping(_,M);let g=e.render.frame;a[_.id]!==g&&(f(_),a[_.id]=g)}function u(_){let b=p();_.__bindingPointIndex=b;let y=i.createBuffer(),M=_.__size,g=_.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,M,g),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,y),y}function p(){for(let _=0;_<o;_++)if(r.indexOf(_)===-1)return r.push(_),_;return Fe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(_){let b=s[_.id],y=_.uniforms,M=_.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let g=0,C=y.length;g<C;g++){let R=y[g];if(Array.isArray(R))for(let P=0,N=R.length;P<N;P++)d(R[P],g,P,M);else d(R,g,0,M)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function d(_,b,y,M){if(E(_,b,y,M)===!0){let g=_.__offset,C=_.value;if(Array.isArray(C)){let R=0;for(let P=0;P<C.length;P++){let N=C[P],O=h(N);x(N,_.__data,R),typeof N!="number"&&typeof N!="boolean"&&!N.isMatrix3&&!ArrayBuffer.isView(N)&&(R+=O.storage/Float32Array.BYTES_PER_ELEMENT)}}else x(C,_.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,g,_.__data)}}function x(_,b,y){typeof _=="number"||typeof _=="boolean"?b[0]=_:_.isMatrix3?(b[0]=_.elements[0],b[1]=_.elements[1],b[2]=_.elements[2],b[3]=0,b[4]=_.elements[3],b[5]=_.elements[4],b[6]=_.elements[5],b[7]=0,b[8]=_.elements[6],b[9]=_.elements[7],b[10]=_.elements[8],b[11]=0):ArrayBuffer.isView(_)?b.set(new _.constructor(_.buffer,_.byteOffset,b.length)):_.toArray(b,y)}function E(_,b,y,M){let g=_.value,C=b+"_"+y;if(M[C]===void 0)return typeof g=="number"||typeof g=="boolean"?M[C]=g:ArrayBuffer.isView(g)?M[C]=g.slice():M[C]=g.clone(),!0;{let R=M[C];if(typeof g=="number"||typeof g=="boolean"){if(R!==g)return M[C]=g,!0}else{if(ArrayBuffer.isView(g))return!0;if(R.equals(g)===!1)return R.copy(g),!0}}return!1}function m(_){let b=_.uniforms,y=0,M=16;for(let C=0,R=b.length;C<R;C++){let P=Array.isArray(b[C])?b[C]:[b[C]];for(let N=0,O=P.length;N<O;N++){let T=P[N],F=Array.isArray(T.value)?T.value:[T.value];for(let L=0,V=F.length;L<V;L++){let X=F[L],H=h(X),D=y%M,J=D%H.boundary,Y=D+J;y+=J,Y!==0&&M-Y<H.storage&&(y+=M-Y),T.__data=new Float32Array(H.storage/Float32Array.BYTES_PER_ELEMENT),T.__offset=y,y+=H.storage}}}let g=y%M;return g>0&&(y+=M-g),_.__size=y,_.__cache={},this}function h(_){let b={boundary:0,storage:0};return typeof _=="number"||typeof _=="boolean"?(b.boundary=4,b.storage=4):_.isVector2?(b.boundary=8,b.storage=8):_.isVector3||_.isColor?(b.boundary=16,b.storage=12):_.isVector4?(b.boundary=16,b.storage=16):_.isMatrix3?(b.boundary=48,b.storage=48):_.isMatrix4?(b.boundary=64,b.storage=64):_.isTexture?De("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(_)?(b.boundary=16,b.storage=_.byteLength):De("WebGLRenderer: Unsupported uniform value type.",_),b}function w(_){let b=_.target;b.removeEventListener("dispose",w);let y=r.indexOf(b.__bindingPointIndex);r.splice(y,1),i.deleteBuffer(s[b.id]),delete s[b.id],delete a[b.id]}function A(){for(let _ in s)i.deleteBuffer(s[_]);r=[],s={},a={}}return{bind:l,update:c,dispose:A}}var Ug=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Mn=null;function Fg(){return Mn===null&&(Mn=new $a(Ug,16,16,jn,pn),Mn.name="DFG_LUT",Mn.minFilter=Nt,Mn.magFilter=Nt,Mn.wrapS=vn,Mn.wrapT=vn,Mn.generateMipmaps=!1,Mn.needsUpdate=!0),Mn}var lo=class{constructor(e={}){let{canvas:t=ed(),context:n=null,depth:s=!0,stencil:a=!1,alpha:r=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:f=!1,outputBufferType:d=qt}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=n.getContextAttributes().alpha}else x=r;let E=d,m=new Set([wr,Mr,Sr]),h=new Set([qt,un,Ji,Ki,yr,br]),w=new Uint32Array(4),A=new Int32Array(4),_=new k,b=null,y=null,M=[],g=[],C=null;this.domElement=t,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=hn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let R=this,P=!1,N=null,O=null,T=null,F=null;this._outputColorSpace=zt;let L=0,V=0,X=null,H=-1,D=null,J=new xt,Y=new xt,ae=null,Pe=new Ye(0),Ee=0,we=t.width,K=t.height,j=1,ce=null,be=null,ge=new xt(0,0,we,K),Oe=new xt(0,0,we,K),dt=!1,ze=new Oi,We=!1,je=!1,Ge=new gt,Ze=new k,ht=new xt,ot={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},nt=!1;function tt(){return X===null?j:1}let z=n;function He(S,U){return t.getContext(S,U)}let Ve,I,v,G,W,ee,le,de,Q,ne,me,Se,he,ue,Ae,Ie,Ue,B,fe,te,pe,oe,se;try{let S={alpha:!0,depth:s,stencil:a,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"186"}`),t.addEventListener("webglcontextlost",Le,!1),t.addEventListener("webglcontextrestored",Be,!1),t.addEventListener("webglcontextcreationerror",it,!1),z===null){let U="webgl2";if(z=He(U,S),z===null)throw He(U)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}ie()}catch(S){throw t.removeEventListener("webglcontextlost",Le,!1),t.removeEventListener("webglcontextrestored",Be,!1),t.removeEventListener("webglcontextcreationerror",it,!1),Fe("WebGLRenderer: "+S.message),S}function ie(){Ve=new Hp(z),Ve.init(),pe=new Rg(z,Ve),I=new Lp(z,Ve,e,pe),v=new Ag(z,Ve),I.reversedDepthBuffer&&f&&v.buffers.depth.setReversed(!0),O=z.createFramebuffer(),T=z.createFramebuffer(),F=z.createFramebuffer(),G=new qp(z),W=new fg,ee=new Cg(z,Ve,v,W,I,pe,G),le=new Vp(R),de=new $h(z),oe=new Ip(z,de),Q=new Wp(z,de,G,oe),ne=new Yp(z,Q,de,oe,G),B=new $p(z,I,ee),Ae=new Dp(W),me=new ug(R,le,Ve,I,oe,Ae),Se=new Lg(R,W),he=new mg,ue=new bg(Ve),Ue=new Np(R,le,v,ne,x,l),Ie=new Eg(R,ne,I),se=new Dg(z,G,I,v),fe=new Pp(z,Ve,G),te=new Xp(z,Ve,G),G.programs=me.programs,R.capabilities=I,R.extensions=Ve,R.properties=W,R.renderLists=he,R.shadowMap=Ie,R.state=v,R.info=G}E!==qt&&(C=new Jp(E,t.width,t.height,o,s,a));let re=new ql(R,z);this.xr=re,this.getContext=function(){return z},this.getContextAttributes=function(){return z.getContextAttributes()},this.forceContextLoss=function(){let S=Ve.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){let S=Ve.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return j},this.setPixelRatio=function(S){S!==void 0&&(j=S,this.setSize(we,K,!1))},this.getSize=function(S){return S.set(we,K)},this.setSize=function(S,U,Z=!0){if(re.isPresenting){De("WebGLRenderer: Can't change size while VR device is presenting.");return}we=S,K=U,t.width=Math.floor(S*j),t.height=Math.floor(U*j),Z===!0&&(t.style.width=S+"px",t.style.height=U+"px"),C!==null&&C.setSize(t.width,t.height),this.setViewport(0,0,S,U)},this.getDrawingBufferSize=function(S){return S.set(we*j,K*j).floor()},this.setDrawingBufferSize=function(S,U,Z){we=S,K=U,j=Z,t.width=Math.floor(S*Z),t.height=Math.floor(U*Z),this.setViewport(0,0,S,U)},this.setEffects=function(S){if(E===qt){Fe("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let U=0;U<S.length;U++)if(S[U].isOutputPass===!0){De("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}C.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(J)},this.getViewport=function(S){return S.copy(ge)},this.setViewport=function(S,U,Z,q){S.isVector4?ge.set(S.x,S.y,S.z,S.w):ge.set(S,U,Z,q),v.viewport(J.copy(ge).multiplyScalar(j).round())},this.getScissor=function(S){return S.copy(Oe)},this.setScissor=function(S,U,Z,q){S.isVector4?Oe.set(S.x,S.y,S.z,S.w):Oe.set(S,U,Z,q),v.scissor(Y.copy(Oe).multiplyScalar(j).round())},this.getScissorTest=function(){return dt},this.setScissorTest=function(S){v.setScissorTest(dt=S)},this.setOpaqueSort=function(S){ce=S},this.setTransparentSort=function(S){be=S},this.getClearColor=function(S){return S.copy(Ue.getClearColor())},this.setClearColor=function(){Ue.setClearColor(...arguments)},this.getClearAlpha=function(){return Ue.getClearAlpha()},this.setClearAlpha=function(){Ue.setClearAlpha(...arguments)},this.clear=function(S=!0,U=!0,Z=!0){let q=0;if(S){let $=!1;if(X!==null){let ye=X.texture.format;$=m.has(ye)}if($){let ye=X.texture.type,Te=h.has(ye),_e=Ue.getClearColor(),Ce=Ue.getClearAlpha(),Ne=_e.r,Xe=_e.g,Je=_e.b;Te?(w[0]=Ne,w[1]=Xe,w[2]=Je,w[3]=Ce,z.clearBufferuiv(z.COLOR,0,w)):(A[0]=Ne,A[1]=Xe,A[2]=Je,A[3]=Ce,z.clearBufferiv(z.COLOR,0,A))}else q|=z.COLOR_BUFFER_BIT}U&&(q|=z.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),Z&&(q|=z.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),q!==0&&z.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(S){S.setRenderer(this),N=S},this.dispose=function(){t.removeEventListener("webglcontextlost",Le,!1),t.removeEventListener("webglcontextrestored",Be,!1),t.removeEventListener("webglcontextcreationerror",it,!1),Ue.dispose(),he.dispose(),ue.dispose(),W.dispose(),le.dispose(),ne.dispose(),oe.dispose(),se.dispose(),me.dispose(),re.dispose(),re.removeEventListener("sessionstart",Qn),re.removeEventListener("sessionend",Yt),_t.stop()};function Le(S){S.preventDefault(),bl("WebGLRenderer: Context Lost."),P=!0}function Be(){bl("WebGLRenderer: Context Restored."),P=!1;let S=G.autoReset,U=Ie.enabled,Z=Ie.autoUpdate,q=Ie.needsUpdate,$=Ie.type;ie(),G.autoReset=S,Ie.enabled=U,Ie.autoUpdate=Z,Ie.needsUpdate=q,Ie.type=$}function it(S){Fe("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function mt(S){let U=S.target;U.removeEventListener("dispose",mt),Qe(U)}function Qe(S){mn(S),W.remove(S)}function mn(S){let U=W.get(S).programs;U!==void 0&&(U.forEach(function(Z){me.releaseProgram(Z)}),S.isShaderMaterial&&me.releaseShaderCache(S))}this.renderBufferDirect=function(S,U,Z,q,$,ye){U===null&&(U=ot);let Te=$.isMesh&&$.matrixWorld.determinantAffine()<0,_e=oa(S,U,Z,q,$);v.setMaterial(q,Te);let Ce=Z.index,Ne=1;if(q.wireframe===!0){if(Ce=Q.getWireframeAttribute(Z),Ce===void 0)return;Ne=2}let Xe=Z.drawRange,Je=Z.attributes.position,Re=Xe.start*Ne,st=(Xe.start+Xe.count)*Ne;ye!==null&&(Re=Math.max(Re,ye.start*Ne),st=Math.min(st,(ye.start+ye.count)*Ne)),Ce!==null?(Re=Math.max(Re,0),st=Math.min(st,Ce.count)):Je!=null&&(Re=Math.max(Re,0),st=Math.min(st,Je.count));let St=st-Re;if(St<0||St===1/0)return;oe.setup($,q,_e,Z,Ce);let ft,ct=fe;if(Ce!==null&&(ft=de.get(Ce),ct=te,ct.setIndex(ft)),$.isMesh)q.wireframe===!0?(v.setLineWidth(q.wireframeLinewidth*tt()),ct.setMode(z.LINES)):ct.setMode(z.TRIANGLES);else if($.isLine){let Pt=q.linewidth;Pt===void 0&&(Pt=1),v.setLineWidth(Pt*tt()),$.isLineSegments?ct.setMode(z.LINES):$.isLineLoop?ct.setMode(z.LINE_LOOP):ct.setMode(z.LINE_STRIP)}else $.isPoints?ct.setMode(z.POINTS):$.isSprite&&ct.setMode(z.TRIANGLES);if($.isBatchedMesh)if(Ve.get("WEBGL_multi_draw"))ct.renderMultiDraw($._multiDrawStarts,$._multiDrawCounts,$._multiDrawCount);else{let Pt=$._multiDrawStarts,Me=$._multiDrawCounts,kt=$._multiDrawCount,et=Ce?de.get(Ce).bytesPerElement:1,en=W.get(q).currentProgram.getUniforms();for(let gn=0;gn<kt;gn++)en.setValue(z,"_gl_DrawID",gn),ct.render(Pt[gn]/et,Me[gn])}else if($.isInstancedMesh)ct.renderInstances(Re,St,$.count);else if(Z.isInstancedBufferGeometry){let Pt=Z._maxInstanceCount!==void 0?Z._maxInstanceCount:1/0,Me=Math.min(Z.instanceCount,Pt);ct.renderInstances(Re,St,Me)}else ct.render(Re,St)};function It(S,U,Z,q){N!==null&&S.isNodeMaterial&&N.setObject(q,S),We===!0&&Ae.setState(S,Z,!1),S.transparent===!0&&S.side===Ot&&S.forceSinglePass===!1?(S.side=Gt,S.needsUpdate=!0,fi(S,U,q),S.side=Yn,S.needsUpdate=!0,fi(S,U,q),S.side=Ot):fi(S,U,q)}this.compile=function(S,U,Z=null){Z===null&&(Z=S),N!==null&&N.renderStart(S,U,Z),y=ue.get(Z),y.init(U),g.push(y),Z.traverseVisible(function($){$.isLight&&$.layers.test(U.layers)&&(y.pushLight($),$.castShadow&&y.pushShadow($))}),S!==Z&&S.traverseVisible(function($){$.isLight&&$.layers.test(U.layers)&&(y.pushLight($),$.castShadow&&y.pushShadow($))}),y.setupLights(),N!==null&&N.updateLights(y.state.lightsArray),je=this.localClippingEnabled,We=Ae.init(this.clippingPlanes,je),We===!0&&Ae.setGlobalState(this.clippingPlanes,U),N!==null&&Ie.render(y.state.shadowsArray,Z,U);let q=new Set;return S.traverse(function($){if(!($.isMesh||$.isPoints||$.isLine||$.isSprite))return;let ye=$.material;if(ye)if(Array.isArray(ye))for(let Te=0;Te<ye.length;Te++){let _e=ye[Te];It(_e,Z,U,$),q.add(_e)}else It(ye,Z,U,$),q.add(ye)}),y=g.pop(),N!==null&&N.renderEnd(),q},this.compileAsync=function(S,U,Z=null){let q=this.compile(S,U,Z);return new Promise($=>{function ye(){if(q.forEach(function(Te){let Ce=W.get(Te).currentProgram;(Ce===void 0||Ce.isReady())&&q.delete(Te)}),q.size===0){$(S);return}setTimeout(ye,10)}Ve.get("KHR_parallel_shader_compile")!==null?ye():setTimeout(ye,10)})};let bt=null;function $t(S){bt&&bt(S)}function Qn(){_t.stop()}function Yt(){_t.start()}let _t=new Ld;_t.setAnimationLoop($t),typeof self<"u"&&_t.setContext(self),this.setAnimationLoop=function(S){bt=S,re.setAnimationLoop(S),S===null?_t.stop():_t.start()},re.addEventListener("sessionstart",Qn),re.addEventListener("sessionend",Yt),this.render=function(S,U){if(U!==void 0&&U.isCamera!==!0){Fe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;N!==null&&N.renderStart(S,U);let Z=re.enabled===!0&&re.isPresenting===!0,q=C!==null&&(X===null||Z)&&C.begin(R,X);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),re.enabled===!0&&re.isPresenting===!0&&(C===null||C.isCompositing()===!1)&&(re.cameraAutoUpdate===!0&&re.updateCamera(U),U=re.getCamera()),S.isScene===!0&&S.onBeforeRender(R,S,U,X),y=ue.get(S,g.length),y.init(U),y.state.textureUnits=ee.getTextureUnits(),g.push(y),Ge.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),ze.setFromProjectionMatrix(Ge,dn,U.reversedDepth),je=this.localClippingEnabled,We=Ae.init(this.clippingPlanes,je),b=he.get(S,M.length),b.init(),M.push(b),re.enabled===!0&&re.isPresenting===!0){let Te=R.xr.getDepthSensingMesh();Te!==null&&Et(Te,U,-1/0,R.sortObjects)}Et(S,U,0,R.sortObjects),b.finish(),N!==null&&N.updateLights(y.state.lightsArray),R.sortObjects===!0&&b.sort(ce,be),nt=re.enabled===!1||re.isPresenting===!1||re.hasDepthSensing()===!1,nt&&Ue.addToRenderList(b,S),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),We===!0&&Ae.beginShadows();let $=y.state.shadowsArray;if(Ie.render($,S,U),We===!0&&Ae.endShadows(),(q&&C.hasRenderPass())===!1){let Te=b.opaque,_e=b.transmissive;if(y.setupLights(),U.isArrayCamera){let Ce=U.cameras;if(_e.length>0)for(let Ne=0,Xe=Ce.length;Ne<Xe;Ne++){let Je=Ce[Ne];is(Te,_e,S,Je)}nt&&Ue.render(S);for(let Ne=0,Xe=Ce.length;Ne<Xe;Ne++){let Je=Ce[Ne];ei(b,S,Je,Je.viewport)}}else _e.length>0&&is(Te,_e,S,U),nt&&Ue.render(S),ei(b,S,U)}X!==null&&V===0&&(ee.updateMultisampleRenderTarget(X),ee.updateRenderTargetMipmap(X)),q&&C.end(R),S.isScene===!0&&S.onAfterRender(R,S,U),oe.resetDefaultState(),H=-1,D=null,g.pop(),g.length>0?(y=g[g.length-1],ee.setTextureUnits(y.state.textureUnits),We===!0&&Ae.setGlobalState(R.clippingPlanes,y.state.camera)):y=null,M.pop(),M.length>0?b=M[M.length-1]:b=null,N!==null&&N.renderEnd()};function Et(S,U,Z,q){if(S.visible===!1)return;if(S.layers.test(U.layers)){if(S.isGroup)Z=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(U);else if(S.isLightProbeGrid)y.pushLightProbeGrid(S);else if(S.isLight)y.pushLight(S),S.castShadow&&y.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||S.intersectsFrustum(ze)){q&&ht.setFromMatrixPosition(S.matrixWorld).applyMatrix4(Ge);let Te=ne.update(S),_e=S.material;_e.visible&&b.push(S,Te,_e,Z,ht.z,null,U)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||S.intersectsFrustum(ze))){let Te=ne.update(S),_e=S.material;if(q&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),ht.copy(S.boundingSphere.center)):(Te.boundingSphere===null&&Te.computeBoundingSphere(),ht.copy(Te.boundingSphere.center)),ht.applyMatrix4(S.matrixWorld).applyMatrix4(Ge)),Array.isArray(_e)){let Ce=Te.groups;for(let Ne=0,Xe=Ce.length;Ne<Xe;Ne++){let Je=Ce[Ne],Re=_e[Je.materialIndex];Re&&Re.visible&&b.push(S,Te,Re,Z,ht.z,Je,U)}}else _e.visible&&b.push(S,Te,_e,Z,ht.z,null,U)}}let ye=S.children;for(let Te=0,_e=ye.length;Te<_e;Te++)Et(ye[Te],U,Z,q)}function ei(S,U,Z,q){let{opaque:$,transmissive:ye,transparent:Te}=S;y.setupLightsView(Z),We===!0&&Ae.setGlobalState(R.clippingPlanes,Z),q&&v.viewport(J.copy(q)),$.length>0&&ui($,U,Z),ye.length>0&&ui(ye,U,Z),Te.length>0&&ui(Te,U,Z),v.buffers.depth.setTest(!0),v.buffers.depth.setMask(!0),v.buffers.color.setMask(!0),v.setPolygonOffset(!1)}function is(S,U,Z,q){if((Z.isScene===!0?Z.overrideMaterial:null)!==null)return;if(y.state.transmissionRenderTarget[q.id]===void 0){let Re=Ve.has("EXT_color_buffer_half_float")||Ve.has("EXT_color_buffer_float");y.state.transmissionRenderTarget[q.id]=new Wt(1,1,{generateMipmaps:!0,type:Re?pn:qt,minFilter:Jn,samples:Math.max(4,I.samples),stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:Ke.workingColorSpace})}let ye=y.state.transmissionRenderTarget[q.id],Te=q.viewport||J;ye.setSize(Te.z*R.transmissionResolutionScale,Te.w*R.transmissionResolutionScale);let _e=R.getRenderTarget(),Ce=R.getActiveCubeFace(),Ne=R.getActiveMipmapLevel();R.setRenderTarget(ye),R.getClearColor(Pe),Ee=R.getClearAlpha(),Ee<1&&R.setClearColor(16777215,.5),R.clear(),nt&&Ue.render(Z);let Xe=R.toneMapping;R.toneMapping=hn;let Je=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),y.setupLightsView(q),We===!0&&Ae.setGlobalState(R.clippingPlanes,q),ui(S,Z,q),ee.updateMultisampleRenderTarget(ye),ee.updateRenderTargetMipmap(ye),Ve.has("WEBGL_multisampled_render_to_texture")===!1){let Re=!1;for(let st=0,St=U.length;st<St;st++){let ft=U[st],{object:ct,geometry:Pt,material:Me,group:kt}=ft;if(Me.side===Ot&&ct.layers.test(q.layers)){let et=Me.side;Me.side=Gt,Me.needsUpdate=!0,sa(ct,Z,q,Pt,Me,kt),Me.side=et,Me.needsUpdate=!0,Re=!0}}Re===!0&&(ee.updateMultisampleRenderTarget(ye),ee.updateRenderTargetMipmap(ye))}R.setRenderTarget(_e,Ce,Ne),R.setClearColor(Pe,Ee),Je!==void 0&&(q.viewport=Je),R.toneMapping=Xe}function ui(S,U,Z){let q=U.isScene===!0?U.overrideMaterial:null;for(let $=0,ye=S.length;$<ye;$++){let Te=S[$],{object:_e,geometry:Ce,group:Ne}=Te,Xe=Te.material;Xe.allowOverride===!0&&q!==null&&(Xe=q),_e.layers.test(Z.layers)&&sa(_e,U,Z,Ce,Xe,Ne)}}function sa(S,U,Z,q,$,ye){N!==null&&$.isNodeMaterial&&N.setObject(S,$),S.onBeforeRender(R,U,Z,q,$,ye),S.modelViewMatrix.multiplyMatrices(Z.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),$.onBeforeRender(R,U,Z,q,S,ye),$.transparent===!0&&$.side===Ot&&$.forceSinglePass===!1?($.side=Gt,$.needsUpdate=!0,R.renderBufferDirect(Z,U,q,$,S,ye),$.side=Yn,$.needsUpdate=!0,R.renderBufferDirect(Z,U,q,$,S,ye),$.side=Ot):R.renderBufferDirect(Z,U,q,$,S,ye),S.onAfterRender(R,U,Z,q,$,ye)}function fi(S,U,Z){U.isScene!==!0&&(U=ot);let q=W.get(S),$=y.state.lights,ye=y.state.shadowsArray,Te=$.state.version,_e=me.getParameters(S,$.state,ye,U,Z,y.state.lightProbeGridArray),Ce=me.getProgramCacheKey(_e),Ne=q.programs;q.environment=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?U.environment:null,q.fog=U.fog;let Xe=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap;q.envMap=le.get(S.envMap||q.environment,Xe),q.envMapRotation=q.environment!==null&&S.envMap===null?U.environmentRotation:S.envMapRotation,Ne===void 0&&(S.addEventListener("dispose",mt),Ne=new Map,q.programs=Ne);let Je=Ne.get(Ce);if(Je!==void 0){if(q.currentProgram===Je&&q.lightsStateVersion===Te)return ra(S,_e),Je}else _e.uniforms=me.getUniforms(S),N!==null&&S.isNodeMaterial&&N.build(S,Z,_e),S.onBeforeCompile(_e,R),Je=me.acquireProgram(_e,Ce),Ne.set(Ce,Je),q.uniforms=_e.uniforms;let Re=q.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Re.clippingPlanes=Ae.uniform),ra(S,_e),q.needsLights=po(S),q.lightsStateVersion=Te,q.needsLights&&(Re.ambientLightColor.value=$.state.ambient,Re.lightProbe.value=$.state.probe,Re.sunLights.value=$.state.sun,Re.sunLightShadows.value=$.state.sunShadow,Re.directionalLights.value=$.state.directional,Re.directionalLightShadows.value=$.state.directionalShadow,Re.spotLights.value=$.state.spot,Re.spotLightShadows.value=$.state.spotShadow,Re.rectAreaLights.value=$.state.rectArea,Re.ltc_1.value=$.state.rectAreaLTC1,Re.ltc_2.value=$.state.rectAreaLTC2,Re.pointLights.value=$.state.point,Re.pointLightShadows.value=$.state.pointShadow,Re.hemisphereLights.value=$.state.hemi,Re.sunShadowMatrix.value=$.state.sunShadowMatrix,Re.sunShadowCascade.value=$.state.sunShadowCascade,Re.directionalShadowMatrix.value=$.state.directionalShadowMatrix,Re.spotLightMatrix.value=$.state.spotLightMatrix,Re.spotLightMap.value=$.state.spotLightMap,Re.pointShadowMatrix.value=$.state.pointShadowMatrix),q.lightProbeGrid=y.state.lightProbeGridArray.length>0,q.currentProgram=Je,q.uniformsList=null,Je}function aa(S){if(S.uniformsList===null){let U=S.currentProgram.getUniforms();S.uniformsList=ts.seqWithValue(U.seq,S.uniforms)}return S.uniformsList}function ra(S,U){let Z=W.get(S);Z.outputColorSpace=U.outputColorSpace,Z.batching=U.batching,Z.batchingColor=U.batchingColor,Z.instancing=U.instancing,Z.instancingColor=U.instancingColor,Z.instancingMorph=U.instancingMorph,Z.skinning=U.skinning,Z.morphTargets=U.morphTargets,Z.morphNormals=U.morphNormals,Z.morphColors=U.morphColors,Z.morphTargetsCount=U.morphTargetsCount,Z.numClippingPlanes=U.numClippingPlanes,Z.numIntersection=U.numClipIntersection,Z.vertexAlphas=U.vertexAlphas,Z.vertexTangents=U.vertexTangents,Z.toneMapping=U.toneMapping}function uo(S,U){if(S.length===0)return null;if(S.length===1)return S[0].texture!==null?S[0]:null;_.setFromMatrixPosition(U.matrixWorld);for(let Z=0,q=S.length;Z<q;Z++){let $=S[Z];if($.texture!==null&&$.boundingBox.containsPoint(_))return $}return null}function oa(S,U,Z,q,$){U.isScene!==!0&&(U=ot),ee.resetTextureUnits();let ye=U.fog,Te=q.isMeshStandardMaterial||q.isMeshLambertMaterial||q.isMeshPhongMaterial?U.environment:null,_e=X===null?R.outputColorSpace:X.isXRRenderTarget===!0?X.texture.colorSpace:Ke.workingColorSpace,Ce=q.isMeshStandardMaterial||q.isMeshLambertMaterial&&!q.envMap||q.isMeshPhongMaterial&&!q.envMap,Ne=le.get(q.envMap||Te,Ce),Xe=q.vertexColors===!0&&!!Z.attributes.color&&Z.attributes.color.itemSize===4,Je=!!Z.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Re=!!Z.morphAttributes.position,st=!!Z.morphAttributes.normal,St=!!Z.morphAttributes.color,ft=hn;q.toneMapped&&(X===null||X.isXRRenderTarget===!0)&&(ft=R.toneMapping);let ct=Z.morphAttributes.position||Z.morphAttributes.normal||Z.morphAttributes.color,Pt=ct!==void 0?ct.length:0,Me=W.get(q),kt=y.state.lights;if(We===!0&&(je===!0||S!==D)){let ut=S===D&&q.id===H;Ae.setState(q,S,ut)}let et=!1;q.version===Me.__version?(Me.needsLights&&Me.lightsStateVersion!==kt.state.version||Me.outputColorSpace!==_e||$.isBatchedMesh&&Me.batching===!1||!$.isBatchedMesh&&Me.batching===!0||$.isBatchedMesh&&Me.batchingColor===!0&&$._colorsTexture===null||$.isBatchedMesh&&Me.batchingColor===!1&&$._colorsTexture!==null||$.isInstancedMesh&&Me.instancing===!1||!$.isInstancedMesh&&Me.instancing===!0||$.isSkinnedMesh&&Me.skinning===!1||!$.isSkinnedMesh&&Me.skinning===!0||$.isInstancedMesh&&Me.instancingColor===!0&&$.instanceColor===null||$.isInstancedMesh&&Me.instancingColor===!1&&$.instanceColor!==null||$.isInstancedMesh&&Me.instancingMorph===!0&&$.morphTexture===null||$.isInstancedMesh&&Me.instancingMorph===!1&&$.morphTexture!==null||Me.envMap!==Ne||q.fog===!0&&Me.fog!==ye||Me.numClippingPlanes!==void 0&&(Me.numClippingPlanes!==Ae.numPlanes||Me.numIntersection!==Ae.numIntersection)||Me.vertexAlphas!==Xe||Me.vertexTangents!==Je||Me.morphTargets!==Re||Me.morphNormals!==st||Me.morphColors!==St||Me.toneMapping!==ft||Me.morphTargetsCount!==Pt||!!Me.lightProbeGrid!=y.state.lightProbeGridArray.length>0)&&(et=!0):(et=!0,Me.__version=q.version);let en=Me.currentProgram;et===!0&&(en=fi(q,U,$),N&&q.isNodeMaterial&&N.onUpdateProgram(q,en,Me));let gn=!1,Ln=!1,pi=!1,lt=en.getUniforms(),yt=Me.uniforms;if(v.useProgram(en.program)&&(gn=!0,Ln=!0,pi=!0),q.id!==H&&(H=q.id,Ln=!0),Me.needsLights){let ut=uo(y.state.lightProbeGridArray,$);Me.lightProbeGrid!==ut&&(Me.lightProbeGrid=ut,Ln=!0)}if(gn||D!==S){v.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),lt.setValue(z,"projectionMatrix",S.projectionMatrix),lt.setValue(z,"viewMatrix",S.matrixWorldInverse);let Un=lt.map.cameraPosition;Un!==void 0&&Un.setValue(z,Ze.setFromMatrixPosition(S.matrixWorld)),I.logarithmicDepthBuffer&&lt.setValue(z,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&lt.setValue(z,"isOrthographic",S.isOrthographicCamera===!0),D!==S&&(D=S,Ln=!0,pi=!0)}if(Me.needsLights&&(kt.state.sunShadowMap.length>0&&lt.setValue(z,"sunShadowMap",kt.state.sunShadowMap,ee),kt.state.directionalShadowMap.length>0&&lt.setValue(z,"directionalShadowMap",kt.state.directionalShadowMap,ee),kt.state.spotShadowMap.length>0&&lt.setValue(z,"spotShadowMap",kt.state.spotShadowMap,ee),kt.state.pointShadowMap.length>0&&lt.setValue(z,"pointShadowMap",kt.state.pointShadowMap,ee)),$.isSkinnedMesh){lt.setOptional(z,$,"bindMatrix"),lt.setOptional(z,$,"bindMatrixInverse");let ut=$.skeleton;ut&&(ut.boneTexture===null&&ut.computeBoneTexture(),lt.setValue(z,"boneTexture",ut.boneTexture,ee))}$.isBatchedMesh&&(lt.setOptional(z,$,"batchingTexture"),lt.setValue(z,"batchingTexture",$._matricesTexture,ee),lt.setOptional(z,$,"batchingIdTexture"),lt.setValue(z,"batchingIdTexture",$._indirectTexture,ee),lt.setOptional(z,$,"batchingColorTexture"),$._colorsTexture!==null&&lt.setValue(z,"batchingColorTexture",$._colorsTexture,ee));let Dn=Z.morphAttributes;if((Dn.position!==void 0||Dn.normal!==void 0||Dn.color!==void 0)&&B.update($,Z,en),(Ln||Me.receiveShadow!==$.receiveShadow)&&(Me.receiveShadow=$.receiveShadow,lt.setValue(z,"receiveShadow",$.receiveShadow)),(q.isMeshStandardMaterial||q.isMeshLambertMaterial||q.isMeshPhongMaterial)&&q.envMap===null&&U.environment!==null&&(yt.envMapIntensity.value=U.environmentIntensity),yt.dfgLUT!==void 0&&(yt.dfgLUT.value=Fg()),Ln){if(lt.setValue(z,"toneMappingExposure",R.toneMappingExposure),Me.needsLights&&fo(yt,pi),ye&&q.fog===!0&&Se.refreshFogUniforms(yt,ye),Se.refreshMaterialUniforms(yt,q,j,K,y.state.transmissionRenderTarget[S.id]),Me.needsLights&&Me.lightProbeGrid){let ut=Me.lightProbeGrid;yt.probesSH.value=ut.texture,yt.probesMin.value.copy(ut.boundingBox.min),yt.probesMax.value.copy(ut.boundingBox.max),yt.probesResolution.value.copy(ut.resolution)}ts.upload(z,aa(Me),yt,ee)}if(q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(ts.upload(z,aa(Me),yt,ee),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&lt.setValue(z,"center",$.center),lt.setValue(z,"modelViewMatrix",$.modelViewMatrix),lt.setValue(z,"normalMatrix",$.normalMatrix),lt.setValue(z,"modelMatrix",$.matrixWorld),q.uniformsGroups!==void 0){let ut=q.uniformsGroups;for(let Un=0,mi=ut.length;Un<mi;Un++){let $l=ut[Un];se.update($l,en),se.bind($l,en)}}return en}function fo(S,U){S.ambientLightColor.needsUpdate=U,S.lightProbe.needsUpdate=U,S.sunLights.needsUpdate=U,S.sunLightShadows.needsUpdate=U,S.directionalLights.needsUpdate=U,S.directionalLightShadows.needsUpdate=U,S.pointLights.needsUpdate=U,S.pointLightShadows.needsUpdate=U,S.spotLights.needsUpdate=U,S.spotLightShadows.needsUpdate=U,S.rectAreaLights.needsUpdate=U,S.hemisphereLights.needsUpdate=U}function po(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return L},this.getActiveMipmapLevel=function(){return V},this.getRenderTarget=function(){return X},this.setRenderTargetTextures=function(S,U,Z){let q=W.get(S);q.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,q.__autoAllocateDepthBuffer===!1&&(q.__useRenderToTexture=!1),W.get(S.texture).__webglTexture=U,W.get(S.depthTexture).__webglTexture=q.__autoAllocateDepthBuffer?void 0:Z,q.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,U){let Z=W.get(S);Z.__webglFramebuffer=U,Z.__useDefaultFramebuffer=U===void 0},this.setRenderTarget=function(S,U=0,Z=0){X=S,L=U,V=Z;let q=null,$=!1,ye=!1;if(S){let _e=W.get(S);if(_e.__useDefaultFramebuffer!==void 0){v.bindFramebuffer(z.FRAMEBUFFER,_e.__webglFramebuffer),J.copy(S.viewport),Y.copy(S.scissor),ae=S.scissorTest,v.viewport(J),v.scissor(Y),v.setScissorTest(ae),H=-1;return}else if(_e.__webglFramebuffer===void 0)ee.setupRenderTarget(S);else if(_e.__hasExternalTextures)ee.rebindTextures(S,W.get(S.texture).__webglTexture,W.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){let Xe=S.depthTexture;if(_e.__boundDepthTexture!==Xe){if(Xe!==null&&W.has(Xe)&&(S.width!==Xe.image.width||S.height!==Xe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");ee.setupDepthRenderbuffer(S)}}let Ce=S.texture;(Ce.isData3DTexture||Ce.isDataArrayTexture||Ce.isCompressedArrayTexture)&&(ye=!0);let Ne=W.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Ne[U])?q=Ne[U][Z]:q=Ne[U],$=!0):S.samples>0&&ee.useMultisampledRTT(S)===!1?q=W.get(S).__webglMultisampledFramebuffer:Array.isArray(Ne)?q=Ne[Z]:q=Ne,J.copy(S.viewport),Y.copy(S.scissor),ae=S.scissorTest}else J.copy(ge).multiplyScalar(j).floor(),Y.copy(Oe).multiplyScalar(j).floor(),ae=dt;if(Z!==0&&(q=O),v.bindFramebuffer(z.FRAMEBUFFER,q)&&v.drawBuffers(S,q),v.viewport(J),v.scissor(Y),v.setScissorTest(ae),$){let _e=W.get(S.texture);z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_CUBE_MAP_POSITIVE_X+U,_e.__webglTexture,Z)}else if(ye){let _e=U;for(let Ce=0;Ce<S.textures.length;Ce++){let Ne=W.get(S.textures[Ce]);z.framebufferTextureLayer(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0+Ce,Ne.__webglTexture,Z,_e)}}else if(S!==null&&Z!==0){let _e=W.get(S.texture);z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,_e.__webglTexture,Z)}H=-1};function la(S){let U=W.get(S);return(U.__readFormat!==S.format||U.__readType!==S.type)&&(U.__readFormat=S.format,U.__readType=S.type,U.__formatReadable=I.textureFormatReadable(S.format),U.__typeReadable=I.textureTypeReadable(S.type)),U}this.readRenderTargetPixels=function(S,U,Z,q,$,ye,Te,_e=0){if(!(S&&S.isWebGLRenderTarget)){Fe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ce=W.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Te!==void 0&&(Ce=Ce[Te]),Ce){v.bindFramebuffer(z.FRAMEBUFFER,Ce);try{let Ne=S.textures[_e],Xe=Ne.format,Je=Ne.type;S.textures.length>1&&z.readBuffer(z.COLOR_ATTACHMENT0+_e);let Re=la(Ne);if(Re.__formatReadable===!1){Fe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(Re.__typeReadable===!1){Fe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=S.width-q&&Z>=0&&Z<=S.height-$&&z.readPixels(U,Z,q,$,pe.convert(Xe),pe.convert(Je),ye)}finally{let Ne=X!==null?W.get(X).__webglFramebuffer:null;v.bindFramebuffer(z.FRAMEBUFFER,Ne)}}},this.readRenderTargetPixelsAsync=async function(S,U,Z,q,$,ye,Te,_e=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ce=W.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Te!==void 0&&(Ce=Ce[Te]),Ce)if(U>=0&&U<=S.width-q&&Z>=0&&Z<=S.height-$){v.bindFramebuffer(z.FRAMEBUFFER,Ce);let Ne=S.textures[_e],Xe=Ne.format,Je=Ne.type;S.textures.length>1&&z.readBuffer(z.COLOR_ATTACHMENT0+_e);let Re=la(Ne);if(Re.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(Re.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let st=z.createBuffer();z.bindBuffer(z.PIXEL_PACK_BUFFER,st),z.bufferData(z.PIXEL_PACK_BUFFER,ye.byteLength,z.STREAM_READ),z.readPixels(U,Z,q,$,pe.convert(Xe),pe.convert(Je),0),z.bindBuffer(z.PIXEL_PACK_BUFFER,null);let St=X!==null?W.get(X).__webglFramebuffer:null;v.bindFramebuffer(z.FRAMEBUFFER,St);let ft=z.fenceSync(z.SYNC_GPU_COMMANDS_COMPLETE,0);return z.flush(),await nd(z,ft,4),z.bindBuffer(z.PIXEL_PACK_BUFFER,st),z.getBufferSubData(z.PIXEL_PACK_BUFFER,0,ye),z.bindBuffer(z.PIXEL_PACK_BUFFER,null),z.deleteBuffer(st),z.deleteSync(ft),ye}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,U=null,Z=0){let q=Math.pow(2,-Z),$=Math.floor(S.image.width*q),ye=Math.floor(S.image.height*q),Te=U!==null?U.x:0,_e=U!==null?U.y:0;ee.setTexture2D(S,0),z.copyTexSubImage2D(z.TEXTURE_2D,Z,0,0,Te,_e,$,ye),v.unbindTexture()},this.copyTextureToTexture=function(S,U,Z=null,q=null,$=0,ye=0){let Te,_e,Ce,Ne,Xe,Je,Re,st,St,ft=S.isCompressedTexture?S.mipmaps[ye]:S.image;if(Z!==null)Te=Z.max.x-Z.min.x,_e=Z.max.y-Z.min.y,Ce=Z.isBox3?Z.max.z-Z.min.z:1,Ne=Z.min.x,Xe=Z.min.y,Je=Z.isBox3?Z.min.z:0;else{let yt=Math.pow(2,-$);Te=Math.floor(ft.width*yt),_e=Math.floor(ft.height*yt),S.isDataArrayTexture?Ce=ft.depth:S.isData3DTexture?Ce=Math.floor(ft.depth*yt):Ce=1,Ne=0,Xe=0,Je=0}q!==null?(Re=q.x,st=q.y,St=q.z):(Re=0,st=0,St=0);let ct=pe.convert(U.format),Pt=pe.convert(U.type),Me;U.isData3DTexture?(ee.setTexture3D(U,0),Me=z.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(ee.setTexture2DArray(U,0),Me=z.TEXTURE_2D_ARRAY):(ee.setTexture2D(U,0),Me=z.TEXTURE_2D),v.activeTexture(z.TEXTURE0),v.pixelStorei(z.UNPACK_FLIP_Y_WEBGL,U.flipY),v.pixelStorei(z.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),v.pixelStorei(z.UNPACK_ALIGNMENT,U.unpackAlignment);let kt=v.getParameter(z.UNPACK_ROW_LENGTH),et=v.getParameter(z.UNPACK_IMAGE_HEIGHT),en=v.getParameter(z.UNPACK_SKIP_PIXELS),gn=v.getParameter(z.UNPACK_SKIP_ROWS),Ln=v.getParameter(z.UNPACK_SKIP_IMAGES);v.pixelStorei(z.UNPACK_ROW_LENGTH,ft.width),v.pixelStorei(z.UNPACK_IMAGE_HEIGHT,ft.height),v.pixelStorei(z.UNPACK_SKIP_PIXELS,Ne),v.pixelStorei(z.UNPACK_SKIP_ROWS,Xe),v.pixelStorei(z.UNPACK_SKIP_IMAGES,Je);let pi=S.isDataArrayTexture||S.isData3DTexture,lt=U.isDataArrayTexture||U.isData3DTexture;if(S.isDepthTexture){let yt=W.get(S),Dn=W.get(U),ut=W.get(yt.__renderTarget),Un=W.get(Dn.__renderTarget);v.bindFramebuffer(z.READ_FRAMEBUFFER,ut.__webglFramebuffer),v.bindFramebuffer(z.DRAW_FRAMEBUFFER,Un.__webglFramebuffer);for(let mi=0;mi<Ce;mi++)pi&&(z.framebufferTextureLayer(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,W.get(S).__webglTexture,$,Je+mi),z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,W.get(U).__webglTexture,ye,St+mi)),z.blitFramebuffer(Ne,Xe,Te,_e,Re,st,Te,_e,z.DEPTH_BUFFER_BIT,z.NEAREST);v.bindFramebuffer(z.READ_FRAMEBUFFER,null),v.bindFramebuffer(z.DRAW_FRAMEBUFFER,null)}else if($!==0||S.isRenderTargetTexture||W.has(S)){let yt=W.get(S),Dn=W.get(U);v.bindFramebuffer(z.READ_FRAMEBUFFER,T),v.bindFramebuffer(z.DRAW_FRAMEBUFFER,F);for(let ut=0;ut<Ce;ut++)pi?z.framebufferTextureLayer(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,yt.__webglTexture,$,Je+ut):z.framebufferTexture2D(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,yt.__webglTexture,$),lt?z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,Dn.__webglTexture,ye,St+ut):z.framebufferTexture2D(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,Dn.__webglTexture,ye),$!==0?z.blitFramebuffer(Ne,Xe,Te,_e,Re,st,Te,_e,z.COLOR_BUFFER_BIT,z.NEAREST):lt?z.copyTexSubImage3D(Me,ye,Re,st,St+ut,Ne,Xe,Te,_e):z.copyTexSubImage2D(Me,ye,Re,st,Ne,Xe,Te,_e);v.bindFramebuffer(z.READ_FRAMEBUFFER,null),v.bindFramebuffer(z.DRAW_FRAMEBUFFER,null)}else lt?S.isDataTexture||S.isData3DTexture?z.texSubImage3D(Me,ye,Re,st,St,Te,_e,Ce,ct,Pt,ft.data):U.isCompressedArrayTexture?z.compressedTexSubImage3D(Me,ye,Re,st,St,Te,_e,Ce,ct,ft.data):z.texSubImage3D(Me,ye,Re,st,St,Te,_e,Ce,ct,Pt,ft):S.isDataTexture?z.texSubImage2D(z.TEXTURE_2D,ye,Re,st,Te,_e,ct,Pt,ft.data):S.isCompressedTexture?z.compressedTexSubImage2D(z.TEXTURE_2D,ye,Re,st,ft.width,ft.height,ct,ft.data):z.texSubImage2D(z.TEXTURE_2D,ye,Re,st,Te,_e,ct,Pt,ft);v.pixelStorei(z.UNPACK_ROW_LENGTH,kt),v.pixelStorei(z.UNPACK_IMAGE_HEIGHT,et),v.pixelStorei(z.UNPACK_SKIP_PIXELS,en),v.pixelStorei(z.UNPACK_SKIP_ROWS,gn),v.pixelStorei(z.UNPACK_SKIP_IMAGES,Ln),ye===0&&U.generateMipmaps&&z.generateMipmap(Me),v.unbindTexture()},this.initRenderTarget=function(S){W.get(S).__webglFramebuffer===void 0&&ee.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?ee.setTextureCube(S,0):S.isData3DTexture?ee.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?ee.setTexture2DArray(S,0):ee.setTexture2D(S,0),v.unbindTexture()},this.resetState=function(){L=0,V=0,X=null,v.reset(),oe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return dn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=Ke._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ke._getUnpackColorSpace()}};(function(){let{useState:i,useEffect:e,useRef:t}=React,{Card:n,SectionTitle:s,Badge:a,Icon:r,Segmented:o,Spinner:l,Empty:c,ProgressRing:u,Modal:p}=window.CG.UI,{ProbBars:f,BarChart:d}=window.CG.Charts;function x(){let{t:y,lang:M,toast:g,user:C}=window.CG.Store.useStore(),[R,P]=i("plant"),[N,O]=i(null),[T,F]=i(null),[L,V]=i(null),[X,H]=i(null),[D,J]=i(!1),[Y,ae]=i(null),[Pe,Ee]=i(null),[we,K]=i("file_selected"),[j,ce]=i([]),[be,ge]=i(""),[Oe,dt]=i(!1),[ze,We]=i(!1),[je,Ge]=i(!1),Ze=t(null),ht=t(null),ot=t(null);e(()=>{window.CG.API_CLIENT.fields().then(ce).catch(()=>{})},[]);let nt=(v,G="file_selected")=>{if(v)if(Ee(new Date().toISOString()),K(G),O(v),ae(null),v.type.startsWith("image/")){let W=URL.createObjectURL(v);F(W)}else F(null)},tt=()=>{O(null),F(null),V(null),H(null),ae(null),ot.current?.scrollIntoView({behavior:"smooth",block:"start"})},z=()=>{Ge(!0),ot.current?.scrollIntoView({behavior:"smooth",block:"start"})},He=async()=>{if(!N){g(M==="th"?"\u0E01\u0E23\u0E38\u0E13\u0E32\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E44\u0E1F\u0E25\u0E4C":"Please choose a file","warn");return}let v=R==="csv"||N.name.toLowerCase().endsWith(".csv");J(!0),ae(null);try{let G=v?await window.CG.API_CLIENT.predictCsv(N,be||null):L?await window.CG.API_CLIENT.predictImages([{file:N,source:R},{file:L,source:"plant"}],be||null,Pe,we):await window.CG.API_CLIENT.predictImage(N,R,be||null,Pe,we);ae(G),g(M==="th"?"\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E2A\u0E33\u0E40\u0E23\u0E47\u0E08":"Analysis complete","success")}catch(G){g(G.message,"error")}finally{J(!1)}};e(()=>{N&&R!=="csv"&&!D&&!Y&&He()},[N]);let Ve=[{value:"leaf",label:y("src_leaf")},{value:"plant",label:y("src_plant")},{value:"canopy",label:y("src_canopy")},{value:"csv",label:y("src_csv")}],I=Y?3:N||D?2:1;return React.createElement("div",{className:"space-y-6 max-w-6xl mx-auto diagnosis-workspace"},React.createElement("section",{className:"diagnosis-intro animate-fadeup"},React.createElement("div",null,React.createElement("span",{className:"diagnosis-kicker"},React.createElement(r,{name:"leaf",className:"w-4 h-4"})," CASSAVAGUARD VISION"),React.createElement("h1",{className:"txt"},M==="th"?"\u0E15\u0E23\u0E27\u0E08\u0E2A\u0E38\u0E02\u0E20\u0E32\u0E1E\u0E21\u0E31\u0E19\u0E2A\u0E33\u0E1B\u0E30\u0E2B\u0E25\u0E31\u0E07\u0E08\u0E32\u0E01\u0E20\u0E32\u0E1E\u0E40\u0E14\u0E35\u0E22\u0E27":"Understand cassava health from one photo"),React.createElement("p",{className:"txt-soft"},M==="th"?"\u0E16\u0E48\u0E32\u0E22\u0E20\u0E32\u0E1E\u0E17\u0E31\u0E49\u0E07\u0E15\u0E49\u0E19\u0E17\u0E35\u0E48\u0E22\u0E31\u0E07\u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E41\u0E1B\u0E25\u0E07 \u0E23\u0E30\u0E1A\u0E1A\u0E08\u0E30\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E2A\u0E38\u0E02\u0E20\u0E32\u0E1E\u0E41\u0E25\u0E30\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E0A\u0E48\u0E27\u0E07\u0E1C\u0E25\u0E1C\u0E25\u0E34\u0E15\u0E42\u0E14\u0E22\u0E44\u0E21\u0E48\u0E15\u0E49\u0E2D\u0E07\u0E02\u0E38\u0E14\u0E2B\u0E31\u0E27":"Photograph the standing plant to analyze health and estimate a non-destructive yield range.")),React.createElement("div",{className:"diagnosis-trust"},React.createElement("span",null,React.createElement(r,{name:"check",className:"w-4 h-4"}),M==="th"?"\u0E44\u0E21\u0E48\u0E15\u0E49\u0E2D\u0E07\u0E40\u0E02\u0E49\u0E32\u0E2A\u0E39\u0E48\u0E23\u0E30\u0E1A\u0E1A":"No sign-in"),React.createElement("span",null,React.createElement(r,{name:"cpu",className:"w-4 h-4"}),M==="th"?"\u0E42\u0E21\u0E40\u0E14\u0E25 5 \u0E04\u0E25\u0E32\u0E2A":"5-class model"))),React.createElement("ol",{className:"workflow-steps","aria-label":M==="th"?"\u0E02\u0E31\u0E49\u0E19\u0E15\u0E2D\u0E19\u0E01\u0E32\u0E23\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C":"Analysis steps"},[[1,"camera",M==="th"?"\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E23\u0E39\u0E1B":"Add photo"],[2,"brain",M==="th"?"\u0E1B\u0E23\u0E30\u0E21\u0E27\u0E25\u0E1C\u0E25\u0E2D\u0E31\u0E15\u0E42\u0E19\u0E21\u0E31\u0E15\u0E34":"Auto analyze"],[3,"leaf",M==="th"?"\u0E14\u0E39\u0E1C\u0E25\u0E41\u0E25\u0E30 3D":"Result & 3D"]].map(([v,G,W])=>React.createElement("li",{key:v,className:I>=v?"active":""},React.createElement("span",null,React.createElement(r,{name:G,className:"w-4 h-4"})),React.createElement("b",null,W),v<3&&React.createElement("i",null)))),React.createElement("div",{className:"diagnosis-tip"},React.createElement(r,{name:"camera",className:"w-5 h-5"}),React.createElement("span",null,M==="th"?"\u0E40\u0E04\u0E25\u0E47\u0E14\u0E25\u0E31\u0E1A: \u0E16\u0E48\u0E32\u0E22\u0E43\u0E2B\u0E49\u0E40\u0E2B\u0E47\u0E19\u0E17\u0E31\u0E49\u0E07\u0E15\u0E49\u0E19\u0E15\u0E31\u0E49\u0E07\u0E41\u0E15\u0E48\u0E42\u0E04\u0E19\u0E16\u0E36\u0E07\u0E22\u0E2D\u0E14 \u0E21\u0E35\u0E27\u0E31\u0E15\u0E16\u0E38\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E02\u0E19\u0E32\u0E14 \u0E41\u0E25\u0E30\u0E2B\u0E25\u0E35\u0E01\u0E40\u0E25\u0E35\u0E48\u0E22\u0E07\u0E22\u0E49\u0E2D\u0E19\u0E41\u0E2A\u0E07":"Tip: Show the whole plant from base to canopy, include a scale reference, and avoid backlight.")),React.createElement("div",{className:`grid gap-4 ${Y||D?"lg:grid-cols-5":""}`},React.createElement(n,{className:`${Y||D?"lg:col-span-2":"max-w-3xl w-full mx-auto"} animate-fadeup capture-card`},React.createElement("div",{ref:ot},React.createElement("div",{className:"flex items-center justify-between gap-3 mb-4"},React.createElement("div",null,React.createElement("div",{className:"txt font-bold text-lg"},N?M==="th"?"\u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A\u0E23\u0E39\u0E1B\u0E20\u0E32\u0E1E":"Check your photo":M==="th"?"\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E23\u0E39\u0E1B\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E23\u0E34\u0E48\u0E21":"Choose a photo to begin"),React.createElement("div",{className:"txt-dim text-sm mt-0.5"},M==="th"?"JPG \u0E2B\u0E23\u0E37\u0E2D PNG \u2022 \u0E43\u0E0A\u0E49\u0E20\u0E32\u0E1E\u0E15\u0E49\u0E19\u0E09\u0E1A\u0E31\u0E1A\u0E17\u0E35\u0E48\u0E44\u0E21\u0E48\u0E1C\u0E48\u0E32\u0E19\u0E1F\u0E34\u0E25\u0E40\u0E15\u0E2D\u0E23\u0E4C":"JPG or PNG \u2022 use an original, unfiltered photo")),React.createElement(a,{tone:"green"},"1 ",M==="th"?"\u0E23\u0E39\u0E1B":"photo")),React.createElement("div",{onDragOver:v=>{v.preventDefault(),dt(!0)},onDragLeave:()=>dt(!1),onDrop:v=>{v.preventDefault(),dt(!1),nt(v.dataTransfer.files[0])},onClick:()=>Ze.current.click(),className:`capture-zone cursor-pointer ${Oe?"is-dragging":""} ${T?"has-preview":""}`},T?React.createElement("img",{src:T,alt:M==="th"?"\u0E23\u0E39\u0E1B\u0E17\u0E35\u0E48\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C":"Selected photo for analysis",className:"max-h-[350px] w-full rounded-2xl object-contain"}):N?React.createElement("div",{className:"txt-soft"},React.createElement(r,{name:"soil",className:"w-10 h-10 mx-auto mb-2 text-brand-400"}),React.createElement("div",{className:"txt font-medium text-sm"},N.name)):React.createElement("div",{className:"txt-dim"},React.createElement("div",{className:"capture-orb"},React.createElement(r,{name:"camera",className:"w-9 h-9"}),React.createElement("span",{className:"capture-orb-ring"})),React.createElement("div",{className:"txt text-xl font-extrabold"},M==="th"?"\u0E41\u0E15\u0E30\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E23\u0E39\u0E1B\u0E17\u0E31\u0E49\u0E07\u0E15\u0E49\u0E19":"Tap to choose a whole-plant photo"),React.createElement("div",{className:"txt-dim text-sm mt-2"},M==="th"?"\u0E2B\u0E23\u0E37\u0E2D\u0E25\u0E32\u0E01\u0E23\u0E39\u0E1B\u0E21\u0E32\u0E27\u0E32\u0E07\u0E15\u0E23\u0E07\u0E19\u0E35\u0E49":"or drag and drop it here")),React.createElement("input",{ref:Ze,type:"file",className:"hidden",accept:R==="csv"?".csv":"image/*",onChange:v=>nt(v.target.files[0])})),R!=="csv"&&React.createElement("div",{className:"grid sm:grid-cols-2 gap-3 mt-4"},React.createElement("button",{onClick:()=>We(!0),className:"primary-action"},React.createElement(r,{name:"camera",className:"w-5 h-5"}),y("take_photo")),React.createElement("button",{onClick:()=>Ze.current.click(),className:"secondary-action"},React.createElement(r,{name:"upload",className:"w-5 h-5"}),y("upload_file"))),R==="leaf"&&N&&React.createElement("div",{className:"evidence-panel mt-4"},React.createElement("div",{className:"flex items-center justify-between gap-3"},React.createElement("div",null,React.createElement("div",{className:"txt text-sm font-bold"},M==="th"?"\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E20\u0E32\u0E1E\u0E17\u0E31\u0E49\u0E07\u0E15\u0E49\u0E19\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E1C\u0E25\u0E17\u0E35\u0E48\u0E23\u0E2D\u0E1A\u0E14\u0E49\u0E32\u0E19\u0E02\u0E36\u0E49\u0E19":"Add a whole-plant view for stronger evidence"),React.createElement("p",{className:"txt-dim text-xs mt-1"},M==="th"?"\u0E23\u0E30\u0E1A\u0E1A\u0E08\u0E30\u0E23\u0E27\u0E21\u0E04\u0E27\u0E32\u0E21\u0E19\u0E48\u0E32\u0E08\u0E30\u0E40\u0E1B\u0E47\u0E19\u0E08\u0E32\u0E01\u0E20\u0E32\u0E1E\u0E43\u0E1A\u0E41\u0E25\u0E30\u0E20\u0E32\u0E1E\u0E15\u0E49\u0E19 \u0E1E\u0E23\u0E49\u0E2D\u0E21\u0E15\u0E23\u0E27\u0E08\u0E27\u0E48\u0E32\u0E1C\u0E25\u0E15\u0E23\u0E07\u0E01\u0E31\u0E19\u0E2B\u0E23\u0E37\u0E2D\u0E44\u0E21\u0E48":"We fuse leaf and plant probabilities and report whether the views agree.")),React.createElement(a,{tone:L?"low":"slate"},L?"2/2":"1/2")),L?React.createElement("div",{className:"evidence-photo mt-3"},React.createElement("img",{src:X,alt:M==="th"?"\u0E20\u0E32\u0E1E\u0E15\u0E49\u0E19\u0E21\u0E31\u0E19\u0E2A\u0E33\u0E1B\u0E30\u0E2B\u0E25\u0E31\u0E07":"Whole cassava plant"}),React.createElement("div",null,React.createElement("strong",{className:"txt text-sm block"},M==="th"?"\u0E20\u0E32\u0E1E\u0E17\u0E31\u0E49\u0E07\u0E15\u0E49\u0E19\u0E1E\u0E23\u0E49\u0E2D\u0E21\u0E41\u0E25\u0E49\u0E27":"Whole-plant view ready"),React.createElement("span",{className:"txt-dim text-xs block truncate max-w-[210px]"},L.name)),React.createElement("button",{onClick:()=>{V(null),H(null)},"aria-label":M==="th"?"\u0E25\u0E1A\u0E20\u0E32\u0E1E\u0E15\u0E49\u0E19":"Remove plant photo"},React.createElement(r,{name:"close",className:"w-4 h-4"}))):React.createElement("button",{type:"button",onClick:()=>ht.current?.click(),className:"add-evidence-button mt-3"},React.createElement(r,{name:"plus",className:"w-4 h-4"}),M==="th"?"\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E20\u0E32\u0E1E\u0E17\u0E31\u0E49\u0E07\u0E15\u0E49\u0E19":"Add whole-plant photo"),React.createElement("input",{ref:ht,type:"file",className:"hidden",accept:"image/*",onChange:v=>{let G=v.target.files?.[0];G&&(V(G),H(URL.createObjectURL(G)),ae(null))}})),React.createElement("div",{className:"mt-3"},React.createElement("button",{type:"button",onClick:()=>Ge(v=>!v),className:"w-full flex items-center justify-between gap-2 txt-soft hover:txt text-xs font-semibold py-1.5 transition"},React.createElement("span",{className:"flex items-center gap-1.5"},React.createElement(r,{name:"cpu",className:"w-3.5 h-3.5"}),M==="th"?"\u0E15\u0E31\u0E27\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E02\u0E31\u0E49\u0E19\u0E2A\u0E39\u0E07":"Advanced options"),React.createElement(r,{name:je?"close":"grid",className:"w-3.5 h-3.5"})),je&&React.createElement("div",{className:"mt-2 space-y-3 animate-fadeup rounded-xl border hair p-3"},React.createElement("div",null,React.createElement("label",{className:"txt-dim text-xs"},M==="th"?"\u0E0A\u0E19\u0E34\u0E14\u0E20\u0E32\u0E1E":"Image type"),React.createElement("div",{className:"mt-1"},React.createElement(o,{options:Ve,value:R,onChange:v=>{P(v),ae(null)}}))),R!=="csv"&&React.createElement("div",null,React.createElement("label",{className:"txt-dim text-xs"},M==="th"?"\u0E41\u0E1B\u0E25\u0E07\u0E1B\u0E25\u0E39\u0E01 (\u0E44\u0E21\u0E48\u0E1A\u0E31\u0E07\u0E04\u0E31\u0E1A)":"Field (optional)"),React.createElement("select",{value:be,onChange:v=>ge(v.target.value),className:"w-full mt-1 glass rounded-xl px-3 py-2.5 txt text-sm bg-transparent focus:outline-none focus:ring-2 ring-brand-500/40"},React.createElement("option",{value:"",className:"bg-ink-800"},"\u2014 ",M==="th"?"\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E08\u0E32\u0E01\u0E23\u0E39\u0E1B\u0E40\u0E17\u0E48\u0E32\u0E19\u0E31\u0E49\u0E19":"Photo analysis only"," \u2014"),j.map(v=>React.createElement("option",{key:v.id,value:v.id,className:"bg-ink-800"},M==="th"&&v.name_th||v.name))),React.createElement("p",{className:"txt-dim text-xs mt-1.5"},M==="th"?"\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E40\u0E21\u0E37\u0E48\u0E2D\u0E15\u0E49\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E40\u0E2A\u0E23\u0E34\u0E21\u0E1C\u0E25\u0E14\u0E49\u0E27\u0E22\u0E2D\u0E32\u0E01\u0E32\u0E28 \u0E20\u0E39\u0E21\u0E34\u0E1B\u0E23\u0E30\u0E40\u0E17\u0E28 \u0E41\u0E25\u0E30\u0E14\u0E32\u0E27\u0E40\u0E17\u0E35\u0E22\u0E21":"Select to add weather, terrain, and satellite context.")),R==="csv"&&React.createElement("div",null,React.createElement("label",{className:"txt-dim text-xs"},y("select_field")),React.createElement("select",{value:be,onChange:v=>ge(v.target.value),className:"w-full mt-1 glass rounded-xl px-3 py-2 txt text-sm bg-transparent focus:outline-none focus:ring-2 ring-brand-500/40"},React.createElement("option",{value:"",className:"bg-ink-800"},"\u2014 ",y("all_fields")," \u2014"),j.map(v=>React.createElement("option",{key:v.id,value:v.id,className:"bg-ink-800"},M==="th"&&v.name_th||v.name)))))),React.createElement("button",{onClick:He,disabled:D||!N,className:"analyze-action disabled:opacity-40"},D?React.createElement(React.Fragment,null,React.createElement(l,{className:"w-5 h-5"}),y("analyzing")):React.createElement(React.Fragment,null,React.createElement(r,{name:"brain",className:"w-5 h-5"}),y("analyze"))),R!=="csv"&&!N&&React.createElement("div",{className:"mt-4 grid sm:grid-cols-2 gap-2 text-sm"},React.createElement("div",{className:"rounded-xl border border-brand-500/25 bg-brand-500/10 p-3"},React.createElement("div",{className:"font-semibold text-brand-300 flex items-center gap-1"},React.createElement(r,{name:"check",className:"w-3.5 h-3.5"}),M==="th"?"\u0E20\u0E32\u0E1E\u0E17\u0E35\u0E48\u0E40\u0E2B\u0E21\u0E32\u0E30":"Good photo"),React.createElement("div",{className:"txt-soft mt-1 leading-relaxed"},M==="th"?"\u0E41\u0E2A\u0E07\u0E18\u0E23\u0E23\u0E21\u0E0A\u0E32\u0E15\u0E34 \u0E20\u0E32\u0E1E\u0E04\u0E21 \u0E43\u0E1A\u0E01\u0E34\u0E19\u0E1E\u0E37\u0E49\u0E19\u0E17\u0E35\u0E48\u0E2A\u0E48\u0E27\u0E19\u0E43\u0E2B\u0E0D\u0E48 \u0E41\u0E25\u0E30\u0E16\u0E48\u0E32\u0E22\u0E2B\u0E25\u0E32\u0E22\u0E21\u0E38\u0E21":"Natural light, sharp focus, leaf fills the frame, multiple angles.")),React.createElement("div",{className:"rounded-xl border border-rose-500/25 bg-rose-500/10 p-3"},React.createElement("div",{className:"font-semibold text-rose-300 flex items-center gap-1"},React.createElement(r,{name:"close",className:"w-3.5 h-3.5"}),M==="th"?"\u0E04\u0E27\u0E23\u0E16\u0E48\u0E32\u0E22\u0E43\u0E2B\u0E21\u0E48":"Retake"),React.createElement("div",{className:"txt-soft mt-1 leading-relaxed"},M==="th"?"\u0E20\u0E32\u0E1E\u0E2A\u0E31\u0E48\u0E19 \u0E22\u0E49\u0E2D\u0E19\u0E41\u0E2A\u0E07 \u0E43\u0E1A\u0E40\u0E25\u0E47\u0E01 \u0E1E\u0E37\u0E49\u0E19\u0E2B\u0E25\u0E31\u0E07\u0E23\u0E01 \u0E40\u0E1B\u0E35\u0E22\u0E01\u0E19\u0E49\u0E33 \u0E2B\u0E23\u0E37\u0E2D\u0E1C\u0E48\u0E32\u0E19\u0E1F\u0E34\u0E25\u0E40\u0E15\u0E2D\u0E23\u0E4C\u0E2A\u0E35":"Blur, backlight, tiny leaf, clutter, wet leaf, or color filters."))))),(Y||D)&&React.createElement("div",{className:"lg:col-span-3 space-y-4"},D&&React.createElement(m,null),!D&&!Y&&React.createElement(n,{className:"min-h-[300px] grid place-items-center animate-fadeup"},React.createElement(c,{icon:"brain",text:M==="th"?"\u0E2D\u0E31\u0E1B\u0E42\u0E2B\u0E25\u0E14\u0E44\u0E1F\u0E25\u0E4C\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E23\u0E34\u0E48\u0E21\u0E01\u0E32\u0E23\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C":"Upload a file to begin analysis"})),!D&&Y&&(Y.source==="csv"?React.createElement(b,{r:Y,onRetake:tt}):React.createElement(h,{r:Y,preview:T,fieldId:be,onRetake:tt,onOpenAdvanced:z})))),React.createElement(E,{open:ze,onClose:()=>We(!1),onCapture:v=>{nt(v,"camera_capture"),We(!1)}}))}function E({open:y,onClose:M,onCapture:g}){let{t:C,lang:R,toast:P}=window.CG.Store.useStore(),N=t(null),O=t(null),[T,F]=i(!1),[L,V]=i(null),[X,H]=i("environment"),D=()=>{O.current&&(O.current.getTracks().forEach(Ee=>Ee.stop()),O.current=null)},J=async Ee=>{D(),F(!1),V(null);try{let we=await navigator.mediaDevices.getUserMedia({video:{facingMode:Ee,width:{ideal:1280},height:{ideal:720}},audio:!1});O.current=we,N.current&&(N.current.srcObject=we,await N.current.play(),F(!0))}catch{P(C("cam_error"),"error"),M()}};e(()=>(y?J(X):D(),D),[y]);let Y=()=>{let Ee=N.current;if(!Ee)return;let we=document.createElement("canvas");we.width=Ee.videoWidth||640,we.height=Ee.videoHeight||480,we.getContext("2d").drawImage(Ee,0,0,we.width,we.height),V(we.toDataURL("image/jpeg",.92))},ae=()=>{if(!L)return;let Ee=atob(L.split(",")[1]),we=new Uint8Array(Ee.length);for(let j=0;j<Ee.length;j++)we[j]=Ee.charCodeAt(j);let K=new File([we],`capture_${Date.now()}.jpg`,{type:"image/jpeg"});D(),g(K)},Pe=()=>{let Ee=X==="environment"?"user":"environment";H(Ee),J(Ee)};return React.createElement(p,{open:y,onClose:()=>{D(),M()},title:C("take_photo")},React.createElement("div",{className:"relative rounded-2xl overflow-hidden bg-black aspect-[4/3] grid place-items-center"},React.createElement("video",{ref:N,playsInline:!0,muted:!0,className:`w-full h-full object-cover ${L?"hidden":""}`,style:{transform:X==="user"?"scaleX(-1)":"none"}}),L&&React.createElement("img",{src:L,alt:"capture",className:"w-full h-full object-cover"}),!T&&!L&&React.createElement("div",{className:"absolute inset-0 grid place-items-center bg-black/40"},React.createElement("div",{className:"flex flex-col items-center gap-2 text-white/80"},React.createElement(l,{className:"w-6 h-6"}),React.createElement("span",{className:"text-sm"},C("cam_starting")))),T&&!L&&React.createElement("div",{className:"absolute inset-6 border-2 border-white/40 rounded-2xl pointer-events-none"})),React.createElement("div",{className:"flex items-center justify-center gap-3 mt-4"},L?React.createElement(React.Fragment,null,React.createElement("button",{onClick:()=>J(X),className:"glass rounded-xl px-5 py-3 flex items-center gap-2 txt-soft hover:txt font-medium"},React.createElement(r,{name:"history",className:"w-4 h-4"}),C("retake")),React.createElement("button",{onClick:ae,className:"grad-brand text-white font-semibold rounded-xl px-6 py-3 flex items-center gap-2 hover:brightness-110 transition shadow-lg shadow-brand-500/20"},React.createElement(r,{name:"check",className:"w-5 h-5"}),C("use_photo"))):React.createElement(React.Fragment,null,React.createElement("button",{onClick:Pe,title:C("switch_cam"),className:"glass rounded-xl w-12 h-12 grid place-items-center txt-soft hover:txt"},React.createElement(r,{name:"history",className:"w-5 h-5"})),React.createElement("button",{onClick:Y,disabled:!T,className:"grad-brand text-white font-semibold rounded-xl px-6 py-3 flex items-center gap-2 disabled:opacity-50 hover:brightness-110 transition shadow-lg shadow-brand-500/20"},React.createElement(r,{name:"camera",className:"w-5 h-5"}),C("capture")))))}function m(){let{Skeleton:y,Card:M}=window.CG.UI;return React.createElement(M,{className:"animate-fadeup"},React.createElement("div",{className:"flex items-center gap-3 mb-4"},React.createElement(l,{className:"w-5 h-5 text-brand-400"}),React.createElement("span",{className:"txt-soft text-sm"},"Running CassavaNet inference\u2026")),React.createElement("div",{className:"grid grid-cols-2 gap-4"},React.createElement(y,{className:"h-48"}),React.createElement("div",{className:"space-y-3"},React.createElement(y,{className:"h-6 w-3/4"}),React.createElement(y,{className:"h-4"}),React.createElement(y,{className:"h-4 w-2/3"}),React.createElement(y,{className:"h-20"}))))}function h({r:y,preview:M,fieldId:g,onRetake:C,onOpenAdvanced:R}){let{t:P,lang:N}=window.CG.Store.useStore(),O=y.top3[0],[T,F]=i("heat"),[L,V]=i(!1),X=y.auxiliary_findings?.find(Y=>Y.key==="whitefly"),[H,D]=i(g?void 0:null),J=H?.recommendations;return e(()=>{if(!g||!y.prediction_id){D(null);return}let Y=!1;return D(void 0),window.CG.API_CLIENT.predictionContext(y.prediction_id).then(ae=>{Y||D(ae)}).catch(ae=>{Y||D({evidence:[],recommendations:[],partial:!0,errors:[{source:"environment",error:ae.message}]})}),()=>{Y=!0}},[g,y.prediction_id]),React.createElement(React.Fragment,null,React.createElement(n,{className:"animate-fadeup"},React.createElement("div",{className:"flex items-center gap-2 mb-3 flex-wrap"},React.createElement(a,{tone:O.key,dot:!0},N==="th"?O.th:O.en),y.model_basis&&React.createElement(a,{tone:y.model_basis[O.key]==="trained_ml"?"low":"info"},y.model_basis[O.key]==="trained_ml"?N==="th"?"\u0E42\u0E21\u0E40\u0E14\u0E25\u0E17\u0E35\u0E48\u0E40\u0E17\u0E23\u0E19\u0E08\u0E23\u0E34\u0E07":"Trained model":N==="th"?"\u0E01\u0E0E\u0E01\u0E32\u0E23\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19 (\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E08\u0E23\u0E34\u0E07)":"Heuristic (no dataset yet)"),y.multi_view&&React.createElement(a,{tone:y.multi_view.agreement===1?"low":"medium"},N==="th"?`\u0E2B\u0E25\u0E32\u0E22\u0E21\u0E38\u0E21 ${Math.round(y.multi_view.agreement*100)}% \u0E15\u0E23\u0E07\u0E01\u0E31\u0E19`:`Multi-view ${Math.round(y.multi_view.agreement*100)}% agreement`)),y.severity&&React.createElement("div",{className:"flex items-center gap-2 mb-3 flex-wrap"},React.createElement(a,{tone:y.severity.level==="severe"?"high":y.severity.level==="moderate"?"medium":"low"},N==="th"?{mild:"\u0E2D\u0E32\u0E01\u0E32\u0E23\u0E40\u0E25\u0E47\u0E01\u0E19\u0E49\u0E2D\u0E22",moderate:"\u0E2D\u0E32\u0E01\u0E32\u0E23\u0E1B\u0E32\u0E19\u0E01\u0E25\u0E32\u0E07",severe:"\u0E2D\u0E32\u0E01\u0E32\u0E23\u0E23\u0E38\u0E19\u0E41\u0E23\u0E07"}[y.severity.level]:{mild:"Mild",moderate:"Moderate",severe:"Severe"}[y.severity.level]),React.createElement("span",{className:"txt-dim text-[11px]"},N==="th"?y.severity.note_th:y.severity.note_en)),y.capture_context&&React.createElement(w,{context:y.capture_context}),React.createElement("div",{className:"flex items-center gap-4"},React.createElement(u,{value:O.confidence*100,size:84,label:P("confidence")}),React.createElement("div",{className:"flex-1 min-w-0"},y.health_score&&React.createElement("div",{className:"mb-2 flex items-center gap-2"},React.createElement("div",{className:"text-2xl font-bold txt tabular-nums"},y.health_score.score,React.createElement("span",{className:"text-xs txt-dim font-normal"},"/100")),React.createElement("span",{className:"txt-dim text-[11px]"},N==="th"?y.health_score.note_th:y.health_score.note_en)),y.requires_review?React.createElement("div",{className:"rounded-xl border border-amber-500/30 bg-amber-500/10 p-3 text-amber-200 text-xs leading-relaxed"},N==="th"?`\u0E1C\u0E25\u0E19\u0E35\u0E49\u0E15\u0E49\u0E2D\u0E07\u0E15\u0E23\u0E27\u0E08\u0E17\u0E32\u0E19\u0E42\u0E14\u0E22\u0E1C\u0E39\u0E49\u0E40\u0E0A\u0E35\u0E48\u0E22\u0E27\u0E0A\u0E32\u0E0D\u0E01\u0E48\u0E2D\u0E19\u0E14\u0E33\u0E40\u0E19\u0E34\u0E19\u0E01\u0E32\u0E23\u0E01\u0E31\u0E1A\u0E41\u0E1B\u0E25\u0E07 (${(y.review_reasons||[]).join(", ")})`:`Expert review is required before field action (${(y.review_reasons||[]).join(", ")})`):React.createElement("p",{className:"txt-soft text-xs leading-relaxed"},N==="th"?y.explanation_th:y.explanation_en))),React.createElement("div",{className:"mt-4 glass rounded-xl p-3"},React.createElement("div",{className:"txt-soft text-xs font-semibold mb-1.5 flex items-center gap-1.5"},React.createElement(r,{name:"bulb",className:"w-3.5 h-3.5 text-amber-400"}),N==="th"?"\u0E04\u0E33\u0E41\u0E19\u0E30\u0E19\u0E33":"Recommendation"),g?H===void 0?React.createElement("div",{className:"flex items-center gap-2 txt-dim text-xs"},React.createElement(l,{className:"w-4 h-4"}),N==="th"?"\u0E1C\u0E25 AI \u0E1E\u0E23\u0E49\u0E2D\u0E21\u0E41\u0E25\u0E49\u0E27 \xB7 \u0E01\u0E33\u0E25\u0E31\u0E07\u0E42\u0E2B\u0E25\u0E14\u0E2D\u0E32\u0E01\u0E32\u0E28 \u0E20\u0E39\u0E21\u0E34\u0E1B\u0E23\u0E30\u0E40\u0E17\u0E28 \u0E41\u0E25\u0E30\u0E14\u0E32\u0E27\u0E40\u0E17\u0E35\u0E22\u0E21\u0E40\u0E1A\u0E37\u0E49\u0E2D\u0E07\u0E2B\u0E25\u0E31\u0E07...":"AI result ready \xB7 loading weather, terrain and satellite evidence in the background..."):J&&J.length>0?React.createElement("ul",{className:"space-y-2"},J.slice(0,2).map((Y,ae)=>React.createElement("li",{key:ae,className:"text-xs"},React.createElement("div",{className:"flex items-center justify-between gap-2"},React.createElement("span",{className:"txt font-semibold"},N==="th"?Y.title_th:Y.title_en),React.createElement(a,{tone:Y.severity},Math.round(Y.confidence*100),"%")),(N==="th"?Y.actions_th:Y.actions_en)?.[0]&&React.createElement("div",{className:"txt-soft mt-0.5 flex items-start gap-1.5"},React.createElement(r,{name:"check",className:"w-3.5 h-3.5 text-brand-400 mt-0.5 shrink-0"}),(N==="th"?Y.actions_th:Y.actions_en)[0])))):React.createElement("p",{className:"txt-dim text-xs"},N==="th"?"\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E04\u0E33\u0E41\u0E19\u0E30\u0E19\u0E33\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A\u0E41\u0E1B\u0E25\u0E07\u0E19\u0E35\u0E49\u0E43\u0E19\u0E02\u0E13\u0E30\u0E19\u0E35\u0E49":"No recommendations for this field right now."):React.createElement("button",{onClick:R,className:"text-brand-300 hover:text-brand-200 text-xs font-medium flex items-center gap-1.5 transition"},N==="th"?"\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E41\u0E1B\u0E25\u0E07\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E23\u0E31\u0E1A\u0E04\u0E33\u0E41\u0E19\u0E30\u0E19\u0E33\u0E40\u0E09\u0E1E\u0E32\u0E30\u0E40\u0E08\u0E32\u0E30\u0E08\u0E07":"Attach a field for tailored recommendations"," ",React.createElement("span",{"aria-hidden":"true"},"\u2192"))),H&&React.createElement("div",{className:"mt-3 rounded-xl border border-cyan-500/25 bg-cyan-500/[.07] p-3"},React.createElement("div",{className:"txt text-xs font-semibold flex items-center gap-1.5"},React.createElement(r,{name:"map",className:"w-4 h-4 text-cyan-300"}),N==="th"?"\u0E2B\u0E25\u0E31\u0E01\u0E10\u0E32\u0E19\u0E1B\u0E23\u0E30\u0E01\u0E2D\u0E1A\u0E08\u0E32\u0E01\u0E41\u0E1B\u0E25\u0E07":"Field evidence used"),React.createElement("div",{className:"grid grid-cols-2 sm:grid-cols-4 gap-2 mt-2"},H.evidence.map(Y=>{let ae={weather:N==="th"?"\u0E2A\u0E20\u0E32\u0E1E\u0E2D\u0E32\u0E01\u0E32\u0E28":"Weather",terrain:N==="th"?"\u0E20\u0E39\u0E21\u0E34\u0E1B\u0E23\u0E30\u0E40\u0E17\u0E28":"Terrain",satellite:N==="th"?"\u0E14\u0E32\u0E27\u0E40\u0E17\u0E35\u0E22\u0E21":"Satellite"},Pe=Y.source==="weather"?`${Y.summary?.rain_7d_mm??"\u2014"} mm/7d`:Y.source==="terrain"?`${Y.elevation_m??"\u2014"} m`:`NDVI ${Y.summary?.ndvi??"\u2014"}`;return React.createElement("div",{key:Y.source,className:"glass rounded-lg p-2"},React.createElement("div",{className:"txt-dim text-[10px]"},ae[Y.source]),React.createElement("div",{className:`text-xs font-semibold mt-0.5 ${Y.available?"txt":"text-amber-300"}`},Pe))})),React.createElement("p",{className:"txt-dim text-[10px] mt-2 leading-relaxed"},N==="th"?H.disclaimer_th:H.disclaimer_en)),React.createElement("button",{onClick:C,className:"w-full mt-4 glass rounded-xl py-2.5 flex items-center justify-center gap-2 txt-soft hover:txt transition text-sm font-medium"},React.createElement(r,{name:"history",className:"w-4 h-4"}),N==="th"?"\u0E16\u0E48\u0E32\u0E22\u0E43\u0E2B\u0E21\u0E48":"Retake")),React.createElement(A,{result:y}),React.createElement("button",{onClick:()=>V(Y=>!Y),className:"w-full glass rounded-xl px-4 py-2.5 flex items-center justify-between gap-2 txt-soft hover:txt text-xs font-semibold transition animate-fadeup"},React.createElement("span",{className:"flex items-center gap-1.5"},React.createElement(r,{name:"cpu",className:"w-3.5 h-3.5"}),N==="th"?"\u0E23\u0E32\u0E22\u0E25\u0E30\u0E40\u0E2D\u0E35\u0E22\u0E14\u0E02\u0E31\u0E49\u0E19\u0E2A\u0E39\u0E07":"Advanced Details"),React.createElement(r,{name:L?"close":"grid",className:"w-3.5 h-3.5"})),L&&React.createElement(React.Fragment,null,React.createElement(n,{className:"animate-fadeup"},React.createElement("div",{className:"grid md:grid-cols-2 gap-4"},React.createElement("div",null,React.createElement("div",{className:"flex items-center gap-2 mb-2 flex-wrap"},React.createElement("span",{className:"txt-dim text-xs font-mono"},y.model.name," v",y.model.version)),React.createElement("div",{className:"relative rounded-xl overflow-hidden bg-black/20 grid place-items-center min-h-[220px]"},React.createElement("img",{src:T==="heat"?y.heatmap:M,alt:"analysis",className:"w-full object-contain max-h-[260px]"}),T==="whitefly"&&X?.image_size&&React.createElement("svg",{className:"absolute inset-0 w-full h-full pointer-events-none",viewBox:`0 0 ${X.image_size[0]} ${X.image_size[1]}`,preserveAspectRatio:"xMidYMid meet","aria-label":"Whitefly detection boxes"},X.detections.map((Y,ae)=>{let[Pe,Ee,we,K]=Y.box_xyxy;return React.createElement("g",{key:ae},React.createElement("rect",{x:Pe,y:Ee,width:we-Pe,height:K-Ee,fill:"rgba(245,158,11,.12)",stroke:"#f59e0b",strokeWidth:Math.max(2,X.image_size[0]/700)}))})),React.createElement("div",{className:"absolute bottom-2 right-2 flex gap-1"},React.createElement("button",{onClick:()=>F("original"),className:`text-[11px] px-2 py-1 rounded-lg ${T==="original"?"grad-brand text-white":"glass-strong txt-soft"}`},"Original"),React.createElement("button",{onClick:()=>F("heat"),className:`text-[11px] px-2 py-1 rounded-lg ${T==="heat"?"grad-brand text-white":"glass-strong txt-soft"}`},N==="th"?"\u0E08\u0E38\u0E14\u0E2A\u0E33\u0E04\u0E31\u0E0D":"Attribution"),X&&React.createElement("button",{onClick:()=>F("whitefly"),className:`text-[11px] px-2 py-1 rounded-lg ${T==="whitefly"?"bg-amber-500 text-white":"glass-strong txt-soft"}`},N==="th"?`\u0E01\u0E23\u0E2D\u0E1A\u0E41\u0E21\u0E25\u0E07 ${X.count}`:`Whitefly boxes ${X.count}`))),React.createElement("p",{className:"txt-dim text-[11px] mt-2 flex items-center gap-1.5"},React.createElement(r,{name:"brain",className:"w-3.5 h-3.5"}),P("attention")," \xB7 ",y.inference_ms," ms")),React.createElement("div",{className:"flex flex-col"},React.createElement("div",{className:"txt-soft text-xs"},P("top3")),y.top3.map((Y,ae)=>React.createElement("div",{key:Y.key,className:"flex items-center gap-2 mt-1.5"},React.createElement("span",{className:`w-5 text-center text-[11px] font-bold ${ae===0?"text-brand-400":"txt-dim"}`},"#",ae+1),React.createElement("span",{className:"txt text-xs flex-1 truncate"},N==="th"?Y.th:Y.en),React.createElement("span",{className:"txt-soft text-xs font-mono tabular-nums"},(Y.confidence*100).toFixed(1),"%"))),React.createElement("div",{className:"glass rounded-xl p-3 mt-3"},React.createElement("div",{className:"txt-soft text-xs font-semibold mb-1.5 flex items-center gap-1.5"},React.createElement(r,{name:"bulb",className:"w-3.5 h-3.5 text-amber-400"}),P("explain")),React.createElement("p",{className:"txt-soft text-xs leading-relaxed"},N==="th"?y.explanation_th:y.explanation_en))))),y.auxiliary_findings?.length>0&&React.createElement(n,{className:"animate-fadeup"},React.createElement(s,{icon:"check",title:N==="th"?"\u0E1C\u0E25\u0E08\u0E32\u0E01\u0E2B\u0E31\u0E27\u0E42\u0E21\u0E40\u0E14\u0E25\u0E40\u0E2A\u0E23\u0E34\u0E21":"Auxiliary model findings",sub:N==="th"?"\u0E1C\u0E25\u0E2D\u0E34\u0E2A\u0E23\u0E30 \u0E44\u0E21\u0E48\u0E16\u0E39\u0E01\u0E19\u0E33\u0E44\u0E1B\u0E23\u0E27\u0E21\u0E01\u0E31\u0E1A softmax 5 \u0E04\u0E25\u0E32\u0E2A":"Independent findings; not mixed into the five-class softmax"}),React.createElement("div",{className:"space-y-3"},y.auxiliary_findings.map(Y=>React.createElement("div",{key:Y.key,className:`rounded-xl border p-3 ${Y.detected?"border-amber-500/35 bg-amber-500/10":"hair glass"}`},React.createElement("div",{className:"flex items-center justify-between gap-3 flex-wrap"},React.createElement("div",null,React.createElement("div",{className:"flex items-center gap-2"},React.createElement(a,{tone:Y.detected?"medium":"slate",dot:Y.detected},Y.detected?N==="th"?"\u0E15\u0E23\u0E27\u0E08\u0E1E\u0E1A\u0E40\u0E2B\u0E19\u0E37\u0E2D threshold":"detected above threshold":N==="th"?"\u0E44\u0E21\u0E48\u0E16\u0E36\u0E07 threshold":"below threshold"),React.createElement("span",{className:"txt text-sm font-semibold"},N==="th"?Y.th:Y.en)),React.createElement("div",{className:"txt-dim text-[10px] font-mono mt-1"},Y.model.id,Y.model.test_macro_f1!=null?` \xB7 test macro-F1 ${(Y.model.test_macro_f1*100).toFixed(1)}%`:Y.model.test_map50!=null?` \xB7 test mAP50 ${(Y.model.test_map50*100).toFixed(1)}%`:"")),React.createElement("div",{className:"text-right"},React.createElement("div",{className:"txt text-xl font-bold tabular-nums"},Y.count!=null?`${Y.count} ${N==="th"?"\u0E15\u0E31\u0E27":"objects"}`:`${(Y.probability*100).toFixed(1)}%`),React.createElement("div",{className:"txt-dim text-[10px]"},Y.count!=null?`${N==="th"?"\u0E04\u0E27\u0E32\u0E21\u0E21\u0E31\u0E48\u0E19\u0E43\u0E08\u0E2A\u0E39\u0E07\u0E2A\u0E38\u0E14":"max confidence"} ${(Y.probability*100).toFixed(1)}%`:`threshold ${(Y.threshold*100).toFixed(1)}%`))),React.createElement("div",{className:"h-2 rounded-full bg-white/5 overflow-hidden mt-3"},React.createElement("div",{className:`h-full rounded-full ${Y.detected?"bg-amber-400":"bg-slate-400"}`,style:{width:`${Y.probability*100}%`}})),React.createElement("div",{className:"txt-dim text-[11px] mt-2"},N==="th"?"\u0E15\u0E49\u0E2D\u0E07\u0E43\u0E2B\u0E49\u0E1C\u0E39\u0E49\u0E40\u0E0A\u0E35\u0E48\u0E22\u0E27\u0E0A\u0E32\u0E0D\u0E15\u0E23\u0E27\u0E08\u0E22\u0E37\u0E19\u0E22\u0E31\u0E19\u0E01\u0E48\u0E2D\u0E19\u0E08\u0E31\u0E14\u0E01\u0E32\u0E23\u0E41\u0E1B\u0E25\u0E07 \u0E41\u0E25\u0E30\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E1C\u0E48\u0E32\u0E19\u0E01\u0E32\u0E23\u0E17\u0E14\u0E2A\u0E2D\u0E1A\u0E2D\u0E34\u0E2A\u0E23\u0E30\u0E01\u0E31\u0E1A\u0E20\u0E32\u0E1E\u0E41\u0E1B\u0E25\u0E07\u0E44\u0E17\u0E22":"Requires expert confirmation before field action and is not independently validated on Thai field photos."),Y.model.evaluation_warning&&React.createElement("div",{className:"mt-2 rounded-lg border border-amber-400/30 bg-amber-500/10 px-3 py-2 text-[11px] text-amber-200"},N==="th"?"\u0E04\u0E33\u0E40\u0E15\u0E37\u0E2D\u0E19\u0E04\u0E38\u0E13\u0E20\u0E32\u0E1E: \u0E04\u0E48\u0E32 mAP/recall \u0E40\u0E14\u0E34\u0E21\u0E2D\u0E32\u0E08\u0E2A\u0E39\u0E07\u0E40\u0E01\u0E34\u0E19\u0E08\u0E23\u0E34\u0E07\u0E08\u0E32\u0E01\u0E01\u0E32\u0E23\u0E41\u0E1A\u0E48\u0E07\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E41\u0E1A\u0E1A\u0E40\u0E01\u0E48\u0E32 \u0E15\u0E49\u0E2D\u0E07\u0E1D\u0E36\u0E01\u0E43\u0E2B\u0E21\u0E48\u0E42\u0E14\u0E22\u0E41\u0E22\u0E01\u0E17\u0E31\u0E49\u0E07 acquisition run \u0E01\u0E48\u0E2D\u0E19\u0E43\u0E0A\u0E49\u0E20\u0E32\u0E04\u0E2A\u0E19\u0E32\u0E21":"Quality warning: legacy splitting may overstate mAP/recall. Retraining with whole acquisition-run groups is required before field use."))))),React.createElement("div",{className:"grid md:grid-cols-2 gap-4"},React.createElement(n,{className:"animate-fadeup"},React.createElement(s,{icon:"leaf",title:P("symptoms")}),React.createElement("div",{className:"space-y-2"},y.symptoms.map((Y,ae)=>React.createElement("div",{key:ae,className:"flex items-center justify-between glass rounded-xl px-3 py-2"},React.createElement("span",{className:"txt text-sm"},N==="th"?Y.th:Y.en),React.createElement(a,{tone:Y.severity==="info"?"info":Y.severity},Y.severity==="info"?"\u2014":Math.round(Y.score*100)+"%"))))),React.createElement(n,{className:"animate-fadeup",style:{animationDelay:"60ms"}},React.createElement(s,{icon:"cpu",title:P("feat_imp")}),React.createElement("div",{className:"space-y-2.5"},y.feature_importance.map((Y,ae)=>React.createElement("div",{key:ae},React.createElement("div",{className:"flex justify-between text-xs mb-1"},React.createElement("span",{className:"txt-soft"},Y.feature),React.createElement("span",{className:"txt-dim font-mono"},(Y.importance*100).toFixed(0),"%")),React.createElement("div",{className:"h-2 rounded-full bg-white/5 overflow-hidden"},React.createElement("div",{className:"h-full grad-brand rounded-full",style:{width:Y.importance*100+"%",transition:"width 1s cubic-bezier(.2,.7,.2,1)"}}))))))),React.createElement(n,{className:"animate-fadeup"},React.createElement(s,{icon:"grid",title:P("prob_dist"),sub:N==="th"?"\u0E2B\u0E31\u0E27\u0E42\u0E21\u0E40\u0E14\u0E25\u0E2B\u0E25\u0E31\u0E01 5 \u0E04\u0E25\u0E32\u0E2A\u0E40\u0E17\u0E48\u0E32\u0E19\u0E31\u0E49\u0E19":"Primary five-class model head only"}),React.createElement(f,{items:Object.entries(y.probs).map(([Y,ae])=>{let Pe=window.CG._classMap&&window.CG._classMap[Y]||{th:Y,en:Y};return{key:Y,label:N==="th"?Pe.th:Pe.en,value:ae}}).sort((Y,ae)=>ae.value-Y.value)})),React.createElement("p",{className:"txt-dim text-[11px] text-center"},N==="th"?"CassavaGuard \u0E40\u0E1B\u0E47\u0E19\u0E40\u0E04\u0E23\u0E37\u0E48\u0E2D\u0E07\u0E21\u0E37\u0E2D\u0E2A\u0E19\u0E31\u0E1A\u0E2A\u0E19\u0E38\u0E19\u0E01\u0E32\u0E23\u0E15\u0E31\u0E14\u0E2A\u0E34\u0E19\u0E43\u0E08 \u0E44\u0E21\u0E48\u0E43\u0E0A\u0E48\u0E01\u0E32\u0E23\u0E27\u0E34\u0E19\u0E34\u0E08\u0E09\u0E31\u0E22\u0E17\u0E35\u0E48\u0E22\u0E37\u0E19\u0E22\u0E31\u0E19\u0E42\u0E14\u0E22\u0E2B\u0E49\u0E2D\u0E07\u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E01\u0E32\u0E23":"CassavaGuard is decision support, not a laboratory-confirmed diagnosis.")))}function w({context:y}){let{lang:M}=window.CG.Store.useStore(),g=y.is_actual_capture_time,C=new Date(y.captured_at),R=Number.isNaN(C.getTime())?y.captured_at:C.toLocaleString(M==="th"?"th-TH":"en-GB"),P=y.crop_timing?.days_after_planting_at_capture;return React.createElement("div",{className:"mb-3 rounded-xl border border-sky-500/25 bg-sky-500/[.07] p-3"},React.createElement("div",{className:"flex items-center justify-between gap-2 flex-wrap"},React.createElement("div",{className:"txt text-xs font-semibold flex items-center gap-1.5"},React.createElement(r,{name:"history",className:"w-4 h-4 text-sky-300"}),M==="th"?"\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E0A\u0E48\u0E27\u0E07\u0E40\u0E27\u0E25\u0E32\u0E16\u0E48\u0E32\u0E22":"Capture-time analysis"),React.createElement(a,{tone:g?"low":"medium"},g?M==="th"?"\u0E40\u0E27\u0E25\u0E32\u0E08\u0E32\u0E01 EXIF":"EXIF time":M==="th"?"\u0E40\u0E27\u0E25\u0E32\u0E17\u0E14\u0E41\u0E17\u0E19":"Fallback time")),React.createElement("div",{className:"grid grid-cols-2 sm:grid-cols-4 gap-2 mt-2 text-xs"},React.createElement("div",null,React.createElement("div",{className:"txt-dim text-[10px]"},M==="th"?"\u0E27\u0E31\u0E19\u0E41\u0E25\u0E30\u0E40\u0E27\u0E25\u0E32":"Date & time"),React.createElement("div",{className:"txt font-semibold mt-0.5"},R)),React.createElement("div",null,React.createElement("div",{className:"txt-dim text-[10px]"},M==="th"?"\u0E0A\u0E48\u0E27\u0E07\u0E27\u0E31\u0E19":"Day period"),React.createElement("div",{className:"txt font-semibold mt-0.5"},M==="th"?y.period_of_day.th:y.period_of_day.en)),React.createElement("div",null,React.createElement("div",{className:"txt-dim text-[10px]"},M==="th"?"\u0E0A\u0E48\u0E27\u0E07\u0E24\u0E14\u0E39":"Season"),React.createElement("div",{className:"txt font-semibold mt-0.5"},M==="th"?y.season.th:y.season.en)),React.createElement("div",null,React.createElement("div",{className:"txt-dim text-[10px]"},M==="th"?"\u0E2D\u0E32\u0E22\u0E38\u0E41\u0E1B\u0E25\u0E07 \u0E13 \u0E15\u0E2D\u0E19\u0E16\u0E48\u0E32\u0E22":"Crop age at capture"),React.createElement("div",{className:"txt font-semibold mt-0.5"},Number.isFinite(P)&&P>=0?M==="th"?`${P} \u0E27\u0E31\u0E19`:`${P} days`:"\u2014"))),!g&&React.createElement("p",{className:"text-amber-300 text-[10px] mt-2 leading-relaxed"},M==="th"?y.warnings?.[0]?.th:y.warnings?.[0]?.en),React.createElement("p",{className:"txt-dim text-[10px] mt-1"},M==="th"?"\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E40\u0E27\u0E25\u0E32\u0E0A\u0E48\u0E27\u0E22\u0E2D\u0E18\u0E34\u0E1A\u0E32\u0E22\u0E1A\u0E23\u0E34\u0E1A\u0E17\u0E40\u0E17\u0E48\u0E32\u0E19\u0E31\u0E49\u0E19 \u0E44\u0E21\u0E48\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E04\u0E48\u0E32\u0E04\u0E27\u0E32\u0E21\u0E19\u0E48\u0E32\u0E08\u0E30\u0E40\u0E1B\u0E47\u0E19\u0E42\u0E23\u0E04\u0E02\u0E2D\u0E07\u0E42\u0E21\u0E40\u0E14\u0E25":"Time adds context only and does not alter model disease probabilities."))}function A({result:y}){let{lang:M}=window.CG.Store.useStore(),[g,C]=i(10),[R,P]=i(220),[N,O]=i(1),[T,F]=i(null),[L,V]=i(!1),[X,H]=i(""),[D,J]=i(!1),[Y,ae]=i(!1),[Pe,Ee]=i(null),[we,K]=i(""),[j,ce]=i("1"),[be,ge]=i(""),[Oe,dt]=i("KU50"),[ze,We]=i(""),[je,Ge]=i(""),[Ze,ht]=i([]),[ot,nt]=i(null),[tt,z]=i(""),[He,Ve]=i(null),[I,v]=i(null),[G,W]=i(!1),[ee,le]=i(!1),[de,Q]=i(null),[ne,me]=i("side"),[Se,he]=i(null),[ue,Ae]=i(!1),[Ie,Ue]=i(""),[B,fe]=i(""),[te,pe]=i("1"),[oe,se]=i(null),[ie,re]=i(!1),[Le,Be]=i(""),[it,mt]=i("whole"),Qe=y.top3[0],mn=y.severity?.level||(Qe.key==="healthy"?"mild":"moderate"),It=Number(y.health_score?.score??Math.round((1-Qe.confidence*.55)*100)),bt=Qe.key==="healthy"?0:{mild:2,moderate:4,severe:7}[mn]||4,$t=M==="th"?Qe.th:Qe.en,Qn=Math.max(.08,Math.min(1,(g-3)/9)),Yt=It>=80?"good":It>=60?"fair":"poor";e(()=>{if(!y.prediction_id)return;let S=!0,U=setTimeout(async()=>{V(!0),H("");try{let Z=await window.CG.API_CLIENT.yieldEstimate({prediction_id:y.prediction_id,age_months:g,height_cm:R,stem_count:N});S&&F(Z)}catch(Z){S&&H(Z.message||"Yield estimate unavailable")}finally{S&&V(!1)}},250);return()=>{S=!1,clearTimeout(U)}},[y.prediction_id,g,R,N]);let _t=T?.estimated_fresh_root_weight_kg_per_plant,Et=T?.estimated_root_size,ei=Number(oe?.estimated_fresh_root_weight_kg_per_plant?.midpoint||_t?.midpoint||2.5),is=oe?Math.cbrt(Number(B)/4e3):1,ui=Math.max(.28,Math.min(1.6,ei/4.2)),sa=Number(Et?.root_count||Math.round(4+Qn*3)),fi=Number(Et?.length_cm?.midpoint||28)*is,aa=Number(Et?.diameter_cm?.midpoint||5)*is,ra=async()=>{if(de){Ae(!0),Ue(""),he(null);try{he(await window.CG.API_CLIENT.rootSize(de,ne))}catch(S){Ue(S.message||"Root analysis unavailable")}finally{Ae(!1)}}},uo=async S=>{S.preventDefault(),re(!0),Be(""),se(null);try{se(await window.CG.API_CLIENT.rootWeight({volume_cm3_per_plant:Number(B),plant_count:Number(te)}))}catch(U){Be(U.message||"Root-weight analysis unavailable")}finally{re(!1)}},oa=async S=>{let U=await window.CG.API_CLIENT.startRootReconstruction({set_id:S.set_id,reference_span_cm:Number(tt)});for(Ve({...U,extractedFrames:S.view_count,videoQuality:S.quality});!["complete","failed"].includes(U.status);)await new Promise(Z=>setTimeout(Z,2e3)),U=await window.CG.API_CLIENT.rootReconstructionStatus(U.job_id),Ve(Z=>({...U,extractedFrames:Z?.extractedFrames,videoQuality:Z?.videoQuality}));if(U.status==="failed")throw new Error(U.error);fe(String(Math.round(U.result.volume_cm3))),se(U.result.weight)},fo=async()=>{Be(""),Ve({status:"uploading",progress:0});try{let S=await window.CG.API_CLIENT.saveRootImageSet(Ze);await oa(S)}catch(S){Be(S.message||"3-D reconstruction failed"),Ve(U=>({...U,status:"failed"}))}},po=async()=>{Be(""),Ve({status:"extracting_video",progress:0});try{await oa(await window.CG.API_CLIENT.saveRootVideoSet(I))}catch(S){Be(S.message||"Video reconstruction failed"),Ve(U=>({...U,status:"failed"}))}},la=async S=>{S.preventDefault(),ae(!0);try{let U=Ze.length>=3?await window.CG.API_CLIENT.saveRootImageSet(Ze):{images:[]},Z=await window.CG.API_CLIENT.saveHarvestMeasurement({prediction_id:y.prediction_id,age_months:g,height_cm:R,stem_count:N,variety:Oe,field_code:ze,season:je,latitude:ot?.latitude??null,longitude:ot?.longitude??null,root_volume_cm3_per_plant:B?Number(B):null,root_images:U.images,total_fresh_root_weight_kg:Number(we),harvested_plant_count:Number(j),notes:be});Ee(Z)}catch(U){Ee({error:U.message||"Unable to save measurement"})}finally{ae(!1)}};return React.createElement(n,{className:"animate-fadeup overflow-hidden cassava-model-card"},React.createElement("div",{className:"flex items-start justify-between gap-3 mb-3"},React.createElement("div",null,React.createElement("div",{className:"flex items-center gap-2"},React.createElement("span",{className:"model-live-dot"}),React.createElement("h3",{className:"txt text-base font-bold"},M==="th"?"\u0E41\u0E1A\u0E1A\u0E08\u0E33\u0E25\u0E2D\u0E07\u0E15\u0E49\u0E19\u0E21\u0E31\u0E19\u0E2A\u0E33\u0E1B\u0E30\u0E2B\u0E25\u0E31\u0E07":"Cassava plant model")),React.createElement("p",{className:"txt-dim text-xs mt-1"},M==="th"?"\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E2D\u0E31\u0E15\u0E42\u0E19\u0E21\u0E31\u0E15\u0E34\u0E08\u0E32\u0E01\u0E1C\u0E25\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E20\u0E32\u0E1E\u0E25\u0E48\u0E32\u0E2A\u0E38\u0E14":"Generated automatically from the latest image result")),React.createElement(a,{tone:Qe.key},$t)),React.createElement("div",{className:"grid sm:grid-cols-[minmax(250px,1fr)_minmax(190px,.75fr)] gap-4 items-center"},React.createElement("div",{className:"plant-stage",role:"img","aria-label":M==="th"?`\u0E41\u0E1A\u0E1A\u0E08\u0E33\u0E25\u0E2D\u0E07\u0E2A\u0E32\u0E21\u0E21\u0E34\u0E15\u0E34\u0E15\u0E49\u0E19\u0E21\u0E31\u0E19\u0E2A\u0E33\u0E1B\u0E30\u0E2B\u0E25\u0E31\u0E07 \u0E1C\u0E25 ${$t}`:`3D cassava plant simulation showing ${$t}`},React.createElement(_,{viewMode:it,disease:Qe.key,affectedCount:bt,severity:mn,maturity:Qn,health:It,stemCount:N,rootAbundance:ui,rootCount:sa,rootLength:fi,rootDiameter:aa}),React.createElement("div",{className:"plant-3d-badge"},"DIGITAL TWIN \u2022 ",M==="th"?"\u0E25\u0E32\u0E01\u0E2B\u0E21\u0E38\u0E19 \u2022 \u0E40\u0E25\u0E37\u0E48\u0E2D\u0E19\u0E0B\u0E39\u0E21":"drag to rotate \u2022 scroll to zoom"),React.createElement("div",{className:"plant-view-switch",role:"group","aria-label":M==="th"?"\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E21\u0E38\u0E21\u0E41\u0E1A\u0E1A\u0E08\u0E33\u0E25\u0E2D\u0E07":"Choose model view"},React.createElement("button",{type:"button",className:it==="whole"?"active":"",onClick:()=>mt("whole")},React.createElement(r,{name:"leaf",className:"w-3.5 h-3.5"}),M==="th"?"\u0E17\u0E31\u0E49\u0E07\u0E15\u0E49\u0E19":"Whole plant"),React.createElement("button",{type:"button",className:it==="roots"?"active":"",onClick:()=>mt("roots")},React.createElement(r,{name:"cube",className:"w-3.5 h-3.5"}),M==="th"?"\u0E14\u0E39\u0E2B\u0E31\u0E27":"Root system")),React.createElement("div",{className:"plant-stage-legend"},React.createElement("span",null,React.createElement("i",{className:"legend-leaf"}),M==="th"?"\u0E17\u0E23\u0E07\u0E1E\u0E38\u0E48\u0E21":"Canopy"),React.createElement("span",null,React.createElement("i",{className:"legend-root"}),M==="th"?"\u0E2B\u0E31\u0E27\u0E43\u0E15\u0E49\u0E14\u0E34\u0E19\u0E08\u0E33\u0E25\u0E2D\u0E07":"Simulated roots")),React.createElement("div",{className:"plant-stage-caption"},M==="th"?"\u0E20\u0E32\u0E1E\u0E08\u0E33\u0E25\u0E2D\u0E07\u0E15\u0E32\u0E21\u0E2A\u0E16\u0E32\u0E19\u0E01\u0E32\u0E23\u0E13\u0E4C \u2022 \u0E44\u0E21\u0E48\u0E43\u0E0A\u0E48\u0E01\u0E32\u0E23\u0E2A\u0E41\u0E01\u0E19\u0E42\u0E04\u0E23\u0E07\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E08\u0E23\u0E34\u0E07":"Scenario visualization \u2022 not an actual structural scan")),React.createElement("div",{className:"space-y-3"},React.createElement("div",{className:"model-stat"},React.createElement("span",{className:"txt-soft"},M==="th"?"\u0E2A\u0E38\u0E02\u0E20\u0E32\u0E1E\u0E42\u0E14\u0E22\u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13":"Estimated health"),React.createElement("strong",{className:"txt"},It,"/100"),React.createElement("div",{className:"model-meter"},React.createElement("span",{style:{width:`${Math.max(0,Math.min(100,It))}%`}}))),React.createElement("div",{className:"model-stat model-weight"},React.createElement("span",{className:"txt-soft"},M==="th"?"\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E2B\u0E31\u0E27\u0E2A\u0E14\u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13/\u0E15\u0E49\u0E19":"Estimated fresh root weight"),React.createElement("strong",{className:"txt"},L&&!_t?React.createElement(l,{className:"w-4 h-4"}):_t?`\u2248 ${_t.midpoint.toFixed(2)} kg`:"\u2014"),_t&&React.createElement("div",{className:"weight-range col-span-2"},React.createElement("span",{style:{left:`${Math.max(4,Math.min(88,_t.midpoint/_t.high*100))}%`}}),React.createElement("small",null,_t.low.toFixed(2),"\u2013",_t.high.toFixed(2)," kg"))),React.createElement("div",{className:"root-size-grid"},React.createElement("div",null,React.createElement("span",null,M==="th"?"\u0E08\u0E33\u0E19\u0E27\u0E19\u0E2B\u0E31\u0E27":"Root count"),React.createElement("b",null,Et?`\u2248 ${Et.root_count}`:"\u2014")),React.createElement("div",null,React.createElement("span",null,M==="th"?"\u0E04\u0E27\u0E32\u0E21\u0E22\u0E32\u0E27\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22":"Mean length"),React.createElement("b",null,Et?`\u2248 ${Et.length_cm.midpoint.toFixed(1)} cm`:"\u2014")),React.createElement("div",null,React.createElement("span",null,M==="th"?"\u0E40\u0E2A\u0E49\u0E19\u0E1C\u0E48\u0E32\u0E19\u0E28\u0E39\u0E19\u0E22\u0E4C\u0E01\u0E25\u0E32\u0E07":"Diameter"),React.createElement("b",null,Et?`\u2248 ${Et.diameter_cm.midpoint.toFixed(1)} cm`:"\u2014")),React.createElement("div",null,React.createElement("span",null,M==="th"?"\u0E23\u0E30\u0E14\u0E31\u0E1A\u0E02\u0E19\u0E32\u0E14":"Size class"),React.createElement("b",null,Et?M==="th"?{small:"\u0E40\u0E25\u0E47\u0E01",medium:"\u0E1B\u0E32\u0E19\u0E01\u0E25\u0E32\u0E07",large:"\u0E43\u0E2B\u0E0D\u0E48"}[Et.size_class]:Et.size_class:"\u2014"))),React.createElement("div",{className:"model-stat"},React.createElement("span",{className:"txt-soft"},M==="th"?"\u0E04\u0E27\u0E32\u0E21\u0E2A\u0E21\u0E1A\u0E39\u0E23\u0E13\u0E4C\u0E02\u0E2D\u0E07\u0E15\u0E49\u0E19":"Plant condition"),React.createElement("strong",{className:Yt==="good"?"text-emerald-500":Yt==="fair"?"text-amber-500":"text-rose-500"},M==="th"?{good:"\u0E2A\u0E21\u0E1A\u0E39\u0E23\u0E13\u0E4C\u0E14\u0E35",fair:"\u0E04\u0E27\u0E23\u0E40\u0E1D\u0E49\u0E32\u0E23\u0E30\u0E27\u0E31\u0E07",poor:"\u0E21\u0E35\u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07"}[Yt]:{good:"Good",fair:"Monitor",poor:"At risk"}[Yt])),React.createElement("div",{className:"model-stat"},React.createElement("span",{className:"txt-soft"},M==="th"?"\u0E43\u0E1A\u0E17\u0E35\u0E48\u0E41\u0E2A\u0E14\u0E07\u0E2D\u0E32\u0E01\u0E32\u0E23\u0E43\u0E19\u0E41\u0E1A\u0E1A\u0E08\u0E33\u0E25\u0E2D\u0E07":"Affected leaves in model"),React.createElement("strong",{className:"txt"},bt,"/8")))),React.createElement("button",{type:"button",className:"add-evidence-button mt-4",onClick:()=>le(S=>!S)},React.createElement(r,{name:"cpu",className:"w-4 h-4"}),M==="th"?"\u0E1B\u0E23\u0E31\u0E1A\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E40\u0E15\u0E34\u0E21 (\u0E44\u0E21\u0E48\u0E1A\u0E31\u0E07\u0E04\u0E31\u0E1A)":"Refine optional inputs"),ee&&React.createElement("div",{className:"model-inputs mt-3"},React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E2D\u0E32\u0E22\u0E38\u0E1E\u0E37\u0E0A":"Plant age"," ",React.createElement("b",null,g," ",M==="th"?"\u0E40\u0E14\u0E37\u0E2D\u0E19":"months")),React.createElement("input",{type:"range",min:"3",max:"18",value:g,onChange:S=>C(Number(S.target.value))})),React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E04\u0E27\u0E32\u0E21\u0E2A\u0E39\u0E07\u0E42\u0E14\u0E22\u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13":"Approx. height"," ",React.createElement("b",null,R," cm")),React.createElement("input",{type:"range",min:"50",max:"400",step:"10",value:R,onChange:S=>P(Number(S.target.value))})),React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E08\u0E33\u0E19\u0E27\u0E19\u0E25\u0E33\u0E15\u0E49\u0E19":"Stem count"," ",React.createElement("b",null,N)),React.createElement("input",{type:"range",min:"1",max:"6",value:N,onChange:S=>O(Number(S.target.value))}))),React.createElement("div",{className:"rounded-xl bg-brand-500/10 border border-brand-500/20 p-3 mt-4"},React.createElement("strong",{className:"txt text-sm"},M==="th"?"\u0E01\u0E32\u0E23\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E1C\u0E25\u0E1C\u0E25\u0E34\u0E15\u0E41\u0E1A\u0E1A\u0E44\u0E21\u0E48\u0E02\u0E38\u0E14":"Non-destructive yield estimate"),React.createElement("p",{className:"txt-soft text-xs mt-1"},M==="th"?"\u0E04\u0E33\u0E19\u0E27\u0E13\u0E08\u0E32\u0E01\u0E20\u0E32\u0E1E\u0E17\u0E31\u0E49\u0E07\u0E15\u0E49\u0E19 \u0E2D\u0E32\u0E22\u0E38 \u0E04\u0E27\u0E32\u0E21\u0E2A\u0E39\u0E07 \u0E08\u0E33\u0E19\u0E27\u0E19\u0E25\u0E33\u0E15\u0E49\u0E19 \u0E1C\u0E25\u0E42\u0E23\u0E04 \u0E41\u0E25\u0E30\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E41\u0E1B\u0E25\u0E07 \u0E1C\u0E25\u0E25\u0E31\u0E1E\u0E18\u0E4C\u0E40\u0E1B\u0E47\u0E19\u0E0A\u0E48\u0E27\u0E07\u0E1E\u0E22\u0E32\u0E01\u0E23\u0E13\u0E4C \u0E44\u0E21\u0E48\u0E43\u0E0A\u0E48\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E17\u0E35\u0E48\u0E27\u0E31\u0E14\u0E42\u0E14\u0E22\u0E15\u0E23\u0E07":"Uses the whole-plant image, age, height, stems, disease and field context. This is a prediction interval, not a direct weight measurement.")),React.createElement("button",{type:"button",className:"add-evidence-button mt-3",onClick:()=>W(S=>!S)},React.createElement(r,{name:"check",className:"w-4 h-4"}),M==="th"?"\u0E42\u0E2B\u0E21\u0E14\u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A\u0E14\u0E49\u0E27\u0E22\u0E01\u0E32\u0E23\u0E02\u0E38\u0E14\u0E41\u0E25\u0E30 3D (\u0E44\u0E21\u0E48\u0E1A\u0E31\u0E07\u0E04\u0E31\u0E1A)":"Optional harvest/3-D validation mode"),G&&React.createElement(React.Fragment,null,React.createElement("div",{className:"root-ml-panel mt-4"},React.createElement("div",null,React.createElement("strong",{className:"txt"},M==="th"?"\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E02\u0E19\u0E32\u0E14\u0E23\u0E32\u0E01\u0E14\u0E49\u0E27\u0E22 ML \u0E08\u0E23\u0E34\u0E07":"Real ML root-size analysis"),React.createElement("p",{className:"txt-dim text-xs mt-1"},M==="th"?"\u0E43\u0E0A\u0E49\u0E20\u0E32\u0E1E\u0E2B\u0E31\u0E27\u0E17\u0E35\u0E48\u0E02\u0E38\u0E14\u0E41\u0E25\u0E49\u0E27\u0E1A\u0E19\u0E1E\u0E37\u0E49\u0E19\u0E2B\u0E25\u0E31\u0E07\u0E2A\u0E35\u0E14\u0E33 \u0E21\u0E35\u0E27\u0E07\u0E01\u0E25\u0E21\u0E2D\u0E49\u0E32\u0E07\u0E2D\u0E34\u0E07 2 \u0E19\u0E34\u0E49\u0E27":"Use an excavated-root photo on black cloth with a 2-inch reference disk.")),React.createElement("div",{className:"grid sm:grid-cols-[1fr_auto_auto] gap-2 mt-3"},React.createElement("input",{type:"file",accept:"image/*",onChange:S=>{Q(S.target.files[0]||null),he(null)}}),React.createElement("select",{value:ne,onChange:S=>me(S.target.value)},React.createElement("option",{value:"side"},M==="th"?"\u0E21\u0E38\u0E21\u0E14\u0E49\u0E32\u0E19\u0E02\u0E49\u0E32\u0E07":"Side view"),React.createElement("option",{value:"top"},M==="th"?"\u0E21\u0E38\u0E21\u0E14\u0E49\u0E32\u0E19\u0E1A\u0E19":"Top view")),React.createElement("button",{type:"button",className:"primary-action px-4",disabled:!de||ue,onClick:ra},ue?React.createElement(l,{className:"w-4 h-4"}):React.createElement(r,{name:"brain",className:"w-4 h-4"}),M==="th"?"\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E23\u0E32\u0E01":"Analyze roots")),Ie&&React.createElement("p",{className:"text-rose-500 text-xs mt-2"},Ie),Se&&React.createElement("div",{className:"root-ml-results mt-3"},Object.entries(Se.measurements).map(([S,U])=>React.createElement("div",{key:S},React.createElement("span",null,S),React.createElement("b",null,Number(U).toLocaleString()))),React.createElement("p",null,M==="th"?`\u0E42\u0E21\u0E40\u0E14\u0E25 ${Se.model_id} \u2022 \u0E1D\u0E36\u0E01 ${Se.training_samples} \u0E20\u0E32\u0E1E \u2022 \u0E1C\u0E25\u0E40\u0E1B\u0E47\u0E19\u0E2B\u0E19\u0E48\u0E27\u0E22 DIRT`:`${Se.model_id} \u2022 ${Se.training_samples} training images \u2022 DIRT units`))),React.createElement("form",{className:"root-ml-panel mt-4",onSubmit:uo},React.createElement("div",null,React.createElement("strong",{className:"txt"},M==="th"?"\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E1C\u0E25\u0E1C\u0E25\u0E34\u0E15\u0E14\u0E49\u0E27\u0E22 ML":"ML fresh-root weight analysis"),React.createElement("p",{className:"txt-dim text-xs mt-1"},M==="th"?"\u0E01\u0E23\u0E2D\u0E01\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E15\u0E23\u0E23\u0E32\u0E01\u0E2A\u0E14\u0E15\u0E48\u0E2D\u0E15\u0E49\u0E19\u0E2B\u0E25\u0E31\u0E07\u0E02\u0E38\u0E14 \u0E27\u0E31\u0E14\u0E14\u0E49\u0E27\u0E22\u0E16\u0E31\u0E07\u0E25\u0E49\u0E19/\u0E01\u0E32\u0E23\u0E41\u0E17\u0E19\u0E17\u0E35\u0E48\u0E19\u0E49\u0E33 \u0E2B\u0E23\u0E37\u0E2D\u0E41\u0E1A\u0E1A\u0E08\u0E33\u0E25\u0E2D\u0E07 3D \u0E2B\u0E25\u0E32\u0E22\u0E21\u0E38\u0E21":"Enter excavated fresh-root volume per plant measured by water displacement or multi-view 3-D reconstruction.")),React.createElement("div",{className:"grid sm:grid-cols-[1fr_1fr_auto] gap-2 mt-3"},React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E15\u0E23\u0E23\u0E32\u0E01/\u0E15\u0E49\u0E19 (\u0E0B\u0E21.\xB3)":"Root volume/plant (cm\xB3)"),React.createElement("input",{type:"number",min:"200",max:"20000",step:"1",required:!0,placeholder:"\u0E40\u0E0A\u0E48\u0E19 4000",value:B,onChange:S=>fe(S.target.value)})),React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E08\u0E33\u0E19\u0E27\u0E19\u0E15\u0E49\u0E19":"Plant count"),React.createElement("input",{type:"number",min:"1",max:"1000",step:"1",required:!0,value:te,onChange:S=>pe(S.target.value)})),React.createElement("button",{type:"submit",className:"primary-action px-4 self-end",disabled:ie||!B},ie?React.createElement(l,{className:"w-4 h-4"}):React.createElement(r,{name:"brain",className:"w-4 h-4"}),M==="th"?"\u0E04\u0E33\u0E19\u0E27\u0E13\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01":"Estimate weight")),React.createElement("div",{className:"mt-4 pt-4 border-t border-white/10"},React.createElement("strong",{className:"txt text-sm"},M==="th"?"\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E15\u0E23 3D \u0E2D\u0E31\u0E15\u0E42\u0E19\u0E21\u0E31\u0E15\u0E34\u0E08\u0E32\u0E01\u0E20\u0E32\u0E1E\u0E2B\u0E25\u0E32\u0E22\u0E21\u0E38\u0E21":"Automatic multi-view 3-D volume"),React.createElement("div",{className:"rounded-xl bg-emerald-500/10 border border-emerald-500/20 p-3 mt-2"},React.createElement("b",{className:"txt text-sm"},M==="th"?"\u0E41\u0E19\u0E30\u0E19\u0E33: \u0E2D\u0E31\u0E1B\u0E42\u0E2B\u0E25\u0E14\u0E27\u0E34\u0E14\u0E35\u0E42\u0E2D\u0E40\u0E14\u0E34\u0E19\u0E23\u0E2D\u0E1A\u0E2B\u0E31\u0E27\u0E21\u0E31\u0E19":"Recommended: upload an orbit video"),React.createElement("div",{className:"grid sm:grid-cols-[1fr_180px_auto] gap-2 mt-2"},React.createElement("input",{type:"file",accept:"video/mp4,video/quicktime,video/webm,.m4v",onChange:S=>v(S.target.files?.[0]||null)}),React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E04\u0E27\u0E32\u0E21\u0E01\u0E27\u0E49\u0E32\u0E07\u0E08\u0E23\u0E34\u0E07\u0E2A\u0E39\u0E07\u0E2A\u0E38\u0E14 (\u0E0B\u0E21.)":"Measured max span (cm)"),React.createElement("input",{type:"number",min:"5",max:"300",step:"0.1",value:tt,onChange:S=>z(S.target.value)})),React.createElement("button",{type:"button",className:"primary-action px-4 self-end",disabled:!I||!tt||He&&!["complete","failed"].includes(He.status),onClick:po},React.createElement(r,{name:"play",className:"w-4 h-4"}),M==="th"?"\u0E27\u0E34\u0E14\u0E35\u0E42\u0E2D \u2192 3D":"Video \u2192 3-D")),React.createElement("p",{className:"txt-dim text-xs mt-2"},M==="th"?"\u0E23\u0E2D\u0E07\u0E23\u0E31\u0E1A MP4/MOV/WebM \u0E2A\u0E39\u0E07\u0E2A\u0E38\u0E14 250 MB \u0E04\u0E27\u0E32\u0E21\u0E22\u0E32\u0E27 4\u201390 \u0E27\u0E34\u0E19\u0E32\u0E17\u0E35 \u0E23\u0E30\u0E1A\u0E1A\u0E04\u0E31\u0E14\u0E40\u0E1F\u0E23\u0E21\u0E04\u0E21\u0E41\u0E25\u0E30\u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33\u0E43\u0E2B\u0E49\u0E2D\u0E31\u0E15\u0E42\u0E19\u0E21\u0E31\u0E15\u0E34":"MP4/MOV/WebM up to 250 MB, 4\u201390 seconds. Sharp, non-duplicate frames are selected automatically.")),React.createElement("p",{className:"txt-dim text-xs mt-3"},M==="th"?"\u0E2B\u0E23\u0E37\u0E2D\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E20\u0E32\u0E1E\u0E2B\u0E25\u0E32\u0E22\u0E21\u0E38\u0E21\u0E40\u0E2D\u0E07":"Or select multiple photos manually"),React.createElement("div",{className:"grid sm:grid-cols-[1fr_180px_auto] gap-2 mt-2"},React.createElement("input",{type:"file",accept:"image/*",multiple:!0,onChange:S=>ht(Array.from(S.target.files||[]))}),React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E04\u0E27\u0E32\u0E21\u0E01\u0E27\u0E49\u0E32\u0E07\u0E08\u0E23\u0E34\u0E07\u0E2A\u0E39\u0E07\u0E2A\u0E38\u0E14 (\u0E0B\u0E21.)":"Measured max span (cm)"),React.createElement("input",{type:"number",min:"5",max:"300",step:"0.1",value:tt,onChange:S=>z(S.target.value)})),React.createElement("button",{type:"button",className:"primary-action px-4 self-end",disabled:Ze.length<12||!tt||He&&!["complete","failed"].includes(He.status),onClick:fo},React.createElement(r,{name:"cube",className:"w-4 h-4"}),M==="th"?"\u0E2A\u0E23\u0E49\u0E32\u0E07 3D":"Build 3-D")),React.createElement("p",{className:"txt-dim text-xs mt-2"},M==="th"?`\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E2D\u0E22\u0E48\u0E32\u0E07\u0E19\u0E49\u0E2D\u0E22 12 \u0E20\u0E32\u0E1E (\u0E41\u0E19\u0E30\u0E19\u0E33 20\u201330) \u0E40\u0E14\u0E34\u0E19\u0E16\u0E48\u0E32\u0E22\u0E23\u0E2D\u0E1A\u0E2B\u0E31\u0E27\u0E43\u0E2B\u0E49\u0E20\u0E32\u0E1E\u0E0B\u0E49\u0E2D\u0E19\u0E01\u0E31\u0E19 70\u201380% \u2022 \u0E40\u0E25\u0E37\u0E2D\u0E01\u0E41\u0E25\u0E49\u0E27 ${Ze.length} \u0E20\u0E32\u0E1E`:`Use at least 12 views (20\u201330 recommended) with 70\u201380% overlap \u2022 ${Ze.length} selected`),He&&React.createElement("div",{className:"model-meter mt-2"},React.createElement("span",{style:{width:`${He.progress||0}%`}})),He&&React.createElement("p",{className:"text-xs txt-soft mt-1"},He.status," ",He.stage?`\u2022 ${He.stage}`:""," \u2022 ",He.progress||0,"%"),He?.extractedFrames&&React.createElement("p",{className:"text-xs text-emerald-500 mt-1"},M==="th"?`\u0E04\u0E31\u0E14\u0E08\u0E32\u0E01\u0E27\u0E34\u0E14\u0E35\u0E42\u0E2D\u0E41\u0E25\u0E49\u0E27 ${He.extractedFrames} \u0E40\u0E1F\u0E23\u0E21`:`${He.extractedFrames} video frames selected`)),Le&&React.createElement("p",{className:"text-rose-500 text-xs mt-2"},Le),oe&&React.createElement("div",{className:"root-ml-results mt-3"},React.createElement("div",null,React.createElement("span",null,M==="th"?"\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E2A\u0E14/\u0E15\u0E49\u0E19":"Fresh weight/plant"),React.createElement("b",null,oe.estimated_fresh_root_weight_kg_per_plant.midpoint.toFixed(2)," kg")),React.createElement("div",null,React.createElement("span",null,M==="th"?"\u0E0A\u0E48\u0E27\u0E07\u0E04\u0E32\u0E14\u0E01\u0E32\u0E23\u0E13\u0E4C 95%":"95% prediction range"),React.createElement("b",null,oe.estimated_fresh_root_weight_kg_per_plant.low.toFixed(2),"\u2013",oe.estimated_fresh_root_weight_kg_per_plant.high.toFixed(2)," kg")),React.createElement("div",null,React.createElement("span",null,M==="th"?"\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E23\u0E27\u0E21":"Total weight"),React.createElement("b",null,oe.estimated_total_weight_kg.midpoint.toFixed(2)," kg")),React.createElement("p",null,M==="th"?`\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E0A\u0E31\u0E48\u0E07\u0E08\u0E23\u0E34\u0E07 ${oe.model.samples} \u0E15\u0E31\u0E27\u0E2D\u0E22\u0E48\u0E32\u0E07 / ${oe.model.cultivars} \u0E1E\u0E31\u0E19\u0E18\u0E38\u0E4C \u2022 \u0E17\u0E14\u0E2A\u0E2D\u0E1A\u0E41\u0E1A\u0E1A\u0E40\u0E27\u0E49\u0E19\u0E17\u0E35\u0E25\u0E30\u0E1E\u0E31\u0E19\u0E18\u0E38\u0E4C: R\xB2 ${oe.model.r2.toFixed(3)}, MAE ${oe.model.mae_kg.toFixed(2)} \u0E01\u0E01. \u2022 ${oe.in_training_domain?"\u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E1D\u0E36\u0E01":"\u0E2D\u0E22\u0E39\u0E48\u0E19\u0E2D\u0E01\u0E0A\u0E48\u0E27\u0E07\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E1D\u0E36\u0E01\u2014\u0E0A\u0E48\u0E27\u0E07\u0E16\u0E39\u0E01\u0E02\u0E22\u0E32\u0E22"}`:`${oe.model.samples} weighed samples / ${oe.model.cultivars} cultivars \u2022 leave-one-cultivar-out R\xB2 ${oe.model.r2.toFixed(3)}, MAE ${oe.model.mae_kg.toFixed(2)} kg \u2022 ${oe.in_training_domain?"within training range":"outside training range\u2014interval widened"}`)),React.createElement("p",{className:"text-xs txt-soft mt-3"},M==="th"?"\u0E2A\u0E33\u0E04\u0E31\u0E0D: \u0E20\u0E32\u0E1E\u0E43\u0E1A\u0E43\u0E0A\u0E49\u0E1A\u0E2D\u0E01\u0E42\u0E23\u0E04 \u0E41\u0E15\u0E48\u0E44\u0E21\u0E48\u0E40\u0E2B\u0E47\u0E19\u0E2B\u0E31\u0E27\u0E43\u0E15\u0E49\u0E14\u0E34\u0E19 \u0E08\u0E36\u0E07\u0E15\u0E49\u0E2D\u0E07\u0E27\u0E31\u0E14\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E15\u0E23\u0E23\u0E32\u0E01\u0E2B\u0E25\u0E31\u0E07\u0E02\u0E38\u0E14 \u0E23\u0E30\u0E1A\u0E1A\u0E19\u0E35\u0E49\u0E22\u0E31\u0E07\u0E40\u0E1B\u0E47\u0E19\u0E07\u0E32\u0E19\u0E17\u0E14\u0E25\u0E2D\u0E07\u0E41\u0E25\u0E30\u0E44\u0E21\u0E48\u0E43\u0E0A\u0E49\u0E41\u0E17\u0E19\u0E01\u0E32\u0E23\u0E0A\u0E31\u0E48\u0E07\u0E0B\u0E37\u0E49\u0E2D\u0E02\u0E32\u0E22":"Important: a leaf photo cannot reveal underground roots. Measure excavated-root volume. This experimental model does not replace trade weighing."))),React.createElement("p",{className:"mt-3 rounded-xl bg-amber-500/10 border border-amber-500/20 p-3 text-xs txt-soft leading-relaxed"},X||(T?M==="th"?`${T.disclaimer_th} \u0E08\u0E33\u0E19\u0E27\u0E19\u0E41\u0E25\u0E30\u0E02\u0E19\u0E32\u0E14\u0E2B\u0E31\u0E27\u0E40\u0E1B\u0E47\u0E19\u0E04\u0E48\u0E32\u0E08\u0E33\u0E25\u0E2D\u0E07\u0E08\u0E32\u0E01\u0E2D\u0E32\u0E22\u0E38 \u0E04\u0E27\u0E32\u0E21\u0E2A\u0E39\u0E07 \u0E08\u0E33\u0E19\u0E27\u0E19\u0E25\u0E33\u0E15\u0E49\u0E19 \u0E41\u0E25\u0E30\u0E1C\u0E25\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E42\u0E23\u0E04`:`${T.disclaimer_en} Root count and dimensions are scenarios based on age, height, stem count and disease result.`:M==="th"?"\u0E01\u0E33\u0E25\u0E31\u0E07\u0E04\u0E33\u0E19\u0E27\u0E13\u0E0A\u0E48\u0E27\u0E07\u0E08\u0E32\u0E01\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E17\u0E35\u0E48\u0E01\u0E23\u0E2D\u0E01":"Calculating a range from the supplied observations")),React.createElement("button",{type:"button",onClick:()=>J(S=>!S),className:"add-evidence-button mt-3","aria-expanded":D},React.createElement(r,{name:"check",className:"w-4 h-4"}),M==="th"?"\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E17\u0E35\u0E48\u0E02\u0E38\u0E14\u0E0A\u0E31\u0E48\u0E07\u0E08\u0E23\u0E34\u0E07\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E1E\u0E31\u0E12\u0E19\u0E32\u0E42\u0E21\u0E40\u0E14\u0E25":"Record an actual harvest weight to improve the model"),D&&React.createElement("form",{onSubmit:la,className:"harvest-form mt-3"},React.createElement("div",{className:"grid sm:grid-cols-2 gap-3"},React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E2B\u0E31\u0E27\u0E2A\u0E14\u0E23\u0E27\u0E21 (\u0E01\u0E01.)":"Total fresh-root weight (kg)"),React.createElement("input",{type:"number",min:"0.02",max:"2000",step:"0.01",required:!0,value:we,onChange:S=>K(S.target.value)})),React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E08\u0E33\u0E19\u0E27\u0E19\u0E15\u0E49\u0E19\u0E17\u0E35\u0E48\u0E02\u0E38\u0E14\u0E0A\u0E31\u0E48\u0E07":"Number of harvested plants"),React.createElement("input",{type:"number",min:"1",max:"1000",step:"1",required:!0,value:j,onChange:S=>ce(S.target.value)}))),React.createElement("div",{className:"grid sm:grid-cols-3 gap-3 mt-3"},React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E1E\u0E31\u0E19\u0E18\u0E38\u0E4C\u0E21\u0E31\u0E19\u0E2A\u0E33\u0E1B\u0E30\u0E2B\u0E25\u0E31\u0E07":"Variety"),React.createElement("input",{required:!0,value:Oe,onChange:S=>dt(S.target.value)})),React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E23\u0E2B\u0E31\u0E2A\u0E41\u0E1B\u0E25\u0E07":"Field code"),React.createElement("input",{required:!0,value:ze,onChange:S=>We(S.target.value),placeholder:"FIELD-001"})),React.createElement("label",null,React.createElement("span",null,M==="th"?"\u0E24\u0E14\u0E39/\u0E23\u0E2D\u0E1A\u0E1B\u0E25\u0E39\u0E01":"Season"),React.createElement("input",{required:!0,value:je,onChange:S=>Ge(S.target.value),placeholder:"2026-rainy"}))),React.createElement("label",{className:"mt-3"},React.createElement("span",null,M==="th"?"\u0E20\u0E32\u0E1E\u0E23\u0E32\u0E01\u0E2B\u0E25\u0E32\u0E22\u0E21\u0E38\u0E21 (\u0E2D\u0E22\u0E48\u0E32\u0E07\u0E19\u0E49\u0E2D\u0E22 3; \u0E41\u0E19\u0E30\u0E19\u0E33 20\u201330 \u0E20\u0E32\u0E1E)":"Multi-view root photos (minimum 3; recommended 20\u201330)"),React.createElement("input",{type:"file",accept:"image/*",multiple:!0,required:!0,onChange:S=>ht(Array.from(S.target.files||[]))})),React.createElement("button",{type:"button",className:"add-evidence-button mt-3",onClick:()=>navigator.geolocation?.getCurrentPosition(S=>nt({latitude:S.coords.latitude,longitude:S.coords.longitude}))},React.createElement(r,{name:"map",className:"w-4 h-4"}),ot?`${ot.latitude.toFixed(5)}, ${ot.longitude.toFixed(5)}`:M==="th"?"\u0E41\u0E19\u0E1A\u0E1E\u0E34\u0E01\u0E31\u0E14\u0E41\u0E1B\u0E25\u0E07 (\u0E2A\u0E21\u0E31\u0E04\u0E23\u0E43\u0E08)":"Attach field coordinates (optional)"),React.createElement("label",{className:"mt-3"},React.createElement("span",null,M==="th"?"\u0E2B\u0E21\u0E32\u0E22\u0E40\u0E2B\u0E15\u0E38\u0E01\u0E32\u0E23\u0E40\u0E01\u0E47\u0E1A\u0E15\u0E31\u0E27\u0E2D\u0E22\u0E48\u0E32\u0E07 (\u0E16\u0E49\u0E32\u0E21\u0E35)":"Sampling notes (optional)"),React.createElement("textarea",{rows:"2",maxLength:"1000",value:be,onChange:S=>ge(S.target.value)})),Pe&&React.createElement("p",{className:`text-sm mt-3 ${Pe.error?"text-rose-400":"text-emerald-500"}`},Pe.error||(M==="th"?`\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E41\u0E25\u0E49\u0E27: ${Pe.weight_kg_per_plant} \u0E01\u0E01./\u0E15\u0E49\u0E19`:`Saved: ${Pe.weight_kg_per_plant} kg/plant`)),React.createElement("button",{className:"primary-action w-full mt-3",disabled:Y||!!(Pe&&!Pe.error)},Y?React.createElement(l,{className:"w-4 h-4"}):React.createElement(r,{name:"check",className:"w-4 h-4"}),M==="th"?"\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E04\u0E48\u0E32\u0E17\u0E35\u0E48\u0E27\u0E31\u0E14\u0E08\u0E23\u0E34\u0E07":"Save measured value")))}function _({viewMode:y,disease:M,affectedCount:g,severity:C,maturity:R,health:P,stemCount:N,rootAbundance:O,rootCount:T,rootLength:F,rootDiameter:L}){let V=t(null);return e(()=>{let X=V.current;if(!X)return;let H;try{H=new lo({canvas:X,antialias:!0,alpha:!0,powerPreference:"high-performance"})}catch{X.dataset.webglUnavailable="true";return}H.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),H.outputColorSpace=zt,H.toneMapping=qs,H.toneMappingExposure=1.12,H.shadowMap.enabled=!0,H.shadowMap.type=mr;let D=new _s,J=new Rt(36,1,.1,100),Y=y==="roots";J.position.set(Y?.1:.15,Y?-.4:2.45,Y?5.2:7.6),J.lookAt(0,Y?-.9:1.05,0),D.fog=new vs(465698,.045),D.add(new zs(14350591,4926742,2.35));let ae=new $i(16777215,3.2);ae.position.set(4,7,5),ae.castShadow=!0,ae.shadow.mapSize.set(1024,1024),ae.shadow.camera.near=.5,ae.shadow.camera.far=18,D.add(ae);let Pe=new $i(2282478,1.1);Pe.position.set(-4,3,-4),D.add(Pe);let Ee=new Hs(16758891,1.2,10);Ee.position.set(2.5,.2,3.5),D.add(Ee);let we=new nn;D.add(we);let K=[],j=[],ce=ie=>{let re=new Bs(ie);return K.push(re),re},be=(ie,re)=>{j.push(ie);let Le=new Xt(ie,re);return Le.castShadow=!0,Le.receiveShadow=!0,Le},ge=ce({color:2598987,roughness:.68,side:Ot}),Oe=ce({color:6016871,roughness:.7,side:Ot}),ze=ce({color:{cbb:8142098,cbsd:15381256,cmd:16436245,cgm:10118160}[M]||10576391,roughness:.8,side:Ot}),We=ce({color:4160826,roughness:.96}),je=ce({color:7181389,roughness:1}),Ge=ce({color:11818325,roughness:.86}),Ze=ce({color:13207372,roughness:.92,metalness:.01}),ht=ce({color:14722667,roughness:.9}),ot=ce({color:8474669,roughness:1}),nt=ce({color:5846303,roughness:1,transparent:!0,opacity:.52}),tt=[],z=new nn,He=new nn;we.add(z,He);let Ve=be(new ki(2.15,2,.58,64,1,!0,0,Math.PI*1.72),nt);Ve.position.y=-.72,Ve.receiveShadow=!0,we.add(Ve);let I=be(new ri(2.14,64,.2,Math.PI*1.68),ce({color:7423270,roughness:1,side:Ot}));I.rotation.x=-Math.PI/2,I.position.y=-.43,we.add(I);let v=be(new ri(2.35,64),ce({color:133902,transparent:!0,opacity:.34,roughness:1}));v.rotation.x=-Math.PI/2,v.position.y=-1.83,v.receiveShadow=!0,we.add(v);let G=2.55+R*.45,W=(ie,re,Le,Be,it=8)=>{let mt=new k().subVectors(re,ie),Qe=be(new ki(Le*.78,Le,mt.length(),it),Be);return Qe.position.copy(ie).add(re).multiplyScalar(.5),Qe.quaternion.setFromUnitVectors(new k(0,1,0),mt.clone().normalize()),Qe},ee=Math.max(1,Math.min(4,Math.round(N||1)));for(let ie=0;ie<ee;ie+=1){let re=ie/ee*Math.PI*2+.35,Le=new k(Math.cos(re)*ie*.045,-.48,Math.sin(re)*ie*.045),Be=new k(Math.cos(re)*ie*.16,G-.48-ie*.08,Math.sin(re)*ie*.16);z.add(W(Le,Be,.075-ie*.006,We,14));for(let it=0;it<8;it+=1){let mt=(it+1)/10,Qe=be(new Wi(.077-ie*.006,.009,5,18),je);Qe.position.lerpVectors(Le,Be,mt),Qe.rotation.x=Math.PI/2,z.add(Qe)}}let le=Math.max(3,Math.min(12,Math.round(T||6))),de=Math.max(.62,Math.min(1.45,Number(F||28)/28)),Q=Math.max(.62,Math.min(1.55,Number(L||5)/5));for(let ie=0;ie<le;ie+=1){let re=ie/le*Math.PI*2+.28,Le=.8+ie%4*.075,Be=[new xe(.018,0),new xe(.08*Q,.08),new xe(.18*Q*Le*O,.26),new xe(.2*Q*Le*O,.56),new xe(.15*Q*Le*O,.82),new xe(.055*Q,1.05),new xe(.008,1.18)],it=be(new Ds(Be,28),ie%3===0?ht:Ze);it.scale.y=de*Le,it.position.set(Math.cos(re)*.3,-.48,Math.sin(re)*.3),it.rotation.z=Math.cos(re)*(.3+ie%2*.1),it.rotation.x=Math.sin(re)*(.3+ie%2*.1),it.rotation.y=-re,He.add(it);for(let It=1;It<=3;It+=1){let bt=be(new Wi(.12*Q*Le*O,.006,5,24),ot);bt.position.set(Math.cos(re)*(.3+It*.035),-.48-It*.22*de*Le,Math.sin(re)*(.3+It*.035)),bt.rotation.x=Math.PI/2,bt.rotation.z=Math.cos(re)*.32,He.add(bt)}let mt=new k(Math.cos(re)*.68,-1.34*de*Le,Math.sin(re)*.68),Qe=new k(Math.cos(re+.18)*.92,mt.y-.26,Math.sin(re+.18)*.92);He.add(W(mt,Qe,.014,ot,6));let mn=new Gi([Qe,new k(Math.cos(re+.28)*1.05,Qe.y-.16,Math.sin(re+.28)*1.05),new k(Math.cos(re+.42)*1.18,Qe.y-.34,Math.sin(re+.42)*1.18)]);He.add(be(new Os(mn,10,.008,5,!1),ot))}let ne=new Vi;ne.moveTo(0,0),ne.bezierCurveTo(.09,.08,.19,.3,.13,.62),ne.bezierCurveTo(.07,.88,0,1.04,0,1.1),ne.bezierCurveTo(0,1.04,-.07,.88,-.13,.62),ne.bezierCurveTo(-.19,.3,-.09,.08,0,0);let me=14;for(let ie=0;ie<me;ie+=1){let re=ie*2.399963,Le=.62+ie%5*.43,Be=.72+ie%3*.13,it=new k(0,Le,0),mt=new k(Math.cos(re)*Be,Le+.18,Math.sin(re)*Be);z.add(W(it,mt,.022,Ge));let Qe=new nn;Qe.position.copy(mt),Qe.rotation.set(-1.08+ie%3*.05,0,-re-Math.PI/2),Qe.userData.baseX=Qe.rotation.x,Qe.userData.phase=ie*.73,tt.push(Qe);let mn=ie<Math.round(g*1.5),It=C==="severe"&&mn?.76:1;for(let bt=0;bt<7;bt+=1){let $t=(bt-3)*.39,Qn=mn?ze:ie>10?Oe:ge,Yt=be(new Fs(ne,8),Qn),_t=(bt===3?.68:.52-Math.abs(bt-3)*.025)*It;Yt.scale.set(_t,_t,1),Yt.rotation.x=(bt%2?-.08:.06)+(100-P)*.0015,Yt.rotation.z=-$t,Yt.position.set(Math.sin($t)*.075,Math.cos($t)*.075,(bt-3)*.004),Qe.add(Yt);let Et=new k(-Math.sin($t)*_t*.04,Math.cos($t)*_t*.88,.006);if(Qe.add(W(new k(0,0,.006),Et,.006,We,5)),mn&&bt%2===0){let ei=be(new ri(.035,10),ce({color:8138002,side:Ot,roughness:1}));ei.position.set(Math.sin($t)*.08,.23+Math.cos($t)*.05,.012),Qe.add(ei)}}z.add(Qe)}Y&&(z.visible=!1,Ve.material.opacity=.16,I.material.transparent=!0,I.material.opacity=.1,He.scale.setScalar(1.25),He.position.y=.24),we.position.y=.05,we.rotation.x=-.06;let Se,he=!1,ue=0,Ae=0,Ie=()=>{let ie=X.getBoundingClientRect();H.setSize(Math.max(1,ie.width),Math.max(1,ie.height),!1),J.aspect=Math.max(1,ie.width)/Math.max(1,ie.height),J.updateProjectionMatrix()};Ie();let Ue=new ResizeObserver(Ie);Ue.observe(X);let B=ie=>{he=!0,ue=ie.clientX,X.setPointerCapture?.(ie.pointerId)},fe=ie=>{he&&(Ae+=(ie.clientX-ue)*.012,ue=ie.clientX)},te=()=>{he=!1},pe=ie=>{ie.preventDefault(),J.position.z=Math.max(5.2,Math.min(10,J.position.z+ie.deltaY*.006))};X.addEventListener("pointerdown",B),X.addEventListener("pointermove",fe),X.addEventListener("pointerup",te),X.addEventListener("pointercancel",te),X.addEventListener("wheel",pe,{passive:!1});let oe=new Ws,se=()=>{let ie=oe.getElapsedTime();he||(Ae+=.003),we.rotation.y=Ae,we.position.y=.05+Math.sin(ie*1.2)*.015,tt.forEach((re,Le)=>{re.rotation.x=re.userData.baseX+Math.sin(ie*1.35+re.userData.phase)*(.015+(100-P)*15e-5),re.rotation.y=Math.sin(ie*.9+Le)*.018}),H.render(D,J),Se=requestAnimationFrame(se)};return se(),()=>{cancelAnimationFrame(Se),Ue.disconnect(),X.removeEventListener("pointerdown",B),X.removeEventListener("pointermove",fe),X.removeEventListener("pointerup",te),X.removeEventListener("pointercancel",te),X.removeEventListener("wheel",pe),j.forEach(ie=>ie.dispose()),K.forEach(ie=>ie.dispose()),H.dispose()}},[y,M,g,C,R,P,N,O,T,F,L]),React.createElement("canvas",{ref:V,className:"plant-3d-canvas",tabIndex:"0","aria-label":"Interactive WebGL cassava model. Drag to rotate and scroll to zoom."})}function b({r:y,onRetake:M}){let{t:g,lang:C}=window.CG.Store.useStore(),R=y.top3[0];return React.createElement(n,{className:"animate-fadeup"},React.createElement(s,{icon:"grid",title:C==="th"?"\u0E1C\u0E25\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E08\u0E32\u0E01\u0E40\u0E0B\u0E19\u0E40\u0E0B\u0E2D\u0E23\u0E4C":"Sensor CSV Analysis",sub:`${y.rows} rows`}),React.createElement("div",{className:"flex items-center gap-4 mb-4"},React.createElement(u,{value:R.confidence*100,label:g("confidence")}),React.createElement("div",null,React.createElement(a,{tone:R.key,dot:!0},C==="th"?R.th:R.en),React.createElement("div",{className:"grid grid-cols-2 gap-2 mt-3 text-sm"},Object.entries(y.aggregates).map(([P,N])=>React.createElement("div",{key:P,className:"glass rounded-lg px-2.5 py-1.5"},React.createElement("div",{className:"txt-dim text-[10px] uppercase"},P.replace("_"," ")),React.createElement("div",{className:"txt font-semibold"},N)))))),React.createElement(f,{items:y.top3.map(P=>({key:P.key,label:C==="th"?P.th:P.en,value:P.confidence}))}),React.createElement("button",{onClick:M,className:"w-full mt-4 glass rounded-xl py-2.5 flex items-center justify-center gap-2 txt-soft hover:txt transition text-sm font-medium"},React.createElement(r,{name:"history",className:"w-4 h-4"}),C==="th"?"\u0E16\u0E48\u0E32\u0E22\u0E43\u0E2B\u0E21\u0E48":"Retake"))}window.CG.Pages=window.CG.Pages||{},window.CG.Pages.Predict=x})();(function(){let{useState:i,useEffect:e}=React,{Card:t,SectionTitle:n,Badge:s,Icon:a,Segmented:r,Spinner:o,Skeleton:l}=window.CG.UI,{LineChart:c}=window.CG.Charts,u=[{value:"ndvi",label:"NDVI"},{value:"ndwi",label:"NDMI"},{value:"savi",label:"SAVI"},{value:"evi",label:"EVI"}],p={ndvi:"NDVI",ndwi:"NDMI",savi:"SAVI",evi:"EVI"},f=(E,m)=>m==null?"#334155":E==="ndwi"?m>.2?"#0369a1":m>0?"#38bdf8":m>-.2?"#fcd34d":"#b45309":m>.6?"#065f46":m>.45?"#10b981":m>.3?"#fbbf24":"#dc2626";function d({initialField:E}){let{t:m,lang:h,toast:w}=window.CG.Store.useStore(),[A,_]=i([]),[b,y]=i(E||null),[M,g]=i("ndvi"),[C,R]=i(null),[P,N]=i(null),[O,T]=i(null),[F,L]=i(0),[V,X]=i(null);e(()=>{window.CG.API_CLIENT.fields().then(D=>{_(D),!b&&D.length&&y(D[0].id)})},[]),e(()=>{if(!b)return;R(null),N(null),X(null);let D=window.CG.API_CLIENT;D.satTimeline(b,12).then(J=>{R(J.series),L(J.series.length-1)}).catch(J=>w(J.message,"error")),D.satPasses(b).then(J=>N(J.passes)).catch(()=>{})},[b]),e(()=>{if(!b||!C)return;let D=C[F]?.date;window.CG.API_CLIENT.satGrid(b,M,D).then(T).catch(()=>{})},[b,M,F,C]),e(()=>{b&&window.CG.API_CLIENT.satCompare(b,M,"","").then(X).catch(()=>{})},[M,b]);let H=C?C[F]:null;return React.createElement("div",{className:"space-y-5"},React.createElement("div",{className:"flex flex-wrap items-center justify-between gap-3"},React.createElement(x,{fields:A,fid:b,setFid:y}),React.createElement("div",{className:"flex items-center gap-2"},H?.data_source&&React.createElement(s,{tone:H.data_source.mode==="live"?"online":"medium",dot:!0},H.data_source.mode==="live"?h==="th"?"Sentinel-2 L2A \xB7 \u0E20\u0E32\u0E1E\u0E08\u0E23\u0E34\u0E07":"Sentinel-2 L2A \xB7 observed":h==="th"?"\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E08\u0E33\u0E25\u0E2D\u0E07":"Synthetic"),React.createElement(r,{options:u,value:M,onChange:g}))),React.createElement("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4"},["ndvi","ndwi","savi","evi"].map((D,J)=>React.createElement(t,{key:D,hover:!0,className:"animate-fadeup",style:{animationDelay:J*50+"ms"}},React.createElement("div",{className:"flex items-center justify-between"},React.createElement("span",{className:"txt-soft text-xs font-semibold"},p[D]),React.createElement(a,{name:"satellite",className:"w-4 h-4 text-cyan2-light"})),React.createElement("div",{className:"txt text-2xl font-bold mt-2 tabular-nums"},H?H[D]:React.createElement(l,{className:"h-7 w-16"})),React.createElement("div",{className:"h-1.5 rounded-full mt-2 overflow-hidden bg-white/5"},React.createElement("div",{className:"h-full rounded-full",style:{width:H?Math.min(100,Math.max(0,(H[D]+(D==="ndwi"?1:0))/(D==="ndwi"?2:1)*100))+"%":0,background:f(D,H?H[D]:0)}}))))),React.createElement("div",{className:"grid lg:grid-cols-2 gap-4"},React.createElement(t,{className:"animate-fadeup"},React.createElement(n,{icon:"grid",title:`${M.toUpperCase()} ${m("risk_zones")}`,sub:H?`${H.date} \xB7 valid ${H.valid_pct??100}%`:"",right:O&&React.createElement(s,{tone:"info"},"\u03BC ",O.mean)}),O?React.createElement(React.Fragment,null,React.createElement("div",{className:"grid gap-0.5 rounded-xl overflow-hidden",style:{gridTemplateColumns:`repeat(${O.grid_size},1fr)`}},O.cells.flat().map((D,J)=>React.createElement("div",{key:J,className:"aspect-square relative group",style:{background:f(M,D)},title:D===null?"nodata/cloud":D}))),React.createElement("div",{className:"flex items-center justify-between mt-2 text-[11px] txt-dim"},React.createElement("span",null,"low"),React.createElement("div",{className:"h-2 flex-1 mx-2 rounded-full",style:{background:"linear-gradient(90deg,#dc2626,#fbbf24,#10b981,#065f46)"}}),React.createElement("span",null,"high")),O.risk_zones.length>0&&React.createElement("div",{className:"mt-3 flex items-center gap-2 text-xs"},React.createElement(a,{name:"alert",className:"w-4 h-4 text-rose-400"}),React.createElement("span",{className:"txt-soft"},O.risk_zones.length," ",m("risk_zones")," \xB7 ",h==="th"?"\u0E15\u0E23\u0E27\u0E08\u0E1E\u0E1A\u0E04\u0E27\u0E32\u0E21\u0E1C\u0E34\u0E14\u0E1B\u0E01\u0E15\u0E34\u0E40\u0E0A\u0E34\u0E07\u0E1E\u0E37\u0E49\u0E19\u0E17\u0E35\u0E48":"spatial anomalies detected"))):React.createElement(l,{className:"h-48"}),C&&React.createElement("div",{className:"mt-4"},React.createElement("div",{className:"flex justify-between text-[11px] txt-dim mb-1"},React.createElement("span",null,m("time_slider")),React.createElement("span",{className:"txt-soft font-mono"},H?.date)),React.createElement("input",{type:"range",min:"0",max:C.length-1,value:F,onChange:D=>L(Number(D.target.value)),className:"w-full"}))),React.createElement(t,{className:"animate-fadeup",style:{animationDelay:"60ms"}},React.createElement(n,{icon:"satellite",title:m("trend"),sub:"12 months \xB7 all indices"}),C?React.createElement(c,{height:220,labels:C.map(D=>D.date.slice(2,7)),series:[{label:"NDVI",data:C.map(D=>D.ndvi),color:"#10b981"},{label:"NDMI",data:C.map(D=>D.ndwi),color:"#06b6d4"},{label:"SAVI",data:C.map(D=>D.savi),color:"#f59e0b"},{label:"EVI",data:C.map(D=>D.evi),color:"#8b5cf6"}],opts:{scales:{y:{min:-.5,max:1,grid:{color:"rgba(148,163,184,.12)"},ticks:{color:"#93a4bd",font:{size:9}}},x:{grid:{display:!1},ticks:{color:"#93a4bd",font:{size:9}}}}}}):React.createElement(l,{className:"h-52"}))),React.createElement("div",{className:"grid lg:grid-cols-2 gap-4"},React.createElement(t,{className:"animate-fadeup"},React.createElement(n,{icon:"grid",title:m("compare"),sub:V?`\u0394\u03BC ${V.delta_mean>0?"+":""}${V.delta_mean}`:""}),V?React.createElement("div",{className:"grid grid-cols-2 gap-3"},[["a",h==="th"?"\u0E01\u0E48\u0E2D\u0E19\u0E2B\u0E19\u0E49\u0E32":"Earlier"],["b",h==="th"?"\u0E1B\u0E31\u0E08\u0E08\u0E38\u0E1A\u0E31\u0E19":"Latest"]].map(([D,J])=>React.createElement("div",{key:D},React.createElement("div",{className:"flex justify-between text-xs mb-1.5"},React.createElement("span",{className:"txt-soft"},J),React.createElement("span",{className:"txt-dim font-mono"},V[D].date)),React.createElement("div",{className:"grid gap-px rounded-lg overflow-hidden",style:{gridTemplateColumns:`repeat(${V[D].grid_size},1fr)`}},V[D].cells.flat().map((Y,ae)=>React.createElement("div",{key:ae,className:"aspect-square",style:{background:f(M,Y)}}))),React.createElement("div",{className:"text-center txt-dim text-[11px] mt-1"},"\u03BC ",V[D].mean)))):React.createElement(l,{className:"h-40"})),React.createElement(t,{className:"animate-fadeup",style:{animationDelay:"60ms"}},React.createElement(n,{icon:"satellite",title:m("sat_timeline"),sub:h==="th"?"\u0E23\u0E32\u0E22\u0E01\u0E32\u0E23\u0E20\u0E32\u0E1E\u0E17\u0E35\u0E48\u0E23\u0E31\u0E1A\u0E08\u0E23\u0E34\u0E07\u0E25\u0E48\u0E32\u0E2A\u0E38\u0E14":"Actual recent acquisitions"}),P?React.createElement("div",{className:"space-y-2 max-h-64 overflow-y-auto no-scrollbar"},P.slice().reverse().map((D,J)=>React.createElement("div",{key:J,className:`flex items-center gap-3 rounded-xl px-3 py-2 ${D.future?"border border-dashed hair":"glass"}`},React.createElement("div",{className:`w-2 h-2 rounded-full shrink-0 ${D.usable?"bg-brand-400":"bg-amber-400"}`}),React.createElement("span",{className:"txt text-sm font-mono"},D.date),React.createElement("span",{className:"txt-soft text-xs"},D.satellite),React.createElement("div",{className:"flex-1"}),D.future?React.createElement(s,{tone:"info"},h==="th"?"\u0E01\u0E33\u0E2B\u0E19\u0E14\u0E01\u0E32\u0E23":"scheduled"):React.createElement(s,{tone:D.usable?"low":"medium"},D.cloud_pct,"% cloud")))):React.createElement(l,{className:"h-40"}))))}function x({fields:E,fid:m,setFid:h}){let{lang:w}=window.CG.Store.useStore();return React.createElement("select",{value:m||"",onChange:A=>h(Number(A.target.value)),className:"glass rounded-xl px-3 py-2 txt text-sm bg-transparent focus:outline-none focus:ring-2 ring-brand-500/40"},E.map(A=>React.createElement("option",{key:A.id,value:A.id,className:"bg-ink-800"},w==="th"&&A.name_th||A.name)))}window.CG.Pages=window.CG.Pages||{},window.CG.Pages.Satellite=d,window.CG.FieldPicker=x})();(function(){let{useState:i,useEffect:e}=React,{Card:t,SectionTitle:n,Badge:s,Icon:a,Skeleton:r}=window.CG.UI,{LineChart:o,BarChart:l}=window.CG.Charts,c={sunny:"sun",partly_cloudy:"cloud",cloudy:"cloud",rain:"drop",storm:"drop"};function u({initialField:p}){let{t:f,lang:d,toast:x}=window.CG.Store.useStore(),[E,m]=i([]),[h,w]=i(p||null),[A,_]=i(null),[b,y]=i(null),[M,g]=i(null);e(()=>{window.CG.API_CLIENT.fields().then(R=>{m(R),!h&&R.length&&w(R[0].id)})},[]),e(()=>{let R=window.CG.API_CLIENT;_(null),y(null),g(null),R.weatherCurrent(h).then(_).catch(P=>x(P.message,"error")),R.weatherHistory(h,30).then(P=>y(P.series)).catch(()=>{}),R.weatherForecast(h,7).then(P=>g(P.series)).catch(()=>{})},[h]);let C=A?[{icon:"temp",label:d==="th"?"\u0E2D\u0E38\u0E13\u0E2B\u0E20\u0E39\u0E21\u0E34":"Temperature",v:A.temp_c,u:"\xB0C",tone:"amber"},{icon:"drop",label:d==="th"?"\u0E04\u0E27\u0E32\u0E21\u0E0A\u0E37\u0E49\u0E19":"Humidity",v:A.humidity_pct,u:"%",tone:"cyan"},{icon:"cloud",label:d==="th"?"\u0E1D\u0E19":"Rainfall",v:A.rainfall_mm,u:"mm",tone:"cyan"},{icon:"wind",label:d==="th"?"\u0E25\u0E21":"Wind",v:A.wind_kmh,u:"km/h",tone:"brand"},{icon:"sun",label:d==="th"?"\u0E23\u0E31\u0E07\u0E2A\u0E35\u0E14\u0E27\u0E07\u0E2D\u0E32\u0E17\u0E34\u0E15\u0E22\u0E4C":"Solar",v:A.solar_mj,u:"MJ",tone:"amber"}]:[];return React.createElement("div",{className:"space-y-5"},React.createElement("div",{className:"flex items-center justify-between"},window.CG.FieldPicker&&React.createElement(window.CG.FieldPicker,{fields:E,fid:h,setFid:w}),React.createElement("div",{className:"flex items-center gap-2"},A?.data_source&&React.createElement(s,{tone:A.data_source.mode==="live"?"online":"medium",dot:!0},A.data_source.mode==="live"?d==="th"?"Open-Meteo \xB7 \u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E2A\u0E14":"Open-Meteo \xB7 live":d==="th"?"\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E08\u0E33\u0E25\u0E2D\u0E07":"Synthetic"),A&&React.createElement(s,{tone:"info"},d==="th"?A.condition_th:A.condition.replace("_"," ")))),React.createElement("div",{className:"grid lg:grid-cols-3 gap-4"},React.createElement(t,{className:"animate-fadeup relative overflow-hidden"},React.createElement("div",{className:"absolute -right-10 -top-10 w-40 h-40 rounded-full grad-brand opacity-10 blur-2xl"}),A?React.createElement("div",{className:"flex items-center gap-5"},React.createElement("div",{className:"w-20 h-20 rounded-3xl grad-brand grid place-items-center text-white animate-floaty"},React.createElement(a,{name:c[A.condition]||"cloud",className:"w-10 h-10"})),React.createElement("div",null,React.createElement("div",{className:"txt text-5xl font-bold tabular-nums"},A.temp_c,"\xB0"),React.createElement("div",{className:"txt-soft text-sm mt-1"},A.temp_min,"\xB0 / ",A.temp_max,"\xB0"))):React.createElement(r,{className:"h-20"})),React.createElement("div",{className:"lg:col-span-2 grid grid-cols-2 md:grid-cols-5 gap-3"},C.map((R,P)=>React.createElement(t,{key:P,hover:!0,className:"animate-fadeup",style:{animationDelay:P*40+"ms"}},React.createElement(a,{name:R.icon,className:"w-5 h-5 text-cyan2-light"}),React.createElement("div",{className:"txt text-xl font-bold mt-2 tabular-nums"},R.v,React.createElement("span",{className:"text-xs txt-soft ml-0.5"},R.u)),React.createElement("div",{className:"txt-dim text-[11px] mt-0.5"},R.label))))),React.createElement(t,{className:"animate-fadeup"},React.createElement(n,{icon:"cloud",title:f("forecast")}),M?React.createElement("div",{className:"grid grid-cols-7 gap-2"},M.map((R,P)=>React.createElement("div",{key:P,className:"glass rounded-xl p-3 text-center card-hover"},React.createElement("div",{className:"txt-dim text-[11px]"},new Date(R.date).toLocaleDateString(d==="th"?"th-TH":"en",{weekday:"short"})),React.createElement(a,{name:c[R.condition]||"cloud",className:"w-6 h-6 mx-auto my-2 text-cyan2-light"}),React.createElement("div",{className:"txt font-bold text-sm"},R.temp_max,"\xB0"),React.createElement("div",{className:"txt-dim text-[11px]"},R.temp_min,"\xB0"),React.createElement("div",{className:"text-[11px] text-cyan2-light mt-1"},R.rainfall_mm,"mm")))):React.createElement(r,{className:"h-28"})),React.createElement("div",{className:"grid lg:grid-cols-2 gap-4"},React.createElement(t,{className:"animate-fadeup"},React.createElement(n,{icon:"temp",title:`${f("trend")} \xB7 ${d==="th"?"\u0E2D\u0E38\u0E13\u0E2B\u0E20\u0E39\u0E21\u0E34 & \u0E04\u0E27\u0E32\u0E21\u0E0A\u0E37\u0E49\u0E19":"Temp & Humidity"}`,sub:"30 days"}),b?React.createElement(o,{height:220,labels:b.map(R=>R.date.slice(5)),series:[{label:"Temp \xB0C",data:b.map(R=>R.temp_c),color:"#f59e0b"},{label:"Humidity %",data:b.map(R=>R.humidity_pct),color:"#06b6d4"}]}):React.createElement(r,{className:"h-52"})),React.createElement(t,{className:"animate-fadeup",style:{animationDelay:"60ms"}},React.createElement(n,{icon:"cloud",title:`${f("trend")} \xB7 ${d==="th"?"\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E1D\u0E19":"Rainfall"}`,sub:"30 days"}),b?React.createElement(l,{height:220,labels:b.map(R=>R.date.slice(5)),series:[{label:"Rain mm",data:b.map(R=>R.rainfall_mm),color:"#06b6d4"}]}):React.createElement(r,{className:"h-52"}))))}window.CG.Pages=window.CG.Pages||{},window.CG.Pages.Weather=u})();(function(){let{useState:i,useEffect:e}=React,{Card:t,SectionTitle:n,Badge:s,Icon:a,Skeleton:r,Empty:o,Segmented:l}=window.CG.UI,c={nutrient:"soil",water:"drop",disease:"brain",weather:"cloud",info:"check"};function u({initialField:f}){let{t:d,lang:x,toast:E}=window.CG.Store.useStore(),[m,h]=i([]),[w,A]=i(f||"all"),[_,b]=i(null),[y,M]=i("all");e(()=>{window.CG.API_CLIENT.fields().then(h)},[]),e(()=>{b(null);let R=window.CG.API_CLIENT;(async()=>{try{if(w==="all"){let N=await R.fields(),O=await Promise.all(N.map(F=>R.field(F.id))),T=[];O.forEach(F=>F.recommendations.forEach(L=>T.push({...L,field:F.name,field_th:F.name_th,field_id:F.id}))),T.sort((F,L)=>({high:0,medium:1,info:2})[F.severity]-{high:0,medium:1,info:2}[L.severity]||L.confidence-F.confidence),b(T)}else{let N=await R.field(w);b(N.recommendations.map(O=>({...O,field:N.name,field_th:N.name_th,field_id:N.id})))}}catch(N){E(N.message,"error")}})()},[w]);let g=_?_.filter(R=>y==="all"||R.kind===y):null,C=_?{high:_.filter(R=>R.severity==="high").length,medium:_.filter(R=>R.severity==="medium").length,total:_.length}:{high:0,medium:0,total:0};return React.createElement("div",{className:"space-y-5"},React.createElement("div",{className:"flex flex-wrap items-center justify-between gap-3"},React.createElement("div",{className:"flex items-center gap-2"},React.createElement("select",{value:w,onChange:R=>A(R.target.value==="all"?"all":Number(R.target.value)),className:"glass rounded-xl px-3 py-2 txt text-sm bg-transparent focus:outline-none focus:ring-2 ring-brand-500/40"},React.createElement("option",{value:"all",className:"bg-ink-800"},d("all_fields")),m.map(R=>React.createElement("option",{key:R.id,value:R.id,className:"bg-ink-800"},x==="th"&&R.name_th||R.name)))),React.createElement(l,{value:y,onChange:M,options:[{value:"all",label:x==="th"?"\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14":"All"},{value:"nutrient",label:x==="th"?"\u0E18\u0E32\u0E15\u0E38\u0E2D\u0E32\u0E2B\u0E32\u0E23":"Nutrient"},{value:"water",label:x==="th"?"\u0E19\u0E49\u0E33":"Water"},{value:"disease",label:x==="th"?"\u0E42\u0E23\u0E04":"Disease"}]})),React.createElement("div",{className:"grid grid-cols-3 gap-4"},React.createElement(t,{className:"animate-fadeup"},React.createElement("div",{className:"flex items-center gap-3"},React.createElement("div",{className:"w-10 h-10 rounded-xl bg-rose-500/15 text-rose-300 grid place-items-center"},React.createElement(a,{name:"alert"})),React.createElement("div",null,React.createElement("div",{className:"txt text-2xl font-bold"},C.high),React.createElement("div",{className:"txt-dim text-xs"},d("high"))))),React.createElement(t,{className:"animate-fadeup",style:{animationDelay:"60ms"}},React.createElement("div",{className:"flex items-center gap-3"},React.createElement("div",{className:"w-10 h-10 rounded-xl bg-amber-500/15 text-amber-300 grid place-items-center"},React.createElement(a,{name:"bell"})),React.createElement("div",null,React.createElement("div",{className:"txt text-2xl font-bold"},C.medium),React.createElement("div",{className:"txt-dim text-xs"},d("medium"))))),React.createElement(t,{className:"animate-fadeup",style:{animationDelay:"120ms"}},React.createElement("div",{className:"flex items-center gap-3"},React.createElement("div",{className:"w-10 h-10 rounded-xl bg-brand-500/15 text-brand-300 grid place-items-center"},React.createElement(a,{name:"bulb"})),React.createElement("div",null,React.createElement("div",{className:"txt text-2xl font-bold"},C.total),React.createElement("div",{className:"txt-dim text-xs"},d("recommendation")))))),g?g.length===0?React.createElement(t,null,React.createElement(o,{icon:"check",text:x==="th"?"\u0E44\u0E21\u0E48\u0E21\u0E35\u0E04\u0E33\u0E41\u0E19\u0E30\u0E19\u0E33\u0E43\u0E19\u0E2B\u0E21\u0E27\u0E14\u0E19\u0E35\u0E49":"No recommendations in this category"})):React.createElement("div",{className:"grid md:grid-cols-2 gap-4"},g.map((R,P)=>React.createElement(p,{key:P,r:R,delay:P*50}))):React.createElement("div",{className:"grid md:grid-cols-2 gap-4"},[0,1,2,3].map(R=>React.createElement(t,{key:R},React.createElement(r,{className:"h-40"})))))}function p({r:f,delay:d}){let{lang:x}=window.CG.Store.useStore(),E=x==="th"?f.actions_th:f.actions_en;return React.createElement(t,{hover:!0,className:"animate-fadeup relative overflow-hidden",style:{animationDelay:d+"ms"}},React.createElement("div",{className:`absolute left-0 top-0 bottom-0 w-1 ${f.severity==="high"?"bg-rose-500":f.severity==="medium"?"bg-amber-500":"bg-brand-500"}`}),React.createElement("div",{className:"flex items-start justify-between gap-2 mb-3 pl-2"},React.createElement("div",{className:"flex items-center gap-2.5"},React.createElement("div",{className:`w-9 h-9 rounded-xl grid place-items-center ${f.severity==="high"?"bg-rose-500/15 text-rose-300":f.severity==="medium"?"bg-amber-500/15 text-amber-300":"bg-brand-500/15 text-brand-300"}`},React.createElement(a,{name:c[f.kind]||"bulb",className:"w-5 h-5"})),React.createElement("div",null,React.createElement("h4",{className:"txt font-semibold text-sm leading-tight"},x==="th"?f.title_th:f.title_en),f.field&&React.createElement("div",{className:"txt-dim text-[11px] mt-0.5"},x==="th"&&f.field_th||f.field))),React.createElement(s,{tone:f.severity},Math.round(f.confidence*100),"%")),React.createElement("div",{className:"pl-2"},React.createElement("div",{className:"txt-dim text-[11px] font-semibold uppercase mb-1.5"},x==="th"?"\u0E2B\u0E25\u0E31\u0E01\u0E10\u0E32\u0E19":"Evidence"),React.createElement("ul",{className:"space-y-1 mb-3"},f.evidence.map((m,h)=>React.createElement("li",{key:h,className:"flex items-start gap-2 txt-soft text-xs"},React.createElement("span",{className:"w-1.5 h-1.5 rounded-full bg-cyan2 mt-1.5 shrink-0"}),x==="th"?m.th:m.en))),React.createElement("div",{className:"txt-dim text-[11px] font-semibold uppercase mb-1.5"},x==="th"?"\u0E04\u0E33\u0E41\u0E19\u0E30\u0E19\u0E33":"Actions"),React.createElement("ul",{className:"space-y-1"},E.map((m,h)=>React.createElement("li",{key:h,className:"flex items-start gap-2 txt text-xs"},React.createElement(a,{name:"check",className:"w-3.5 h-3.5 text-brand-400 mt-0.5 shrink-0"}),m))),React.createElement("div",{className:"mt-3 flex items-center gap-2"},React.createElement("div",{className:"flex-1 h-1.5 rounded-full bg-white/5 overflow-hidden"},React.createElement("div",{className:"h-full grad-brand rounded-full",style:{width:f.confidence*100+"%",transition:"width 1s"}})),React.createElement("span",{className:"txt-dim text-[10px]"},x==="th"?"\u0E04\u0E27\u0E32\u0E21\u0E40\u0E0A\u0E37\u0E48\u0E2D\u0E21\u0E31\u0E48\u0E19":"confidence"))))}window.CG.Pages=window.CG.Pages||{},window.CG.Pages.Recommendations=u})();(function(){let{useState:i,useEffect:e}=React,{Card:t,SectionTitle:n,Badge:s,Icon:a,Skeleton:r,Empty:o,Modal:l,ProgressRing:c}=window.CG.UI,{ProbBars:u}=window.CG.Charts;function p(){let{t:d,lang:x,toast:E}=window.CG.Store.useStore(),[m,h]=i(null),[w,A]=i(""),[_,b]=i(""),[y,M]=i(null),[g,C]=i([]),R=()=>{let L={};w&&(L.q=w),_&&(L.top_class=_),window.CG.API_CLIENT.history(L).then(V=>h(V.items)).catch(V=>E(V.message,"error"))};e(()=>{window.CG.API_CLIENT.classes().then(C)},[]),e(()=>{let L=setTimeout(R,250);return()=>clearTimeout(L)},[w,_]);let P=L=>window.CG.API_CLIENT.historyDetail(L).then(M).catch(V=>E(V.message,"error")),N=async L=>{let V=x==="th"?`\u0E25\u0E1A\u0E1C\u0E25\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C #${L.id} \u0E41\u0E25\u0E30\u0E20\u0E32\u0E1E\u0E17\u0E35\u0E48\u0E40\u0E01\u0E35\u0E48\u0E22\u0E27\u0E02\u0E49\u0E2D\u0E07\u0E2D\u0E22\u0E48\u0E32\u0E07\u0E16\u0E32\u0E27\u0E23\u0E2B\u0E23\u0E37\u0E2D\u0E44\u0E21\u0E48?`:`Permanently delete prediction #${L.id} and its related images?`;if(window.confirm(V))try{await window.CG.API_CLIENT.deletePrediction(L.id),y?.id===L.id&&M(null),E(x==="th"?"\u0E25\u0E1A\u0E1C\u0E25\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E41\u0E25\u0E49\u0E27":"Prediction deleted","success"),R()}catch(X){E(X.message,"error")}},O=L=>String(L??"").replace(/[&<>"']/g,V=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[V]),T=async()=>{try{let L=await window.CG.API_CLIENT.exportCsv();if(!L.ok)throw new Error("Export failed");let V=await L.blob(),X=URL.createObjectURL(V),H=document.createElement("a");H.href=X,H.download="cassavaguard_predictions.csv",H.click(),URL.revokeObjectURL(X)}catch(L){E(L.message,"error")}},F=()=>{if(!m||!m.length){E(d("no_data"),"warn");return}let L=window.open("","_blank"),V=m.map(X=>`<tr><td>${X.id}</td><td>${O(X.created_at.replace("T"," ").slice(0,16))}</td><td>${O(X.source)}</td><td>${O(X.top_class)}</td><td>${(X.confidence*100).toFixed(1)}%</td><td>${O(X.field_name||"-")}</td></tr>`).join("");L.document.write(`<html><head><title>CassavaGuard Prediction Report</title>
